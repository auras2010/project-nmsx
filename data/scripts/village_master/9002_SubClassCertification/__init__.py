...
from l2.universe.gameserver.datatables import CharTemplateTable
from l2.universe.gameserver.model.base         import ClassType
from l2.universe.gameserver.model.base         import Race
