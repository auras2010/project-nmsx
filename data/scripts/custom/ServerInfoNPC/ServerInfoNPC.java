...
public class ServerInfoNPC extends Quest
{
	...
	private final static int NPC = ExternalConfig.SERVERINFO_NPC_ID;
	...
	public String pageIndex(String msg)
	{
		...
		if (disablePage(3) == 0)
			htmltext += "<tr><td align=center>" + button("Contacts", "redirect page 3 0", 150, 20) + "</td></tr>";
		if (disablePage(4) == 0)
			htmltext += "<tr><td align=center>" + button("NPCs Custom", "redirect page 4 0", 150, 20) + "</td></tr>";
		if (disablePage(5) == 0)
	...
	public String pageSub(int pIndex)
	{
		...
		switch (pIndex)
		{
			...
			case 3:
				title = "Contacts";
				htmltext += "Server Name: <font color=\"LEVEL\">" + ExternalConfig.SERVER_NAME + "</font><br>";
				htmltext += "Description: <font color=\"LEVEL\">" + ExternalConfig.SERVERINFO_NPC_DESCRIPTION + "</font><br>";
				htmltext += "<br>Admin (Adm):<br1>";
				for (final String adm : ExternalConfig.SERVERINFO_NPC_ADM)
					htmltext += "* <font color=\"LEVEL\">" + adm + "</font><br1>";
				htmltext += "<br>GameMaster (GM):<br1>";
				for (final String gm : ExternalConfig.SERVERINFO_NPC_GM)
					htmltext += "* <font color=\"LEVEL\">" + gm + "</font><br1>";
				htmltext += "<br>E-mail: <font color=\"LEVEL\">" + ExternalConfig.SERVERINFO_NPC_EMAIL + "</font><br>";
				if (!ExternalConfig.SERVERINFO_NPC_PHONE.equalsIgnoreCase("0"))
					htmltext += "Phone: <font color=\"LEVEL\">" + ExternalConfig.SERVERINFO_NPC_PHONE + "</font><br>";
				break;
			case 4:
				title = "NPCs Custom";
				for (final String npcCustom : ExternalConfig.SERVERINFO_NPC_CUSTOM)
			...
			case 5:
				...
				htmltext += "Champion System: <font color=\"LEVEL\">" + convBoolean(Config.MOD_CHAMPION_ENABLE) + "</font><br>";
				htmltext += "Wedding System: <font color=\"LEVEL\">" + convBoolean(Config.MOD_ALLOW_WEDDING) + "</font><br>";
			...
			case 6:
				title = "Events Info";
				htmltext += "TvT Events: <font color=\"LEVEL\">" + convBoolean(ExternalConfig.TVT_EVENT_ENABLED) + "</font><br>";
				htmltext += "CTF Events: <font color=\"LEVEL\">" + convBoolean(ExternalConfig.CTF_EVENT_ENABLED) + "</font><br>";
				htmltext += "Handy's Block Checker Event: <font color=\"LEVEL\">" + convBoolean(ExternalConfig.ENABLE_BLOCK_CHECKER_EVENT) + "</font><br>";
				htmltext += "Monster Rush Event: <font color=\"LEVEL\">" + convBoolean(ExternalConfig.MR_ENABLED) + "</font><br>";
				htmltext += "Hide and Seek: <font color=\"LEVEL\">" + convBoolean(ExternalConfig.HAS_ENABLED) + "</font><br>";
				break;
			default:
				title = "Not Found!";
				htmltext = "Not Found!";
	...
	{
		int p = 0;
		for (final String pIndex : ExternalConfig.SERVERINFO_NPC_DISABLE_PAGE)
	...
	public String htmlPage(String op)
	{
		String texto = "";
		if (op == "Title")
			texto += "<html><body><title>Rename Manager</title><center><br>" + "<b><font color=ffcc00>Server Information</font></b>"
