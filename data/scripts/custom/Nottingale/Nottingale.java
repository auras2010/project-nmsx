...
{
    private static String qn = "Nottingale";
    
    private static final int NOTTINGALE = 32627;
    
    public Nottingale(int id, String name, String descr)
	{
		super(id, name, descr);
    ...
    {        
        final QuestState qs = player.getQuestState("10273_GoodDayToFly");
