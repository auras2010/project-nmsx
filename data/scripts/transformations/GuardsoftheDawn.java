...
{
	private static final int[] SKILLS = { 5491, 922, 619 };
	...
	public void transformedSkills()
	{
		...
		// Hide
		getPlayer().addSkill(SkillTable.getInstance().getInfo(922, 1), false);
		// Transform Dispel
	...
	public void removeSkills()
	{
		...
		// Hide
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(922, 1), false);
		// Transform Dispel
