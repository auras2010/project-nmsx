 ...
 */
package quests._111_Elrokian_Hunters_Proof;
...
public class _111_Elrokian_Hunters_Proof extends Quest
{
	...
	{		
		...
		{
			case 4:
				if (contains(QUEST_MONSTERS1, npcId))
				{
				...
				break;
			case 10:
				if (contains(QUEST_MONSTERS2, npcId))
				{
				...
				else if (contains(QUEST_MONSTERS3, npcId))
				{
					if (st.getRandom(100) < 75)
					{
						st.giveItems(8772,1);
				...
				else if (contains(QUEST_MONSTERS4, npcId))
				{
					if (st.getRandom(100) < 75)
					{
						st.giveItems(8771,1);
	...
	{
		new _111_Elrokian_Hunters_Proof(111, "_111_Elrokian_Hunters_Proof", "Elrokian Hunters Proof");
	}	
}
