...
/**
 * 
 * @author moved to java by DS, jython script by BiTi! and DrLecter, Synerge
 *
 */
public final class _637_ThroughOnceMore extends Quest
{
		...
		switch (st.getState())
		{
			...
			case State.CREATED :
				if (player.getLevel() > 72)
				{
					...
					if (st.getQuestItemsCount(PAGAN_MARK) > 0)
					{
						st.exitQuest(true);
						return "32010-0.htm";
					}
	...
	{
		new _637_ThroughOnceMore(637, "_637_ThroughOnceMore", "Through the Gate Once More");
	}
}
