...
public class _023_LidiasHeart extends Quest
{
	...
	{
		GHOST_OF_VON_HELLMANN = st.addSpawn(GHOST_OF_VON_HELLMAN_ID ,51432, -54570, -3136 ,Rnd.get(0, 20), false, 180000);
		GHOST_OF_VON_HELLMANN.broadcastNpcSay("Who awoke me?");
	}
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch (st.getState())
		{
			case State.COMPLETED :
				...
				break;
			case State.CREATED :
				final QuestState qs = st.getPlayer().getQuestState("_022_TragedyInVonHellmannForest");
						...
						switch (cond)
						{
							...
							case 10:
								if (st.getQuestItemsCount(SILVER_SPEAR) != 0)
								{
									...
									st.addRewardExpAndSp(456893,42112);
									st.giveReward(ADENA, 300000);
	...
	{
		new _023_LidiasHeart(23, "_023_LidiasHeart", "Lidia's Heart");    	
	}
}
