...
public class _002_WhatWomenWant extends Quest
{
					...
					switch (cond)
					{
						...
						case 5:
							if (qs.getQuestItemsCount(QUEST_ITEM[4]) > 0)
							{
								...
								qs.addRewardExpAndSp(4254 * Math.round(Config.RATE_QUEST_REWARD_XP), 335 * Math.round(Config.RATE_QUEST_REWARD_SP));
								qs.set("cond", "0");
								qs.exitQuest(false);
								qs.playSound("ItemSound.quest_finish");
							}
	...
	{
		new _002_WhatWomenWant(2, "_002_WhatWomenWant", "What Women Want");
	}
}
