...
PLAIN_DINOSAURS = [22200,22201,22202,22203,22204,22205,22208,22209,22210,22211,22212,22213,22219,22220,22221,22222,22224,22225,22226,22227,22742,22743,22744,22745]
 ...
 def onAdvEvent (self,event,npc, player) :
    ...
    if event == "None" :
       ...
       if count >= 300 :
          ...
          st.rewardItems(REWARDS[st.getRandom(len(REWARDS))],int(5*ExternalConfig.RiseandFalloftheElrokiTribeReward))
       else :
 ...
 def onKill (self, npc, player,isPet):
    ...
    if st :
       if st.getState() == State.STARTED :
          ...
          count = st.getQuestItemsCount(BONES_OF_A_PLAINS_DINOSAUR)
          if cond == 1 :
             chance = ExternalConfig.RiseandFalloftheElrokiTribeDropChance
