...
public final class _511_AwlUnderFoot extends Quest
{
	...
	private String checkFortCondition(L2PcInstance player, L2Npc npc, boolean isEnter)
	{
		...
		final FortDungeon dungeon = _fortDungeons.get(npc.getNpcId());
	...
	public String onAdvEvent (String event, L2Npc npc, L2PcInstance player)
	{
		if (event.equalsIgnoreCase("enter"))
		{
			...
			tele[1] = 246380;
			tele[2] = -6580;
			return enterInstance(player, "RimPailakaFort.xml", tele, _fortDungeons.get(npc.getNpcId()), checkFortCondition(player, npc, true));
		}
	...
	{
		new _511_AwlUnderFoot(511, "_511_AwlUnderFoot", "instances");
	}
}
