...
public class Wedding implements IVoicedCommandHandler
{
	...
	public boolean goToLove(L2PcInstance activeChar)
	{
		...
		{
			activeChar.sendMessage("Can not teleport because the cursed weapon equipped.");
			return false;
		}
		else if (partner.isCursedWeaponEquipped())
		{
			activeChar.sendMessage("Can not teleport because the partner is useing cursed weapon.");
			return false;
		}
