...
public class ClanPenalty implements IUserCommandHandler
{
	...
	public boolean useUserCommand(final int id, final L2PcInstance activeChar)
	{
		...
		if (activeChar.getClanJoinExpiryTime() > timeNow)
		...
		else if (activeChar.getClanCreateExpiryTime() > timeNow)
		...
		else if (activeChar.getClan() != null && activeChar.getClan().getCharPenaltyExpiryTime() > timeNow)
