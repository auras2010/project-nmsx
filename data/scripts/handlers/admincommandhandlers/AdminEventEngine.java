...
public class AdminEventEngine implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(final String command, final L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_event_control_begin"))
		{
			try
			{
				...
				{
					final LinkedList<String> link = new LinkedList<String>();
	...
	public String showStoredEvents()
	{
	...
	public void muestraNpcConInfoAPlayers(final L2PcInstance activeChar, final int id)
	{
		L2Event.npcs.clear();
		final LinkedList<L2PcInstance> temp = new LinkedList<L2PcInstance>();
		temp.clear();
	...
	public void showEventControl(final L2PcInstance activeChar)
	{
		final NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
	...
	public String getMaxLeveledPlayer()
	{
	...
	public void teleportTeam(final L2PcInstance activeChar, final int team)
	{
	...
	public void sitTeam(final int team)
	{
		final LinkedList<String> linked = L2Event.players.get(team);
		final Iterator<String> it = linked.iterator();
		while (it.hasNext())
	...
	public void killTeam(final L2PcInstance activeChar, final int team)
	{
		final LinkedList<String> linked = L2Event.players.get(team);
		final Iterator<String> it = linked.iterator();
		while (it.hasNext())
	...
	public void resTeam(final int team)
	{
		final LinkedList<String> linked = L2Event.players.get(team);
		final Iterator<String> it = linked.iterator();
		while (it.hasNext())
	...
	public void regardTeam(final L2PcInstance activeChar, final int team, final int n, final int id, final String type)
	{
		final LinkedList<String> linked = L2Event.players.get(team);
		int temp = n;
		final Iterator<String> it = linked.iterator();
	...
	public void telePlayersBack(final int team)
	{
		resTeam(team);
		unpolyTeam(team);
		final LinkedList<String> linked = L2Event.players.get(team);
