 ...
 * 
 * @author InsOmnia, StevenP, Synerge
 */
public class TheValentine extends Quest 
{
	// Event Start Date
	private static final String EVENT_DATE = "10 02 2012-17 02 2012";
	...
	{ 	
		147698, 147443, 82218, 82754, 15064, 111067, -12965, 87362, -81037, 
		117412, 43983, -45907, 12153, -84458, 114750, -45656, -117195 
	};
	
	// Y cords for Queen of Hearts spawn
	private static final int[] Y_CORDS = 
	{ 	
		-56025, 26942, 148608, 53573, 143254, 218933, 122914, -143166, 150092, 76642, 
		-47758, 49387, 16753, 244761, -178692, -113119, 46837 
	};
	
	// Z cords for Queen of Hearts spawn
	private static final int[] Z_CORDS = 
	{ 	
		-2775, -2205, -3473, -1496, -2668, -3543, -3117, -1293, -3044, 
		-2695, -797, -3060, -4584, -3730, -820, -240, 367 
	};
	...
	{
		if (npc.getNpcId() != QUEEN_OF_HEARTS)
			return null;
	...
	{
		new TheValentine(-1, "TheValentine", "events");
	}
}
