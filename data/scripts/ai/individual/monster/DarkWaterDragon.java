...
public class DarkWaterDragon extends L2AttackableAIScript
{
	...
	public DarkWaterDragon(int id, String name, String descr)
	{
		...
		final int[] mobs = { DRAGON, SHADE1, SHADE2, FAFURION, DETRACTOR1, DETRACTOR2 };
		registerMobs(mobs, QuestEventType.ON_ATTACK, QuestEventType.ON_SPAWN, QuestEventType.ON_KILL);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		switch (npc.getNpcId())
		{
			case DRAGON:
				...
				final L2Attackable faf = (L2Attackable) this.addSpawn(FAFURION, npc.getX(), npc.getY(), npc.getZ(), 0, false, 0); //spawns Fafurion Kindred when Dard Water Dragon is dead
