...
public class Mutation extends L2AttackableAIScript
{
	...
	{
		// Old npcId
		{ 20835, 21608, 20832, 21602, 20833, 21605, 21625, 21623, 20842, 21620 },
		// New NpcId
		{ 21608, 21609, 21602, 21603, 21605, 21606, 21623, 21624, 21620, 21621 }
	}; 

	public Mutation(int questId, String name, String descr)
	{
		super(questId, name, descr);		
		registerMobs(MUTATION_IDS[0], QuestEventType.ON_ATTACK);
	}
	...
	public String onAttack(L2Npc npc, L2PcInstance player, int damage, boolean isPet)
	{
		...
		{
			final int arrId = getContainsId(MUTATION_IDS[0], npcId);
			if (!(arrId < 0))
			{
				npc.broadcastNpcSay(NPCS_MESSAGES[4]);
				npc.deleteMe();
				final L2Npc newNpc = addSpawn(MUTATION_IDS[1][arrId], npc);
