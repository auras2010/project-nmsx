...
/**
 * Growth-capable mobs: Polymorphing upon successful feeding. Freya Beast Farm
 * @author Fulminus
...
public class BeastFarm extends L2AttackableAIScript
{
	...
	public void spawnNext(L2Npc npc, L2PcInstance player, int nextNpcId, int food)
	{
		...
		if (Util.contains(TAMED_BEASTS,nextNpcId))
		{
			...
			QuestState st = player.getQuestState("_20_BringUpWithLove");
	...
	public String onSkillSee (L2Npc npc, L2PcInstance caster, L2Skill skill, L2Object[] targets, boolean isPet)
	{
		...
		if (!Util.contains(FEEDABLE_BEASTS,npcId))
		{
			switch (skillId)
			{
				...
				case SKILL_BLESSED_GOLDEN_SPICE:
				case SKILL_BLESSED_CRYSTAL_SPICE:
				case SKILL_SGRADE_GOLDEN_SPICE:
				case SKILL_SGRADE_CRYSTAL_SPICE:
					break;
				default:
					return super.onSkillSee(npc,caster,skill,targets,isPet);
			}
	...
	public static void main(String[] args)
	{
		...
		new BeastFarm(-1, "BeastFarm", "ai");
		System.out.println("AI: BeastFarm loaded");
	}
}
