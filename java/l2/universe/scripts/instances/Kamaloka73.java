...
public class Kamaloka73 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka73(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka73";
		param.Template = "Kamaloka_73.xml";
		param.Level = 73;
		param.Npc = 31340;
		param.Mob = 18577;
		param.Minion = 18578;
		param.enterCoord = newCoord(-49080,-207033,-8117);
		param.ClientId = 57;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka73(-1, "Kamaloka73", "Kamaloka73");
	}
