...
import l2.universe.gameserver.model.L2Territory;
...
public class Stage1 extends Quest
{
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		else if (channel.getChannelLeader() != player)
		{
            ...
            {
			player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.PARTY_REQUIREMENTS_NOT_MET));
			return false;
		}
            else if (channel.getMemberCount() > MAX_PLAYERS)
		{
