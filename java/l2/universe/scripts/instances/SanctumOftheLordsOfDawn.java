...
import l2.universe.gameserver.network.serverpackets.CameraMode;
import l2.universe.gameserver.network.serverpackets.ExStartScenePlayer;
import l2.universe.gameserver.network.serverpackets.NormalCamera;
...
{	
	...
	protected void spawnState(HSWorld world)
	{
		...
		final L2Npc npcc = addSpawn(27347, -74948, 213468, -7218,0,false,0,false,world.instanceId);
					...
					switch (doorst)
					{
						...
						case 1:
							...
							for (final int objId : world.allowed)
							{
								...
								if (pl != null)
									pl.showQuestMovie(ExStartScenePlayer.SSQ_RITUAL_OF_PRIEST);
