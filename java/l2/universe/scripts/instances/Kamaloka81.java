...
public class Kamaloka81 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka81(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka81";
		param.Template = "Kamaloka_81.xml";
		param.Level = 81;
		param.PartySize = 9;
		param.Npc = 31340;
		param.Mob = 29147;
		param.Minion = 0;
		param.enterCoord = newCoord(21731,-174886,-10912);
		param.ClientId = 73;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka81(-1, "Kamaloka81", "Kamaloka81");
	}
