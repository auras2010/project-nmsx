...
public class Kamaloka59 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka59(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka59";
		param.Template = "Kamaloka_59.xml";
		param.Level = 59;
		param.PartySize = 9;
		param.Npc = 30196;
		param.Mob = 29138;
		param.Minion = 0;
		param.enterCoord = newCoord(-43731,-185520,-10976);
		param.ClientId = 73;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka59(-1, "Kamaloka59", "Kamaloka59");
	}
