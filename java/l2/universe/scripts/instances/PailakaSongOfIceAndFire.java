...
public class PailakaSongOfIceAndFire extends Quest
{
	...
	private static final int MAX_SUMMON_LEVEL = 45;
	...
	{
		SWORD, ENH_SWORD1, ENH_SWORD2, BOOK1, BOOK2, BOOK3, BOOK4, BOOK5, BOOK6, BOOK7,
	...
	static
	{
		DROPLIST.add(new PailakaDrop(BLOOM, SHIELD_POTION, 30));
		DROPLIST.add(new PailakaDrop(BLOOM, HEAL_POTION, 80));
		DROPLIST.add(new PailakaDrop(BOTTLE, SHIELD_POTION, 10));
		DROPLIST.add(new PailakaDrop(BOTTLE, WATER_ENHANCER, 40));
		DROPLIST.add(new PailakaDrop(BOTTLE, HEAL_POTION, 80));
		DROPLIST.add(new PailakaDrop(BRAZIER, SHIELD_POTION, 10));
		DROPLIST.add(new PailakaDrop(BRAZIER, FIRE_ENHANCER, 40));
		DROPLIST.add(new PailakaDrop(BRAZIER, HEAL_POTION, 80));
	};
	...
	private static class PailakaDrop
	{
		...
		public PailakaDrop(int npcId, int itemId, int chance)
		{
			_itemId = itemId;
			_chance = chance;
			_npcId = npcId;
