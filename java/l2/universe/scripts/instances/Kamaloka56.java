...
public class Kamaloka56 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka56(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka56";
		param.Template = "Kamaloka_56.xml";
		param.Level = 56;
		param.Npc = 30196;
		param.Mob = 18568;
		param.Minion = 18569;
		param.enterCoord = newCoord(-49337,-220890,-8071);
		param.ClientId = 57;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka56(-1, "Kamaloka56", "Kamaloka56");
	}
