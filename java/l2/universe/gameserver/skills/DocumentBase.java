 ...
 */
package l2.universe.gameserver.skills;
...
import l2.universe.gameserver.model.ChanceCondition;
...
import l2.universe.gameserver.skills.conditions.ConditionChangeWeapon;
import l2.universe.gameserver.skills.conditions.ConditionForceBuff;
import l2.universe.gameserver.skills.conditions.ConditionGameChance;
import l2.universe.gameserver.skills.conditions.ConditionGameTime;
import l2.universe.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import l2.universe.gameserver.skills.conditions.ConditionGameWithSkill;
import l2.universe.gameserver.skills.conditions.ConditionLogicAnd;
import l2.universe.gameserver.skills.conditions.ConditionLogicNot;
import l2.universe.gameserver.skills.conditions.ConditionLogicOr;
import l2.universe.gameserver.skills.conditions.ConditionMinDistance;
import l2.universe.gameserver.skills.conditions.ConditionPlayerActiveEffectId;
import l2.universe.gameserver.skills.conditions.ConditionPlayerActiveSkillId;
import l2.universe.gameserver.skills.conditions.ConditionPlayerAgathionId;
import l2.universe.gameserver.skills.conditions.ConditionPlayerCharges;
...
import l2.universe.gameserver.skills.conditions.ConditionPlayerCp;
import l2.universe.gameserver.skills.conditions.ConditionPlayerFlyMounted;
import l2.universe.gameserver.skills.conditions.ConditionPlayerGrade;
...
import l2.universe.gameserver.skills.conditions.ConditionPlayerHasPet;
import l2.universe.gameserver.skills.conditions.ConditionPlayerHp;
import l2.universe.gameserver.skills.conditions.ConditionPlayerInstanceId;
import l2.universe.gameserver.skills.conditions.ConditionPlayerInvSize;
...
import l2.universe.gameserver.skills.conditions.ConditionPlayerLandingZone;
import l2.universe.gameserver.skills.conditions.ConditionPlayerLevel;
import l2.universe.gameserver.skills.conditions.ConditionPlayerMp;
import l2.universe.gameserver.skills.conditions.ConditionPlayerPkCount;
import l2.universe.gameserver.skills.conditions.ConditionPlayerPledgeClass;
import l2.universe.gameserver.skills.conditions.ConditionPlayerRace;
import l2.universe.gameserver.skills.conditions.ConditionPlayerRangeFromNpc;
import l2.universe.gameserver.skills.conditions.ConditionPlayerServitorNpcId;
import l2.universe.gameserver.skills.conditions.ConditionPlayerSex;
import l2.universe.gameserver.skills.conditions.ConditionPlayerSiegeSide;
import l2.universe.gameserver.skills.conditions.ConditionPlayerSouls;
...
import l2.universe.gameserver.skills.conditions.ConditionPlayerTvTEvent;
import l2.universe.gameserver.skills.conditions.ConditionPlayerTvTRoundEvent;
import l2.universe.gameserver.skills.conditions.ConditionPlayerWeight;
import l2.universe.gameserver.skills.conditions.ConditionSiegeZone;
import l2.universe.gameserver.skills.conditions.ConditionSkillStats;
import l2.universe.gameserver.skills.conditions.ConditionSlotItemId;
import l2.universe.gameserver.skills.conditions.ConditionTargetAbnormal;
import l2.universe.gameserver.skills.conditions.ConditionTargetActiveEffectId;
import l2.universe.gameserver.skills.conditions.ConditionTargetActiveSkillId;
import l2.universe.gameserver.skills.conditions.ConditionTargetAggro;
import l2.universe.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import l2.universe.gameserver.skills.conditions.ConditionTargetLevel;
import l2.universe.gameserver.skills.conditions.ConditionTargetNpcId;
import l2.universe.gameserver.skills.conditions.ConditionTargetNpcType;
import l2.universe.gameserver.skills.conditions.ConditionTargetPlayable;
import l2.universe.gameserver.skills.conditions.ConditionTargetRace;
import l2.universe.gameserver.skills.conditions.ConditionTargetRaceId;
import l2.universe.gameserver.skills.conditions.ConditionTargetUsingKind;
import l2.universe.gameserver.skills.conditions.ConditionUsingItemType;
import l2.universe.gameserver.skills.conditions.ConditionUsingSkill;
...
import l2.universe.gameserver.skills.funcs.Lambda;
import l2.universe.gameserver.skills.funcs.LambdaCalc;
import l2.universe.gameserver.skills.funcs.LambdaConst;
import l2.universe.gameserver.skills.funcs.LambdaStats;
...
abstract class DocumentBase
{
	...
	protected void attachEffect(Node n, Object template, Condition attachCond)
	{
		...
		if (effectPower > -1 && type == null && _log.isLoggable(Level.WARNING))
			_log.log(Level.WARNING, "Missing effectType for effect: " + name + " on skill: " + ((L2Skill) template).getName());
		...
		EffectTemplate lt = new EffectTemplate(attachCond, applayCond, name, lambda, count, time, abnormal, special, event, stackType, stackOrder, icon, effectPower, type, trigId, trigLvl, chance);
		parseTemplate(n, lt);
	...
	protected Condition parsePlayerCondition(Node n, Object template)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			else if ("flag".equalsIgnoreCase(a.getNodeName()))
			{
				boolean val = Boolean.valueOf(a.getNodeValue());
				cond = joinAnd(cond, new ConditionPlayerState(PlayerState.FLAG, val));
			}
	...
	protected Condition parseTargetCondition(Node n, Object template)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			else if ("using".equalsIgnoreCase(a.getNodeName()))
			{
				...
				cond = joinAnd(cond, new ConditionTargetUsingKind(mask));
			}
	...
	protected Condition parseGameCondition(Node n)
	{
		...
		for (int i = 0; i < attrs.getLength(); i++)
		{
			...
			{
				boolean val = Boolean.valueOf(a.getNodeValue());
				cond = joinAnd(cond, new ConditionGameWithSkill(val));
			}
