...
public class ItemMarketTable
{
	...
	private void load()
	{
		...
		{
			_log.severe("Error while loading market items " + e.getMessage());
		}
		finally
		{
	...
	private void loadSellers()
	{
		...
		{
			_log.severe("Error while loading market sellers " + e.getMessage());
		}
		finally
		{
			L2DatabaseFactory.close(con);
	...
	private void loadIcons()
	{
		...
		{
			_log.severe("Error while loading market icons " + e.getMessage());
		}
		finally
		{
			L2DatabaseFactory.close(con);
	...
	private static class SaveTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.severe("Error while saving market item into DB " + e.getMessage());
			}
			finally
			{
				L2DatabaseFactory.close(con);
	...
	private static class DeleteTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.severe("Error while deleting market item from DB " + e.getMessage());
			}
			finally
			{
				L2DatabaseFactory.close(con);
	...
	private static class UpdateTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.severe("Error while updating market item in DB " + e.getMessage());
			}
			finally
			{
				L2DatabaseFactory.close(con);
	...
	private static class AddMoneyTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.severe("Error while adding money in DB " + e.getMessage());
			}
			finally
			{
				L2DatabaseFactory.close(con);
	...
	private static class AddSellerTask implements Runnable
	{
		...
		public void run()
		{
			...
			{
				_log.severe("Error while adding seller in DB " + e.getMessage());
			}
			finally
			{
				L2DatabaseFactory.close(con);
