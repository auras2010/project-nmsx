...
public class ClanTable
{
	...
	/**
	 * Returns list of clans in alliance.
	 * 
	 * @param allyId
	 *            alliance id
	 * 
	 * @return list of clans in alliance
	 */
	public List<L2Clan> getClansInAlly(final int allyId)
	{
		final List<L2Clan> result = new ArrayList<L2Clan>();		
		for (final L2Clan clan : _clans.values())
		{
