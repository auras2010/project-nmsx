...
{
	private static final String _S__FE_86_EXGETPREMIUMITEMLISTPACKET = "[S] FE:86 ExGetPremiumItemListPacket";
	private L2PcInstance _activeChar;
	private Map<Integer, L2PremiumItem> _list;

	public ExGetPremiumItemListPacket(L2PcInstance activeChar)
	{
    ...
    protected void writeImpl()
    {
	    ...
	    if (!_list.isEmpty())
	    {
	    	...
	    	{
	    		final L2PremiumItem item = _list.get(num);
    ...
    {
	    return _S__FE_86_EXGETPREMIUMITEMLISTPACKET;
    }
}