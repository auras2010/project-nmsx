...
import static l2.universe.gameserver.datatables.MultiSell.PAGE_SIZE;

import l2.universe.Config;
import l2.universe.gameserver.model.multisell.Entry;
import l2.universe.gameserver.model.multisell.Ingredient;
import l2.universe.gameserver.model.multisell.ListContainer;
	...
	protected void writeImpl()
    {
		...
		while (_size-- > 0)
        {
			...
			for(Ingredient ing : ent.getIngredients())
			{
                 ...
                 * This is the multisell preview packet
                 */
                writeQ((long) (ing.getTemplate() != null && ing.getTemplate().isStackable() ? ing.getItemCount() * Config.RATE_MULTISELL_ITEMS_COST : ing.getItemCount()));	//Count
