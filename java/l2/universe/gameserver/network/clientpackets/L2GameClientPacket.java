...
public abstract class L2GameClientPacket extends ReceivablePacket<L2GameClient>
{
	...
	public boolean read()
	{
		...
		{
			_log.log(Level.SEVERE, "Client: " + getClient().toString() + " - Failed reading: " + getType() + " - L2Universe Version: " + Config.SERVER_VERSION + " - DP Revision: " + Config.DATAPACK_VERSION + " ; " + e.getMessage(), e);
