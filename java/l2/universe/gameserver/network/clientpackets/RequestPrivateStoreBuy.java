...
import l2.universe.gameserver.model.ItemRequest;
...
public final class RequestPrivateStoreBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (storePlayer.getPrivateStoreType() == L2PcInstance.STORE_PRIVATE_PACKAGE_SELL)
		{
			...
			{
				String msgErr = "[RequestPrivateStoreBuy] player " + player.getName() + " tried to buy less items than sold by package-sell, ban this player for bot usage!";
