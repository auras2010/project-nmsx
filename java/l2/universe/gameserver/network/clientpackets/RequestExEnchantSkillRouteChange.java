...
import l2.universe.gameserver.model.L2EnchantSkillGroup.EnchantSkillDetail;
import l2.universe.gameserver.model.actor.instance.L2PcInstance;
import l2.universe.gameserver.network.SystemMessageId;
import l2.universe.gameserver.network.serverpackets.ExBrExtraUserInfo;
import l2.universe.gameserver.network.serverpackets.ExEnchantSkillInfo;
import l2.universe.gameserver.network.serverpackets.ExEnchantSkillInfoDetail;
import l2.universe.gameserver.network.serverpackets.ExEnchantSkillResult;
import l2.universe.gameserver.network.serverpackets.ShortCutRegister;
...
public final class RequestExEnchantSkillRouteChange extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (player.getSp() >= requiredSp)
		{
			...
			L2ItemInstance spb = player.getInventory().getItemByItemId(EnchantGroupsTable.CHANGE_ENCHANT_BOOK);
