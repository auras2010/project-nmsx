 ...
 */
package l2.universe.gameserver.templates.effects;
...
public class EffectTemplate
{
			...
			double ePower, L2SkillType eType, int trigId, int trigLvl, ChanceCondition chanceCond)
	{
		...
		try
		{
			_func = Class.forName("l2.universe.gameserver.skills.effects.Effect" + func);
		}
	...
	public L2Effect getStolenEffect(Env env, L2Effect stolen)
	{
		...
		try
		{
			func = Class.forName("l2.universe.gameserver.skills.effects.Effect"
