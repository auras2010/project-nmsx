...
import l2.universe.gameserver.model.entity.events.BlockCheckerEngine;
...
import l2.universe.gameserver.network.serverpackets.ExCubeGameAddPlayer;
import l2.universe.gameserver.network.serverpackets.ExCubeGameChangeTeam;
import l2.universe.gameserver.network.serverpackets.ExCubeGameRemovePlayer;
...
public final class HandysBlockCheckerManager 
{
	...
	public synchronized void increaseArenaVotes(int arena)
	{
		...
		if(newVotes > holder.getAllPlayers().size() / 2 && !holder.getEvent().isStarted())
		{
			...
			if(ExternalConfig.HBCE_FAIR_PLAY)
