...
import l2.universe.gameserver.model.zone.form.ZoneCuboid;
import l2.universe.gameserver.model.zone.form.ZoneCylinder;
import l2.universe.gameserver.model.zone.form.ZoneNPoly;
import l2.universe.gameserver.model.zone.type.L2ArenaZone;
import l2.universe.gameserver.model.zone.type.L2OlympiadStadiumZone;
...
public class ZoneManager
{
					...
					if ("list".equalsIgnoreCase(n.getNodeName()))
					{
						...
						for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
						{
							if ("zone".equalsIgnoreCase(d.getNodeName()))
							{
								...
								try
								{
									newZone = Class.forName("l2.universe.gameserver.model.zone.type.L2" + zoneType);
								}
	...
	public final L2ArenaZone getArena(L2Character character)
	{
		...
		FastList<L2ZoneType> region = ZoneManager.getInstance().getZones(character.getX(), character.getY(), character.getZ());
		for (L2ZoneType temp : region)
		{
