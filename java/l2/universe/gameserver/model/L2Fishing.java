...
import l2.universe.gameserver.model.actor.instance.L2PenaltyMonsterInstance;
import l2.universe.gameserver.network.SystemMessageId;
import l2.universe.gameserver.network.serverpackets.ExFishingHpRegen;
import l2.universe.gameserver.network.serverpackets.ExFishingStartCombat;
...
public class L2Fishing implements Runnable
{
	...
	public synchronized void doDie(boolean win)
	{
		...
		else if (Config.MOD_FISHERMAN_ENABLED) 
		{
