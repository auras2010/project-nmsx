...
import l2.universe.gameserver.model.actor.stat.PetStat;
...
public class L2PetInstance extends L2Summon
{
	...
	public void addExpAndSp(long addToExp, int addToSp)
	{
		...
		// Wolf or Strider
		else if (isWolfStrider())
			getStat().addExpAndSp(Math.round(addToExp * Config.PET_MOUNTABLE_XP_RATE), addToSp);
		else
	...
	// Synerge - Returns true if is a Wolf or Strider
	public boolean isWolfStrider()
	{
		switch (getNpcId())
		{
			// Striders y and wolfs
			case 12077: // Wolf
			case 12526: // Wind
			case 12527: // Star
			case 12528: // Twilight
			case 12311: // Hatchling of the Wind
			case 12312: // Hatchling of the Stars
