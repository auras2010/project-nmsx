...
import l2.universe.gameserver.datatables.MerchantPriceConfigTable.MerchantPriceConfig;
import l2.universe.gameserver.model.L2TradeList;
import l2.universe.gameserver.network.serverpackets.ActionFailed;
import l2.universe.gameserver.network.serverpackets.BuyList;
import l2.universe.gameserver.network.serverpackets.ExBuySellListPacket;
...
public class L2MerchantInstance extends L2NpcInstance
{
	...
	public final void showBuyWindow(L2PcInstance player, int val)
	{
		...
		else
		{
			...
			final String errMsg = "possible client hacker: "+player.getName()+" attempting to buy from GM shop! < Ban him!";
			Util.handleIllegalPlayerAction(player, errMsg, Config.DEFAULT_PUNISH);
		}
