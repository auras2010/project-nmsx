...
public class TvTEventTeleporter implements Runnable
{
	...
	public TvTEventTeleporter(L2PcInstance playerInstance, int[] coordinates, boolean fastSchedule, boolean adminRemove)
	{
		...
		final long delay = (TvTEvent.isStarted() ? ExternalConfig.TVT_EVENT_RESPAWN_TELEPORT_DELAY : ExternalConfig.TVT_EVENT_START_LEAVE_TELEPORT_DELAY) * 1000;
	...
	public void run()
	{
		...
		if (ExternalConfig.TVT_EVENT_EFFECTS_REMOVAL == 0 || (ExternalConfig.TVT_EVENT_EFFECTS_REMOVAL == 1 && (_playerInstance.getTeam() == 0 || (_playerInstance.isInDuel() && _playerInstance.getDuelState() != Duel.DUELSTATE_INTERRUPTED))))
