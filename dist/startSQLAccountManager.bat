...
color 17
java -Djava.util.logging.config.file=console.cfg -cp ./../libs/*;l2universelogin.jar l2.universe.accountmanager.SQLAccountManager 2> NUL
if %errorlevel% == 0 (
echo.
...
echo.
echo An error has ocurred while running the l2universe Account Manager!
echo.
