...
{	
	...
	public boolean onActionTime()
	{
		...
		final L2Character target = targetList.get(nextTargetIdx);
		
		// Synerge - Bug with confusion in peace zone
		if (target.isInsideZone(L2Character.ZONE_PEACE) && !Config.ALT_MOB_AGRO_IN_PEACEZONE)
			return true;
