	...
	public boolean onStart()
	{
		...
		if (target.isDead() == false)
		{
			...
			if (spoil)
			{
				...
				if (Config.SHOW_TO_PARTY_MEMBERS_SPOIL_SUCCESS && (getEffector().getParty() != null))
					getEffector().getParty().broadcastToPartyMembers(SystemMessage.getSystemMessage(SystemMessageId.SPOIL_SUCCESS));
				else
