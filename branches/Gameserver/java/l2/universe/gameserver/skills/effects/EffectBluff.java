...
import l2.universe.gameserver.network.serverpackets.StartRotation;
...
public class EffectBluff extends L2Effect
{
	...
	public void onExit()
	{
		getEffected().stopBluffed(false);
		getEffected().broadcastPacket(new ValidateLocation(getEffected())); // This must be send???
	}
}
