...
public class ConditionTargetClassIdRestriction extends Condition
{
	 ...
	 *
	 * @param classId the class id list
	 */
	 ...
	 */
	public ConditionTargetClassIdRestriction(int classId)
	{
		_classIds = new ArrayList<Integer>();
	...
	public boolean testImpl(Env env)
	{
		...
		return _classIds == null || (_classIds.contains(((L2PcInstance)env.target).getClassId().getId()));
	}
}
