...
public class InstanceManager
{
	...
	{
		if (_playerInstanceTimes == null || _playerInstanceTimes.containsKey(playerObjId))
		 {
	...
	{
		if (_instanceIdNames != null && _instanceIdNames.containsKey(id))
		{
	...
	public InstanceWorld getPlayerWorld(L2PcInstance player)
	{
		for (InstanceWorld temp : _instanceWorlds.values())
		{
			...
			{
				_log.info("Trouble with instance: " + temp.instanceId + ". Check it!!!");
				continue;
			}
	...
	{
		if (instanceid <= 0 || _instanceList == null)
		{
			return;
		}
