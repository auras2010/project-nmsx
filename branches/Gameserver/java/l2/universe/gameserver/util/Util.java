...
public final class Util
{
	 ...
	 */
	public static boolean checkIfInRange(int range, int col, int x, int y, int z, L2Object obj2, boolean includeZAxis) 
	{
		if (obj2 == null)
			return false;
		if (range == -1)
	...
	// Synerge - Checks maxs Z difference
	public static boolean checkIfInRange(int range, L2Object obj1, L2Object obj2, int height)
	{
		if (obj1 == null || obj2 == null)
			return false;
		if (obj1.getInstanceId() != obj2.getInstanceId())
		...
		// If not in Z fixed radius
		if (Math.abs(obj2.getZ() - obj1.getZ()) > height)
			return false;
