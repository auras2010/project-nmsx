...
import l2.universe.gameserver.model.actor.knownlist.ObjectKnownList;
import l2.universe.gameserver.model.actor.poly.ObjectPoly;
import l2.universe.gameserver.model.actor.position.ObjectPosition;
import l2.universe.gameserver.model.entity.Instance;
import l2.universe.gameserver.network.serverpackets.ActionFailed;
import l2.universe.gameserver.network.serverpackets.ExSendUIEvent;
...
public abstract class L2Object
{
    ...
    /**
	 * Short versions of instanceof comparison, used l2object for top hierarchy, can include several 
	 * comparisons. Only objective for better and shorter code writing
	 * Use only when this != null
	 * Synerge
	 */
	...
	{
		return this instanceof L2Summon;
	}
	...
	{
		return this instanceof L2GrandBossInstance;
	}
