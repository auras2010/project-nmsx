...
public class Olympiad
{
	...
	protected long getMillisToValidationEnd()
	{
		...
		if (_validationEnd > cTime)
			return (_validationEnd - cTime);
	...
	{
		long cTime = Calendar.getInstance().getTimeInMillis();
		if (_nextWeeklyChange > cTime)
			return (_nextWeeklyChange - cTime);
	...
	protected synchronized void addWeeklyPoints()
	{
		...
		for (Integer nobleId : _nobles.keySet())
		{
			...
			int currentPoints = nobleInfo.getInteger(POINTS) + WEEKLY_POINTS;
