...
public class L2DropData
{
	...
	/**
	 * Returns true if is a Seal Stone
	 * 
	 * @return int
	 */
	public boolean isSealStone()
	{
		return (getItemId() >= 6360 && getItemId() <= 6362);
	}
	
	/**
	 * Returns true if is common item
	 * 
	 * @return int
	 */
	public boolean isCommonItem()
	{
		return (getItemId() > 12005 && getItemId() < 12362 || getItemId() > 11604
		        && getItemId() < 12309);
	}
	
	/**
	 * Returns true if is raid jewel
	 * 
	 * @return int
	 */
	public boolean isRaidJewel()
	{
		return ((getItemId() > 6655 && getItemId() < 6663) || getItemId() == 8191
		        || getItemId() == 10170 || getItemId() == 10314);
	}
