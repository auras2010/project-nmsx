...
import l2.universe.gameserver.model.zone.type.L2DerbyTrackZone;
import l2.universe.gameserver.model.zone.type.L2PeaceZone;
...
public final class L2WorldRegion
{
    ...
    public boolean checkEffectRangeInsidePeaceZone(L2Skill skill, final int x, final int y, final int z)
    {
    	...
    	for (L2ZoneType e : getZones())
    	{
			if ((e instanceof L2TownZone && ((L2TownZone) e).isPeaceZone())
			        || e instanceof L2DerbyTrackZone || e instanceof L2PeaceZone)
    		{
    ...
    public void onDeath(L2Character character)
	{
		for (L2ZoneType z : getZones())
		{
			if (z != null && z.isCharacterInZone(character))
