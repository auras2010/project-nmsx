...
public class Hero
{
	...
	public boolean isQualifiedToBeAHero(int objId)
	{
			...
			if (htmContent != null)
			{
				...
				if (!_mainlist.isEmpty())
				{
					...
					if (breakat < (_list.size() - 1))
						DiaryReply.replace("%buttprev%", "<button value=\"Prev\" action=\"bypass _diary?class=" + heroclass 
								+ "&page=" + (page + 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
					else
						DiaryReply.replace("%buttprev%", "");
					
					if (page > 1)
						DiaryReply.replace("%buttnext%", "<button value=\"Next\" action=\"bypass _diary?class=" + heroclass 
								+ "&page=" + (page - 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
					else
		...
		if (_herofights.containsKey(charid))
		{
			...
			if (htmContent != null)
			{
				...
				if (!_list.isEmpty())
				{
					...
					if (breakat < (_list.size() - 1))
						FightReply.replace("%buttprev%", "<button value=\"Prev\" action=\"bypass _match?class=" + heroclass 
								+ "&page=" + (page + 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
					else
						FightReply.replace("%buttprev%", "");
					
					if (page > 1)
						FightReply.replace("%buttnext%", "<button value=\"Next\" action=\"bypass _match?class=" + heroclass 
								+ "&page=" + (page - 1) + "\" width=60 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
					else
