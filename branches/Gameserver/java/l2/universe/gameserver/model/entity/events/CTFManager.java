...
public class CTFManager
{
	 ...
	 */
	 private CTFManager()
	 {
		if (ExternalConfig.CTF_EVENT_ENABLED)
		{
			CTF.loadData();

			this.scheduleEventStart();
			_log.info("[Capture The Flag] EventEngine: Engine started.");
		}
		else
		{
			_log.info("[Capture The Flag] EventEngine: Engine is disabled.");
		}
	}
	...
	public void scheduleEventStart()
	{
		try
		{
			...
			for (String timeOfDay : ExternalConfig.CTF_EVENT_INTERVAL)
			{
