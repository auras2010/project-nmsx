...
{
	private static byte _maxLevel = Config.MAX_SUBCLASS_LEVEL < Experience.MAX_LEVEL ? Config.MAX_SUBCLASS_LEVEL : Experience.MAX_LEVEL - 1;
	...
	// Synerge - Added a GM condition to not limit max subclass level
	public SubClass(boolean isGM)
	{
		_isGm = isGM;
		if (_isGm)
			_maxLevel = Experience.MAX_LEVEL - 1;
	}
