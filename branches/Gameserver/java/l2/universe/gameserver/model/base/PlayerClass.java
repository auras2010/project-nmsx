 ...
 */
package l2.universe.gameserver.model.base;

import static l2.universe.gameserver.model.base.ClassLevel.First;
import static l2.universe.gameserver.model.base.ClassLevel.Fourth;
import static l2.universe.gameserver.model.base.ClassLevel.Second;
import static l2.universe.gameserver.model.base.ClassLevel.Third;
import static l2.universe.gameserver.model.base.ClassType.Fighter;
import static l2.universe.gameserver.model.base.ClassType.Mystic;
import static l2.universe.gameserver.model.base.ClassType.Priest;
import static l2.universe.gameserver.model.base.Race.DarkElf;
import static l2.universe.gameserver.model.base.Race.Dwarf;
import static l2.universe.gameserver.model.base.Race.Elf;
import static l2.universe.gameserver.model.base.Race.Human;
import static l2.universe.gameserver.model.base.Race.Kamael;
import static l2.universe.gameserver.model.base.Race.Orc;
	...
	public final Set<PlayerClass> getAvailableSubclasses(L2PcInstance player)
	{
		...
		if (_level == Third)
		{
			if (player.getRace() != Kamael)
			{
				...
				if (!ExternalConfig.ALL_SUBCLASS_AVAILABLE)
				{
