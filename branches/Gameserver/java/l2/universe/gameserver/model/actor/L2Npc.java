...
import l2.universe.gameserver.model.L2NpcAIData;
...
import l2.universe.gameserver.model.actor.instance.L2ClanHallManagerInstance;
import l2.universe.gameserver.model.actor.instance.L2DoormenInstance;
import l2.universe.gameserver.model.actor.instance.L2FestivalGuideInstance;
import l2.universe.gameserver.model.actor.instance.L2FishermanInstance;
...
import l2.universe.gameserver.model.actor.instance.L2TeleporterInstance;
import l2.universe.gameserver.model.actor.instance.L2TrainerInstance;
import l2.universe.gameserver.model.actor.instance.L2WarehouseInstance;
import l2.universe.gameserver.model.actor.knownlist.NpcKnownList;
import l2.universe.gameserver.model.actor.stat.NpcStat;
import l2.universe.gameserver.model.actor.status.NpcStatus;
...
import l2.universe.gameserver.model.zone.type.L2TownZone;
...
import l2.universe.gameserver.network.serverpackets.ExChangeNpcState;
...
public class L2Npc extends L2Character
{
	...
	protected class RandomAnimationTask implements Runnable
	{
		public void run()
		{
			try
			{
				...
				if (!(isDead() || isStunned() || isBluffed() || isSleeping() || isParalyzed()))
	...
	public void onRandomAnimation(int animationId)
	{
		...
		if (now - _lastSocialBroadcast > _minimalSocialInterval)
		{
			...
			SocialAction sa = new SocialAction(getObjectId(), animationId);
			broadcastPacket(sa);
		}
	}
	...
	{
		if (!hasRandomAnimation() || isNoAnimation())
			return;
	...
	public void updateAbnormalEffect()
	{
		...
		for (L2PcInstance player : plrs)
		{
			...
			if (getRunSpeed() == 0 && !isNoAnimation())
	...
	public void showChatWindow(L2PcInstance player, int val)
	{
		...
		switch (npcId)
		{
			...
			case 31113: // Merchant of Mammon
				if (Config.ALT_STRICT_SEVENSIGNS && !player.isGM())
				{
					switch (compWinner)
					{
	...
	{
		if (isPremium)
			return (int) (getTemplate().rewardExp * ExternalConfig.PREMIUM_RATE_XP);
		else
	...
	{
		if (isPremium)
			return (int) (getTemplate().rewardSp * ExternalConfig.PREMIUM_RATE_SP);
		else		
	...
	/**
	 * Broadcasts a text said by this npc to all players in this npc's knowlist
	 */
	...
	// Synerge - This sets mobs that not do any animation
