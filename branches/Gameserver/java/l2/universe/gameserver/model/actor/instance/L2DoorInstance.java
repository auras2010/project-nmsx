...
import l2.universe.gameserver.ai.L2DoorAI;
...
import l2.universe.gameserver.model.actor.knownlist.DoorKnownList;
import l2.universe.gameserver.model.actor.stat.DoorStat;
import l2.universe.gameserver.model.actor.status.DoorStatus;
...
import l2.universe.gameserver.network.serverpackets.DoorStatusUpdate;
import l2.universe.gameserver.network.serverpackets.OnEventTrigger;
...
public class L2DoorInstance extends L2Character
{
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if(getClanHall() != null)
		{
			if(!(getClanHall() instanceof SiegableHall))
				return false;
			else
	...
	public void broadcastStatusUpdate()
	{
		...
		broadcastStatusUpdate(knownPlayers);
	}
		
	public void broadcastStatusUpdate(final Collection<L2PcInstance> players)
	{
