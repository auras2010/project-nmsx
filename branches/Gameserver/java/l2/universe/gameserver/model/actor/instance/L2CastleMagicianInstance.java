	...
	*/
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		else if (command.startsWith("ExchangeKE"))
		{
			...
			{
				if (player.destroyItemByItemId("CastleMagicianKE", 9912, 10, this, false))
				{
					...
					player.addItem("CastleMagicianKE", item, 1, player, true);
	...
	private static final boolean validateGateCondition(L2PcInstance clanLeader, L2PcInstance player)
	{
		...
		{
			player.sendMessage("You're on TvT Event, teleporting disabled.");
			return false;
		}
