...
import l2.universe.gameserver.model.actor.knownlist.DefenderKnownList;
...
public class L2DefenderInstance extends L2Attackable
{
	...
	public L2CharacterAI getAI()
	{
		...
		if (ai == null)
		{
			synchronized(this)
			{
				if (_ai == null)
                {
					if (getConquerableHall() == null && getCastle(10000) == null || getFort(10000) == null)
                    	_ai = new L2DefenderAI(new AIAccessor());
                }
				return _ai;
			}
		}
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
				...
				|| (_hall != null && _hall.getSiegeZone().isActive()))
		{
			...
			switch (player.getSiegeState())
			{
				case 0:
					return true;
				case 1:
					return !TerritoryWarManager.getInstance().isAllyField(player, activeSiegeId);
				case 2:
					return !player.isRegisteredOnThisSiegeField(activeSiegeId);
			}
		}
		return false;
	}
