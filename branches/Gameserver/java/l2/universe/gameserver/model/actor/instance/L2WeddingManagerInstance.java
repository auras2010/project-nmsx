		...
		else
		{
			...
			else
			{
				...
				else if (command.startsWith("AcceptWedding"))
				{
					...
					if (player.getAdena() < Config.MOD_WEDDING_PRICE || ptarget.getAdena() < Config.MOD_WEDDING_PRICE)
					{
					...
					player.reduceAdena("Wedding", Config.MOD_WEDDING_PRICE, player.getLastFolkNPC(), true);
					ptarget.reduceAdena("Wedding", Config.MOD_WEDDING_PRICE, player.getLastFolkNPC(), true);
