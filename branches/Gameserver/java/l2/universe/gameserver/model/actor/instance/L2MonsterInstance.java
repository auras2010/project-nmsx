...
import l2.universe.gameserver.model.actor.knownlist.MonsterKnownList;
...
public class L2MonsterInstance extends L2Attackable
{
	...
	/**
	 * Synerge - This are functions to override the default stats of the npc template, done for instances
	 * that require npcs have aggresivity and clan alliance
	 * I made override of super functions to replace with needed
	 */
	...
	{
		// Synerge - Aggresive override for special mobs
	...
	{
		// Synerge - Clan name override for special mobs
	...
	{
		// Synerge - Default faction range 500
		if (_clanOverride != null)
			return 500;
	...
	/*
	 * Synerge - This is for mobs that can get aggro while doing something else
	 */
	...
	// Synerge - With this function you can force to spawn a minion
	public void spawnOneMinion(int minionId)
	{
		if (_minionList == null)
			return;
		
		_minionList.spawnMinion(minionId);
	}
}
