...
import l2.universe.gameserver.ItemsAutoDestroy;
...
import l2.universe.gameserver.ai.L2PlayerAI;
import l2.universe.gameserver.ai.L2SummonAI;
import l2.universe.gameserver.cache.HtmCache;
import l2.universe.gameserver.cache.WarehouseCacheManager;
...
import l2.universe.gameserver.datatables.CharSummonTable;
import l2.universe.gameserver.datatables.ClanTable;
import l2.universe.gameserver.datatables.EnchantGroupsTable;
import l2.universe.gameserver.datatables.FishTable;
import l2.universe.gameserver.datatables.HennaTable;
import l2.universe.gameserver.datatables.HeroSkillTable;
import l2.universe.gameserver.datatables.ItemTable;
import l2.universe.gameserver.datatables.MapRegionTable;
import l2.universe.gameserver.datatables.NobleSkillTable;
...
import l2.universe.gameserver.datatables.RecordTable;
...
import l2.universe.gameserver.instancemanager.HandysBlockCheckerManager;
import l2.universe.gameserver.instancemanager.InstanceManager;
import l2.universe.gameserver.instancemanager.ItemsOnGroundManager;
...
import l2.universe.gameserver.instancemanager.HandysBlockCheckerManager.ArenaParticipantsHolder;
...
import l2.universe.gameserver.model.FishData;
import l2.universe.gameserver.model.L2AccessLevel;
import l2.universe.gameserver.model.L2Account;
...
import l2.universe.gameserver.model.L2EnchantSkillLearn;
import l2.universe.gameserver.model.L2Fishing;
import l2.universe.gameserver.model.L2HennaInstance;
import l2.universe.gameserver.model.L2ItemInstance;
import l2.universe.gameserver.model.L2Macro;
import l2.universe.gameserver.model.L2ManufactureItem;
import l2.universe.gameserver.model.L2ManufactureList;
import l2.universe.gameserver.model.L2Object;
import l2.universe.gameserver.model.L2Party;
import l2.universe.gameserver.model.L2PetData;
import l2.universe.gameserver.model.L2PetLevelData;
import l2.universe.gameserver.model.L2PremiumItem;
import l2.universe.gameserver.model.L2Radar;
import l2.universe.gameserver.model.L2RecipeList;
import l2.universe.gameserver.model.L2Request;
import l2.universe.gameserver.model.L2ShortCut;
import l2.universe.gameserver.model.L2Skill;
import l2.universe.gameserver.model.L2SkillLearn;
import l2.universe.gameserver.model.L2Transformation;
import l2.universe.gameserver.model.L2UIKeysSettings;
import l2.universe.gameserver.model.L2World;
import l2.universe.gameserver.model.L2WorldRegion;
import l2.universe.gameserver.model.Location;
import l2.universe.gameserver.model.MacroList;
...
import l2.universe.gameserver.model.ShortCuts;
import l2.universe.gameserver.model.TerritoryWard;
import l2.universe.gameserver.model.TradeList;
...
import l2.universe.gameserver.model.actor.L2Decoy;
...
import l2.universe.gameserver.model.actor.L2Vehicle;
import l2.universe.gameserver.model.actor.appearance.PcAppearance;
import l2.universe.gameserver.model.actor.knownlist.PcKnownList;
import l2.universe.gameserver.model.actor.position.PcPosition;
import l2.universe.gameserver.model.actor.stat.PcStat;
import l2.universe.gameserver.model.actor.status.PcStatus;
import l2.universe.gameserver.model.base.ClassId;
import l2.universe.gameserver.model.base.ClassLevel;
import l2.universe.gameserver.model.base.Experience;
import l2.universe.gameserver.model.base.PlayerClass;
...
import l2.universe.gameserver.model.entity.Hero;
...
import l2.universe.gameserver.model.itemcontainer.ItemContainer;
import l2.universe.gameserver.model.itemcontainer.PcInventory;
import l2.universe.gameserver.model.itemcontainer.PcRefund;
import l2.universe.gameserver.model.itemcontainer.PcWarehouse;
import l2.universe.gameserver.model.itemcontainer.PetInventory;
import l2.universe.gameserver.model.multisell.PreparedListContainer;
import l2.universe.gameserver.model.olympiad.OlympiadGameManager;
import l2.universe.gameserver.model.olympiad.OlympiadGameTask;
import l2.universe.gameserver.model.olympiad.OlympiadManager;
...
import l2.universe.gameserver.network.serverpackets.ChangeWaitType;
...
import l2.universe.gameserver.network.serverpackets.ExAutoSoulShot;
...
import l2.universe.gameserver.network.serverpackets.ExDominionWarStart;
import l2.universe.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import l2.universe.gameserver.network.serverpackets.ExFishingEnd;
import l2.universe.gameserver.network.serverpackets.ExFishingStart;
import l2.universe.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import l2.universe.gameserver.network.serverpackets.ExGetOnAirShip;
import l2.universe.gameserver.network.serverpackets.ExOlympiadMode;
import l2.universe.gameserver.network.serverpackets.ExPCCafePointInfo;
import l2.universe.gameserver.network.serverpackets.ExPrivateStoreSetWholeMsg;
import l2.universe.gameserver.network.serverpackets.ExSetCompassZoneCode;
import l2.universe.gameserver.network.serverpackets.ExSpawnEmitter;
...
import l2.universe.gameserver.network.serverpackets.ExVitalityPointInfo;
import l2.universe.gameserver.network.serverpackets.ExVoteSystemInfo;
import l2.universe.gameserver.network.serverpackets.FriendStatusPacket;
import l2.universe.gameserver.network.serverpackets.GameGuardQuery;
import l2.universe.gameserver.network.serverpackets.GetOnVehicle;
...
import l2.universe.gameserver.network.serverpackets.LeaveWorld;
import l2.universe.gameserver.network.serverpackets.MagicSkillUse;
import l2.universe.gameserver.network.serverpackets.NicknameChanged;
import l2.universe.gameserver.network.serverpackets.NpcHtmlMessage;
import l2.universe.gameserver.network.serverpackets.ObservationMode;
import l2.universe.gameserver.network.serverpackets.ObservationReturn;
import l2.universe.gameserver.network.serverpackets.PartySmallWindowUpdate;
import l2.universe.gameserver.network.serverpackets.PetInventoryUpdate;
import l2.universe.gameserver.network.serverpackets.PlaySound;
import l2.universe.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import l2.universe.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import l2.universe.gameserver.network.serverpackets.PrivateStoreListBuy;
import l2.universe.gameserver.network.serverpackets.PrivateStoreListSell;
import l2.universe.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import l2.universe.gameserver.network.serverpackets.PrivateStoreManageListSell;
import l2.universe.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import l2.universe.gameserver.network.serverpackets.PrivateStoreMsgSell;
import l2.universe.gameserver.network.serverpackets.RecipeShopMsg;
import l2.universe.gameserver.network.serverpackets.RecipeShopSellList;
import l2.universe.gameserver.network.serverpackets.RelationChanged;
import l2.universe.gameserver.network.serverpackets.Ride;
import l2.universe.gameserver.network.serverpackets.ServerClose;
import l2.universe.gameserver.network.serverpackets.SetupGauge;
import l2.universe.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import l2.universe.gameserver.network.serverpackets.SkillList;
import l2.universe.gameserver.network.serverpackets.Snoop;
...
import l2.universe.gameserver.network.serverpackets.TargetSelected;
import l2.universe.gameserver.network.serverpackets.TargetUnselected;
import l2.universe.gameserver.network.serverpackets.TradeDone;
import l2.universe.gameserver.network.serverpackets.TradeOtherDone;
import l2.universe.gameserver.network.serverpackets.TradeStart;
import l2.universe.gameserver.network.serverpackets.UserInfo;
import l2.universe.gameserver.security.MultiBoxProtection.IpPack;
...
import l2.universe.gameserver.skills.l2skills.L2SkillSiegeFlag;
import l2.universe.gameserver.skills.l2skills.L2SkillSummon;
import l2.universe.gameserver.skills.l2skills.L2SkillTrap;
...
import l2.universe.gameserver.util.FloodProtectors;
...
public final class L2PcInstance extends L2Playable
{
	...
	private final boolean _isOfflineTrade = false;
	...
	*/
	...
	private void showQuestWindow(String questId, String stateId)
	{
		...
		final String content = HtmCache.getInstance().getHtm(getHtmlPrefix(), path); //TODO path for quests html
	...
	public void rewardSkills()
	{
		...
		{
			final L2Skill skill = SkillTable.FrequentSkill.DWARVEN_CRAFT.getSkill();
			addSkill(skill, true);
		}
		...
		{
			final L2Skill skill = SkillTable.FrequentSkill.COMMON_CRAFT.getSkill();
			addSkill(skill, true);
		}
	...
	public void addItem(String process, L2ItemInstance item, L2Object reference, boolean sendMessage)
	{
		if (item.getCount() > 0)
		{
			...
			{
				final TerritoryWard ward = TerritoryWarManager.getInstance().getTerritoryWard(item.getItemId() - 13479);
				if (ward != null)
	...
	public L2ItemInstance addItem(String process, int itemId, long count, L2Object reference, boolean sendMessage)
	{
		if (count > 0)
		{
			...
			else
			{
				...
				{
					final TerritoryWard ward = TerritoryWarManager.getInstance().getTerritoryWard(createdItem.getItemId() - 13479);
					if (ward != null)
	...
	{
		_client = client;
		if (client == null && isMarkedToSeparate())
			SubclassSeparationHandler.getInstance().doSeparation(getObjectId());
	}
	...
	{
		return (atEvent || (DM._started && _inEventDM) || (CTF._started && _inEventCTF));
	}
	...
	public void updatePvPTitleColor(int pvpKillAmount)
	{
		...
		if (ExternalConfig.PVP_TITLE_AND_COLOR_SYSTEM_ENABLED)
		{
			if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT10)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT10);
				setTitle(ExternalConfig.PVP10_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT9)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT9);
				setTitle(ExternalConfig.PVP9_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT8)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT8);
				setTitle(ExternalConfig.PVP8_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT7)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT7);
				setTitle(ExternalConfig.PVP7_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT6)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT6);
				setTitle(ExternalConfig.PVP6_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT5)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT5);
				setTitle(ExternalConfig.PVP5_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT4)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT4);
				setTitle(ExternalConfig.PVP4_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT3)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT3);
				setTitle(ExternalConfig.PVP3_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT2)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT2);
				setTitle(ExternalConfig.PVP2_TITLE);
			}
			else if (pvpKillAmount >= ExternalConfig.PVP_AMOUNT1)
			{
				getAppearance().setVisibleTitleColor(ExternalConfig.TITLE_COLOR_FOR_PVP_AMOUNT1);
				setTitle(ExternalConfig.PVP1_TITLE);
			}
		}
	}	
	...
	/**
	 * Replacing every User Info send with this function
	 * This will make a task to send the user info packet. It will help avoiding multiple simultaneous packet
	 * sends, and it will act as a flood protector, every x interval
	 * Synerge
	 */	
	...
	public void sendUserInfo(boolean force)
	{
		...
		_userInfoTask = ThreadPoolManager.getInstance().scheduleAi(new UserInfoTask(), Config.USER_INFO_INTERVAL);
		*/
	}
	...
	*/
	...
	protected void doPickupItem(L2Object object)
	{
		...
		{
			final IItemHandler handler = ItemHandler.getInstance().getItemHandler(target.getEtcItem());
			if (handler == null)
	...
	public void tryOpenPrivateBuyStore()
	{
		...
		{
			if (ExternalConfig.SHOP_MIN_RANGE_FROM_NPC > 0)
          	{
				for (L2Character cha : getKnownList().getKnownCharactersInRadius(ExternalConfig.SHOP_MIN_RANGE_FROM_NPC))
				{
			...
			if (ExternalConfig.SHOP_MIN_RANGE_FROM_PLAYER > 0)
			{
				for (L2Character cha : getKnownList().getKnownCharactersInRadius(ExternalConfig.SHOP_MIN_RANGE_FROM_PLAYER))
				{
					if (cha instanceof L2PcInstance && ((L2PcInstance) cha).isInStoreMode() || ((L2PcInstance) cha).isInCraftMode())
					{
						sendPacket(SystemMessageId.NO_PRIVATE_STORE_HERE);
						return;
					}
	...
	public void transform(L2Transformation transformation)
	{
		if (_transformation != null)
		{
			...
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.YOU_ALREADY_POLYMORPHED_AND_CANNOT_POLYMORPH_AGAIN));
			return;
		}
		...
		// Synerge - If is a mounting transformation, remove weapon and shields, just like mounting a strider
		if (transformation.isMountingTransformation())
		{
			if (!disarmWeapons())
				return;
			if (!disarmShield())
	...
	{		
		if (newTarget != null)
		{
			final boolean isParty = (((newTarget instanceof L2PcInstance) && isInParty() && getParty().getPartyMembers().contains(newTarget)));
	 ...
	 *
	 *
	 * @see l2.universe.gameserver.model.actor.L2Playable#doDie(l2.universe.gameserver.model.actor.L2Character)
	 */
	@Override
	public boolean doDie(L2Character killer)
	{
		...
		if (killer != null)
		{
			...
			if (_inEventCTF)
			{
				...
				{
					sendMessage("You will be revived and teleported to team flag in " + ExternalConfig.CTF_REVIVE_DELAY / 1000 + " seconds!");
					...
					}, ExternalConfig.CTF_REVIVE_DELAY);
				}
			}
			...
			if ((killer instanceof L2PcInstance && ((L2PcInstance) killer)._inEventDM) && _inEventDM)
			{
				if (DM._teleport || DM._started)
				{
					...
					sendMessage("You will be revived and teleported to spot in " + ExternalConfig.DM_REVIVE_DELAY / 1000 + " seconds!");
					ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
					{
						public void run()
						{
					...
					}, ExternalConfig.DM_REVIVE_DELAY);
				}
			}
			else if (_inEventDM)
			{
		...
		if (ExternalConfig.TW_RESS_ON_DEATH && isInTownWarEvent())
	...
	{
		if (atEvent || (DM._started && _inEventDM) || (CTF._started && _inEventCTF) || killer == null) // Modified by CTF Event
			return;
	...
	public void onKillUpdatePvPKarma(L2Character target)
	{
		...
		{
			getInventory().addItem("TownWar", ExternalConfig.TW_ITEM_ID, ExternalConfig.TW_ITEM_AMOUNT, this, this);
			SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.EARNED_S2_S1_S);
			sm.addItemName(ExternalConfig.TW_ITEM_ID);
			sm.addItemNumber(ExternalConfig.TW_ITEM_AMOUNT);
			sendPacket(sm);
	...
	{		
		...
		{
			if (!isInTownWarEvent() || (isInTownWarEvent() && ExternalConfig.TW_GIVE_PVP_AND_PK_POINTS))
			{
			...
			if (ExternalConfig.PUNISH_PK_PLAYER_IF_PKS_OVER > 0) 
			{
				// Remove expired PKs
				for (final Long pKTime : _pKsCounter) {
					if (System.currentTimeMillis() - pKTime.longValue() > ExternalConfig.PK_MONITOR_PERIOD * 1000) 
					{
				...
				if (_pKsCounter.size() > ExternalConfig.PUNISH_PK_PLAYER_IF_PKS_OVER) 
				{
					if ("jail".equals(ExternalConfig.PK_PUNISHMENT_TYPE)) 
					{
						setPunishLevel(PunishLevel.JAIL,
								(int) (ExternalConfig.PK_PUNISHMENT_PERIOD / 60));
	...
	public void increasePkKillsAndKarma(L2Character target)
	{
		...
		// Add karma to attacker and increase its PK counter
		if ((!isInTownWarEvent()) || (ExternalConfig.TW_ALLOW_KARMA && isInTownWarEvent()))
		{
		...
		if (target instanceof L2PcInstance && AntiFeedManager.getInstance().check(this, target))
		{
			...
			if (!isInTownWarEvent() || (isInTownWarEvent() && ExternalConfig.TW_GIVE_PVP_AND_PK_POINTS))
			{
				newPks = getPkKills() + 1;
				setPkKills(newPks);
				AIOItemTable.getInstance().onPkIncrease(newPks);
			}
		}
	...
	public void deathPenalty(boolean atwar, boolean killed_by_pc, boolean killed_by_siege_npc)
	{
		...
		final int clan_luck = getSkillLevel(L2Skill.SKILL_CLAN_LUCK);
		...
		long lostExp = 0;
		if (!atEvent && !_inEventDM && !_inEventCTF) // Modified by CTF Event
		{
	...
	*/
	...
	public boolean mount(L2Summon pet)
	{
		...
		stopAllToggles();
		final Ride mount = new Ride(this, true, pet.getTemplate().npcId);
	...
	public boolean mount(int npcId, int controlItemObjId, boolean useFood)
	{
		...
		stopAllToggles();
		final Ride mount = new Ride(this, true, npcId);
	...
	public boolean dismount()
	{
		...
		if (setMount(0, 0, 0))
		{
			...
			final Ride dismount = new Ride(this, false, 0);
	...
	public void updateOnlineStatus()
	{
		...
		try
		{
            ...
            if (isOnline())
        	{
            	int newPlayer = L2World.getInstance().getAllPlayers().size() + 1;
            	int maxPlayer = RecordTable.getInstance().getMaxPlayer();
            	if (newPlayer > maxPlayer)
            	{
                	RecordTable.getInstance().setMaxPlayer(newPlayer);
               	}
        	}
		}
		catch (Exception e)
	...
	private static boolean restoreSubClassData(L2PcInstance player)
	{
		...
		try
		{
			...
			while (rset.next())
			{
				SubClass subClass = new SubClass(player.isGM());
	...
	private void storeCharBase()
	{
		...
		try
		{
			...
			statement.setInt(51, getPcBangScore());
		...
		try
		{
			...
			if (storeEffects)
			{
				for (L2Effect effect : getAllEffects())
				{
					...
					// Synerge - Dances and Songs are not saved on restart. Retail like. Tested on RpgClub
					if (ExternalConfig.REMOVE_DANCES_ON_RESTART && skill.isDance())
						continue;
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (isOutOfControl() || isParalyzed() || isStunned() || isSleeping() || isBluffed())
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			return false;
		}
		...
		{
			case TARGET_HOLY:
				if (!checkIfOkToCastSealOfRule(CastleManager.getInstance().getCastle(this), false, skill))
					canCast = false;
				break;
			case TARGET_FLAGPOLE:
				if (!checkIfOkToCastFlagDisplay(FortManager.getInstance().getFort(this), false, skill))
					canCast = false;
				break;
			default:
				switch (sklType)
				{
					case SIEGEFLAG:
						if (!L2SkillSiegeFlag.checkIfOkToPlaceFlag(this, false, skill.getId() == 844))
							canCast = false;
						break;
					case STRSIEGEASSAULT:
						if (!checkIfOkToUseStriderSiegeAssault())
							canCast = false;
						break;
					case SUMMON_FRIEND:
						if (!(checkSummonerStatus(this) && checkSummonTargetStatus(target, this)))
							canCast = false;
						break;
				}
				break;
	...
	public boolean checkPvpSkill(L2Object target, L2Skill skill, boolean srcIsSummon)
	{
		...
		)
		{
			...
			final SkillDat skilldatpet = getCurrentPetSkill();
     ...
     * target's lvl is above {ExternalConfig#L2JMOD_DISABLE_ATTACK_IF_LVL_DIFFERENCE_OVER}.
    ...
    {
        if (ExternalConfig.DISABLE_ATTACK_IF_LVL_DIFFERENCE_OVER > 0) 
        {
            if (target.isInsideZone(L2Character.ZONE_SIEGE) ||
            		target.isInsideZone(L2Character.ZONE_PVP) ||
                    (getClan() != null && target.getClan() != null &&
                    		target.getClan().isAtWarWith(getClanId()))) 
            {
                return false;
            }
            ...
            if (target.getPvpFlag() == 0 &&
            		target.getKarma() == 0 &&
            		target.getLevel() +
                    ExternalConfig.DISABLE_ATTACK_IF_LVL_DIFFERENCE_OVER <
                    getLevel()) 
            {
                return true;
            }
	...
	public boolean setMount(int npcId, int npcLevel, int mountType)
	{
		switch (mountType)
		{
			...
			case 1:
				...
				if (isNoble())
				{
					final L2Skill striderAssaultSkill = SkillTable.FrequentSkill.STRIDER_SIEGE_ASSAULT.getSkill();
	...
	public void addCubic(int id, int level, double matk, int activationtime, int activationchance, int maxcount, int totalLifetime, boolean givenByOther)
	{
		if (Config.DEBUG)
		 ...
		 final L2CubicInstance cubic = new L2CubicInstance(this, id, level, (int) matk, activationtime, activationchance, maxcount, totalLifetime, givenByOther);
	...
	public boolean addSubClass(int classId, int classIndex)
	{
		...
		try
		{
			...
			final SubClass newClass = new SubClass(isGM());
	...
	public boolean setActiveClass(int classIndex)
	{
		...
		try
		{
			...
			/*
			 *  Synerge - I could think of this the opposite, if reuses are reseted, then skills like noblesse, hero, 
			 *  etc will be reseted also, and all skills of the other class, just changing twice with long reuse skills
			 */
	...
	public void onPlayerEnter()
	{
		...
		if (isPremium())
        {
        	sendMessage("--->PREMIUM ACCOUNT ACTIVATED");
            sendMessage("--->Exp Rates x" + ExternalConfig.PREMIUM_RATE_XP);
            sendMessage("--->SP Rates x" + ExternalConfig.PREMIUM_RATE_SP);
            sendMessage("--->Adena Rates x" + ExternalConfig.PREMIUM_RATE_DROP_ADENA);
            sendMessage("--->Drop Chance Rates x" + ExternalConfig.PREMIUM_RATE_DROP_ITEMS);
            sendMessage("--->Spoil Chance Rates x" + ExternalConfig.PREMIUM_RATE_DROP_SPOIL);
            sendMessage("--->End Date : " + GetPremiumEndDateToShow());
        }
		revalidateZone(true);
	...
	private String GetPremiumEndDateToShow()
	{
	   DateFormat endDateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm");
	   long endDateLong = getPremiumEndTime();
	   Calendar endDateCalendar = Calendar.getInstance();
	   endDateCalendar.setTimeInMillis(endDateLong);
	   return endDateFormat.format(endDateCalendar.getTime()).toString();
	}
	...
	public void doRevive()
	{
		...
		// Add by CTF Event
		if (_inEventCTF && CTF._started && ExternalConfig.CTF_REVIVE_RECOVERY)
		{
			getStatus().setCurrentHp(getMaxHp());
			getStatus().setCurrentMp(getMaxMp());
			getStatus().setCurrentCp(getMaxCp());
			
			if (ExternalConfig.CTF_BUFFS_AFTER_DIE)
			{
				if (isMageClass())
				{
					if (ExternalConfig.CTF_EVENT_MAGE_BUFFS != null && !ExternalConfig.CTF_EVENT_MAGE_BUFFS.isEmpty())
					{
						for (int i : ExternalConfig.CTF_EVENT_MAGE_BUFFS.keys())
						{
							final L2Skill skill = SkillTable.getInstance().getInfo(i, ExternalConfig.CTF_EVENT_MAGE_BUFFS.get(i));
							if (skill != null)
				...
				{
					if (ExternalConfig.CTF_EVENT_FIGHTER_BUFFS != null && !ExternalConfig.CTF_EVENT_FIGHTER_BUFFS.isEmpty())
					{
						for (int i : ExternalConfig.CTF_EVENT_FIGHTER_BUFFS.keys())
						{
							final L2Skill skill = SkillTable.getInstance().getInfo(i, ExternalConfig.CTF_EVENT_FIGHTER_BUFFS.get(i));
							if (skill != null)
								skill.getEffects(this, this);
						}
					}
	...
	public void reviveRequest(L2PcInstance Reviver, L2Skill skill, boolean Pet)
	{
		...
		if ((Pet && getPet() != null && getPet().isDead()) || (!Pet && isDead()))
		{
			...
			final int restoreExp = (int) Math.round((getExpBeforeDeath() - getExp()) * _revivePower / 100);
	...
	public void setIsReviveRequested(int val)
	{
		_reviveRequested = val;
	}
	...
	public final void updateCLColours()
	{
		if (ExternalConfig.CLAN_LEADER_COLOR_ENABLED)
		{
			if (getClan() != null && !isGM())
			{
				if (getObjectId() == getClan().getLeaderId())
					getAppearance().setVisibleNameColor(ExternalConfig.CLAN_LEADER_COLOR);
				else
					getAppearance().setVisibleNameColor(0);
			}
		}
	}
	...
	{
		addExpAndSp(addToExp, addToSp, useVitality, false);
	}
	
	public void addExpAndSp(long addToExp, int addToSp, boolean useVitality, boolean isQuestExp)
	{
		//if (_isOfflineTrade = false) m
		if (_expGainOn)
			getStat().addExpAndSp(addToExp, addToSp, useVitality, isQuestExp);
		else
			getStat().addExpAndSp(0, addToSp, useVitality, isQuestExp);
	}
	...
	*/
	...
	private synchronized void cleanup()
	{
		...
		try
		{
			if (ExternalConfig.ENABLE_BLOCK_CHECKER_EVENT && this._handysBlockCheckerEventArena != -1)
			{
	...
	public void setPunishLevel(PunishLevel state, int delayInMinutes)
	{
		...
		switch (state)
		{
			case NONE: // Remove Punishments
			{
				switch (_punishLevel)
				{
					...
					case JAIL:
					{
						...
						final String jailInfos = HtmCache.getInstance().getHtm(getHtmlPrefix(), "data/html/jail_out.htm");
						if (jailInfos != null)
			...
			case JAIL: // Jail Player
			{
				...
				// Open a Html message to inform the player
				NpcHtmlMessage htmlMsg = new NpcHtmlMessage(0);
				final String jailInfos = HtmCache.getInstance().getHtm(getHtmlPrefix(), "data/html/jail_in.htm");
				if (jailInfos != null)
					htmlMsg.setHtml(jailInfos);
				else
	...
	public void absorbSoul(L2Skill skill, L2Npc npc)
	{
		...
		{
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.SOUL_CANNOT_BE_INCREASED_ANYMORE));
			return;
		}
	...
	public void increaseDeathPenaltyBuffLevel()
	{
		...
		{
			final L2Skill skill = SkillTable.getInstance().getInfo(5076, getDeathPenaltyBuffLevel());
	...
	public final void sendDamageMessage(L2Character target, int damage, boolean mcrit, boolean pcrit, boolean miss)
	{
		...
		if (pcrit)
		{
			...
			{
				final L2Skill skill = SkillTable.getInstance().getInfo(467, getSkillLevel(467));
	...
	public static boolean checkSummonTargetStatus(L2Object target, L2PcInstance summonerChar)
	{
		...
		{
			final Instance summonerInstance = InstanceManager.getInstance().getInstance(summonerChar.getInstanceId());
		...
		{
			final int targetCabal = SevenSigns.getInstance().getPlayerCabal(targetChar.getObjectId());
	...
	public void gatesAnswer(int answer, int type)
	{
		...
		if (answer == 1 && getTarget() == _gatesRequest.getDoor())
		{
			if (type == 1)
	...
	private class FeedTask implements Runnable
	{
		public void run()
		{
			try
			{
				...
				final int[] foodIds = getPetData(getMountNpcId()).getFood();
				if (foodIds.length == 0)
					return;
				...
				{
					final IItemHandler handler = ItemHandler.getInstance().getItemHandler(food.getEtcItem());
					if (handler != null)
					{
	...
	/** End of section for Smounted pets */
	
	@Override
	public int getAttackElementValue(byte attribute)
	{
		final int value = super.getAttackElementValue(attribute);
	...
	{
		final QuestState _state = getQuestState("CharacterBirthday");
	...
	private void storeRecipeShopList()
	{
		...
		try
		{
			con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement;
			final L2ManufactureList list = getCreateList();
	...
	{
		if (!Config.MOD_MULTILANG_ENABLE)
			return null;
	...
	public boolean setLang(String lang)
	{
		...
		if (Config.MOD_MULTILANG_ENABLE)
		{
			if (Config.MOD_MULTILANG_ALLOWED.contains(lang))
			{
				_lang = lang;
				result = true;
			}
			else
				_lang = Config.MOD_MULTILANG_DEFAULT;
	...
	public void saveConnectionAddress()
	{
		_connectionAddress = getClient().getConnection().getInetAddress().getHostAddress();
	}
	...
	// Synerge - Function to check if the target is affected by an aoe skill of this player
	public boolean isTargetAffectedByAOE(L2PcInstance target, L2Character realTarget)
	{		
		if (!realTarget.isAutoAttackable(this))
			return false;
		
		if (!(realTarget instanceof L2Playable))
			return true;
		
		if (realTarget.isInsideZone(L2Character.ZONE_PVP))
			return true;
		
		if (getParty() != null && getParty().getCommandChannel() != null)
		{
			if (getParty().getCommandChannel().getMembers().contains(target))
				return false;
		}
		
		if (getClan() != null && target.getClan() != null && getAllyId() > 0 && target.getAllyId() > 0)
		{
			if (getAllyId() == target.getAllyId())
				return false;
		}
	...
	// Synerge - Dont remove adventurer buffs
	public void removeActiveBuffForKama() 
	{
		for (L2Effect e : getAllEffects()) 
		{
			if (e.getSkill().isAdventurerBuff()) 
				continue;
	...
	// Synerge - Lets save an IpPack to have internal and external ip at the moment, for fast comparisons
	private IpPack _ipPack = null;
	
	public void saveIpPack(IpPack ipack)
	{
		_ipPack = ipack;
	}
	
	public IpPack getIpPack()
	{
		return _ipPack;
	}
	
	// This is setter/getter for information who kill a player
	private static L2PcInstance _killer = null;
	/**
	 * Set killer who kill this player.
	 * 
	 * @param killer
	 */
	...
	/**
	 * Get killer who kill this player.
	 * 
	 * @return L2PcInstance
	 */
	 ...
	 * Premium service
	 */
	public void updatePremiumItem(int Id, long newcount)
	{
		PremiumItemsTable.getInstance().updatePremiumItem(Id, getObjectId(), newcount);
	}
	
	public void deletePremiumItem(int Id)
	{
		PremiumItemsTable.getInstance().deletePremiumItem(Id, getObjectId());
	}
	
	public Map<Integer, L2PremiumItem> getPremiumItemList()
	{
		return PremiumItemsTable.getInstance().getPremiumItemListOf(getObjectId());
	}
	...
	{
		FastList<L2Skill> temp = new FastList<L2Skill>(ExternalConfig.AIOITEM_SCHEME_MAX_PROFILES);
	...
	{
		if(!ExternalConfig.AIOITEM_ENABLEME || !ExternalConfig.AIOITEM_ENABLESCHEMEBUFF)
			return;
		...
		try
		{
			...
			FastList<String> tempProfiles = new FastList<String>(ExternalConfig.AIOITEM_SCHEME_MAX_PROFILES);
			...
			{
				FastList<L2Skill> tempSkill = new FastList<L2Skill>(ExternalConfig.AIOITEM_SCHEME_MAX_PROFILE_BUFFS);
	...
	private String _subclassAccount = "";
	private int _subclassSex = 0;
	public void setSubclassSeparationIndex(int classIndex)
	{
		_subclassIndex = classIndex;
	}
	public void setSubclassSeparationSex(int sex)
	{
		_subclassSex = sex;
	}
	public void setSubclassSeparationAccount(String accountName)
	{
		_subclassAccount = accountName;
	}
	public int getSubclassSeparationIndex()
	{
		return _subclassIndex;
	}
	public int getSubclassSeparationSex()
	{
		return _subclassSex;
	}
	public String getSubclassSeparationAccount()
	{
		return _subclassAccount;
	}
	public void cancelSubclassSeparation()
	{
		_subclassIndex = 0;
		_subclassSex = 0;
		_subclassAccount = "";
	}
	public boolean isMarkedToSeparate()
	{
		return (_subclassIndex != 0 && !_subclassAccount.equals(""));
	}
}