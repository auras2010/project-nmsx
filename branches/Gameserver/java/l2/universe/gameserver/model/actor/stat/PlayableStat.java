...
import l2.universe.gameserver.model.zone.type.L2SwampZone;
...
public class PlayableStat extends CharStat
{
    ...
    public boolean addLevel(byte value)
    {
        ...
        if (!levelIncreased && getActiveChar() instanceof L2PcInstance && 
        		!((L2PcInstance)(getActiveChar())).isGM() && Config.DECREASE_SKILL_LEVEL) 
        {
