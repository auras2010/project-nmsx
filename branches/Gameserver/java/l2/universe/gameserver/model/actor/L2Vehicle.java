...
import l2.universe.gameserver.model.VehiclePathPoint;
import l2.universe.gameserver.model.actor.instance.L2PcInstance;
import l2.universe.gameserver.model.actor.knownlist.VehicleKnownList;
import l2.universe.gameserver.model.actor.stat.VehicleStat;
import l2.universe.gameserver.network.SystemMessageId;
import l2.universe.gameserver.network.serverpackets.DeleteObject;
...
public abstract class L2Vehicle extends L2Character
{
	...
	public boolean addPassenger(L2PcInstance player)
	{
		...
		player.setInsideZone(ZONE_PEACE, true); 
	 	player.revalidateZone(true); // Update telling it status changed. 
		return true;
	}
