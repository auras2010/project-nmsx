...
import l2.universe.gameserver.MonsterRace;
...
import l2.universe.gameserver.model.actor.knownlist.RaceManagerKnownList;
...
import l2.universe.gameserver.network.serverpackets.MonRaceInfo;
...
public class L2RaceManagerInstance extends L2NpcInstance
{
    ...
    public void onBypassFeedback(L2PcInstance player, String command)
    {
        ...
        else if (command.startsWith("ShowOdds") && _state == ACCEPTING_BETS)
        {
        ...
        if (command.startsWith("BuyTicket"))
        {
            ...
            else if ((val == 10 && player.getRace(0) == 0)
