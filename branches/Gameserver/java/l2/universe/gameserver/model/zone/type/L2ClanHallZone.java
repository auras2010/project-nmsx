...
import l2.universe.gameserver.network.serverpackets.AgitDecoInfo;
...
public class L2ClanHallZone extends L2SpawnZone
{
	...
	public void setParameter(String name, String value)
	{
		if (name.equals("clanHallId"))
		{
			...
			ClanHall hall = ClanHallManager.getAllClanHalls().get(_clanHallId);
			if(hall == null)
				_log.warning("L2ClanHallZone: Clan Hall with id "+ value +" does not exist!");
			else
				hall.setZone(this);
		}
		else
	...
	protected void onEnter(L2Character character)
	{
		if (character instanceof L2PcInstance)
		{
			...
			AuctionableHall clanHall = ClanHallManager.getInstance().getClanHallById(_clanHallId);
			if (clanHall == null)
				return;
