 ...
 */
package l2.universe.gameserver.model.zone.form;

import java.awt.geom.Line2D;
import java.awt.geom.Point2D;

import l2.universe.gameserver.model.zone.L2ZoneForm;
...
public class ZoneCuboid extends L2ZoneForm
{
	 ...
	 * fishing algorithms, wich are now able to correctly place the hook in the water, thanks to
	 * getHighZ(). getLowZ() was added, considering potential future modifications.
	 */
	@Override
	public int getLowZ()
	{
	...
	@Override
	public Point2D intersectsSegment(int fromX, int fromY, int toX, int toY)
	{
		if (lineSegmentsIntersect(_x1, _y1, _x2, _y1, fromX, fromY, toX, toY))
		{
			return getIntersectionPoint(new Line2D.Double(_x1, _y1, _x2, _y1), new Line2D.Double(fromX, fromY, toX, toY));
		}
		if (lineSegmentsIntersect(_x1, _y2, _x2, _y2, fromX, fromY, toX, toY))
		{
			return getIntersectionPoint(new Line2D.Double(_x1, _y2, _x2, _y2), new Line2D.Double(fromX, fromY, toX, toY));
		}
		if (lineSegmentsIntersect(_x1, _y1, _x1, _y2, fromX, fromY, toX, toY))
		{
			return getIntersectionPoint(new Line2D.Double(_x1, _y1, _x1, _y2), new Line2D.Double(fromX, fromY, toX, toY));
		}
		if (lineSegmentsIntersect(_x2, _y1, _x2, _y2, fromX, fromY, toX, toY))
		{
			return getIntersectionPoint(new Line2D.Double(_x2, _y1, _x2, _y2), new Line2D.Double(fromX, fromY, toX, toY));
		}
		return null; 
	}
