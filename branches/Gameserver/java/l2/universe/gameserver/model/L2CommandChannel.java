...
import l2.universe.gameserver.network.serverpackets.ExMPCCPartyInfoUpdate;
...
public class L2CommandChannel
{
	...
	{
		if (party == null || _partys == null || _partys.isEmpty())
			return;
	 ...
	 * @return
	 */
	public boolean constains(int playerId)
	{
