 ...
 */
package l2.universe.gameserver.taskmanager;

import static l2.universe.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static l2.universe.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static l2.universe.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import l2.universe.gameserver.taskmanager.tasks.TaskCleanUp;
import l2.universe.gameserver.taskmanager.tasks.TaskDailyQuestClean;
import l2.universe.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import l2.universe.gameserver.taskmanager.tasks.TaskJython;
import l2.universe.gameserver.taskmanager.tasks.TaskOlympiadSave;
import l2.universe.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import l2.universe.gameserver.taskmanager.tasks.TaskRecom;
import l2.universe.gameserver.taskmanager.tasks.TaskRestart;
import l2.universe.gameserver.taskmanager.tasks.TaskScript;
import l2.universe.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import l2.universe.gameserver.taskmanager.tasks.TaskShutdown;
