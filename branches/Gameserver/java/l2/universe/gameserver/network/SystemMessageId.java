...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId NIGHT_EFFECT_APPLIES_S1;
	
	/**
	 * ID: 1132<br>
	 * Message: It is now dawn and the effect of $s1 will now disappear.
	 */
	public static final SystemMessageId DAY_EFFECT_DISAPPEARS_S1;
	 ...
	 */
	public static final SystemMessageId MOVED_TO_THE_PREVIOUS_CHATTING_CHANNEL_TAB;

	/**
	 * ID: 2502<br>
	 * Message: You will be moved to the next chatting channel tab.
	 */
	public static final SystemMessageId MOVED_TO_THE_NEXT_CHATTING_CHANNEL_TAB;

	/**
	 * ID: 2503<br>
	 * Message: The currently selected target will be cancelled.
	 */
	public static final SystemMessageId CURRENT_TARGET_WILL_BE_CANCELLED;

	/**
	 * ID: 2504<br>
	 * Message: Focus will be moved to chat window.
	 */
	public static final SystemMessageId FOCUS_WILL_MOVED_TO_CHAT_WINDOW;

	/**
	 * ID: 2505<br>
	 * Message: Opens or closes the inventory window.
	 */
	public static final SystemMessageId OPENS_OR_CLOSES_INVENTORY_WINDOW;

	/**
	 * ID: 2506<br>
	 * Message: Temporarily hides all open windows.
	 */
	public static final SystemMessageId TEMPORARILY_HIDES_ALL_OPEN_WINDOWS;

	/**
	 * ID: 2507<br>
	 * Message: Closes all open windows.
	 */
	public static final SystemMessageId CLOSES_ALL_OPEN_WINDOWS;

	/**
	 * ID: 2508<br>
	 * Message: Opens the GM manager window.
	 */
	public static final SystemMessageId OPENS_GM_MANAGER_WINDOW;

	/**
	 * ID: 2509<br>
	 * Message: Opens the GM petition window.
	 */
	public static final SystemMessageId OPENS_GM_PETITION_WINDOW;
	 ...
	 * inputs.
	 */
	public static final SystemMessageId BUFF_IN_PARTY_WINDOW_IS_TOGGLED;

	/**
	 * ID: 2511<br>
	 * Message: Activates or deactivates minimum frame function
	 */
	public static final SystemMessageId ACTIVATES_DESACTIVATES_MINIMUM_FRAME;

	/**
	 * ID: 2512<br>
	 * Message: Runs or closes the MSN messenger window.
	 */
	public static final SystemMessageId RUNS_OR_CLOSES_MSN_WINDOW;
	 ...
	 */
	public static final SystemMessageId ASSIGN_1_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_2_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_3_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_4_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_5_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_6_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_7_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_8_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_9_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_10_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_11_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_12_SLOT_SHORTCUT_BASE_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_1_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_2_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_3_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_4_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_5_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_6_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_7_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_8_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_9_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_10_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_11_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_12_SLOT_SHORTCUT_EXPANDED_WINDOW;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_1_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_2_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_3_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_4_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_5_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_6_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_7_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_8_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_9_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_10_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_11_SLOT_SHORTCUT_EXPANDED_WINDOW2;
	 ...
	 * Combination of Ctrl and Shift cannot be assigned.
	 */
	public static final SystemMessageId ASSIGN_12_SLOT_SHORTCUT_EXPANDED_WINDOW2;

	/**
	 * ID: 2549<br>
	 * Message: Move the shortcut page in the shortcut base window to page 1.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE1;

	/**
	 * ID: 2550<br>
	 * Message: Move the shortcut page in the shortcut base window to page 2.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE2;

	/**
	 * ID: 2551<br>
	 * Message: Move the shortcut page in the shortcut base window to page 3.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE3;

	/**
	 * ID: 2552<br>
	 * Message: Move the shortcut page in the shortcut base window to page 4.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE4;

	/**
	 * ID: 2553<br>
	 * Message: Move the shortcut page in the shortcut base window to page 5.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE5;

	/**
	 * ID: 2554<br>
	 * Message: Move the shortcut page in the shortcut base window to page 6.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE6;

	/**
	 * ID: 2555<br>
	 * Message: Move the shortcut page in the shortcut base window to page 7.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE7;

	/**
	 * ID: 2556<br>
	 * Message: Move the shortcut page in the shortcut base window to page 8.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE8;

	/**
	 * ID: 2557<br>
	 * Message: Move the shortcut page in the shortcut base window to page 9.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE9;

	/**
	 * ID: 2558<br>
	 * Message: Move the shortcut page in the shortcut base window to page 10.
	 */
	public static final SystemMessageId MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE10;
	 ...
	 * and game commands.
	 */
	public static final SystemMessageId OPENS_CLOSES_ACTION_WINDOW;

	/**
	 * ID: 2560<br>
	 * Message: Opens and closes the game bulletin board.
	 */
	public static final SystemMessageId OPENS_CLOSES_GAME_BOARD;

	/**
	 * ID: 2561<br>
	 * Message: Opens and closes the calculator.
	 */
	public static final SystemMessageId OPENS_CLOSES_CALCULATOR;
	 ...
	 * default.
	 */
	public static final SystemMessageId HIDES_SHOWS_CHAT_WINDOW;
	 ...
	 */
	public static final SystemMessageId OPENS_CLOSES_CLAN_WINDOW;
	 ...
	 */
	public static final SystemMessageId OPENS_CLOSES_STATUS_WINDOW;

	/**
	 * ID: 2565<br>
	 * Message: Opens and closes the help window.
	 */
	public static final SystemMessageId OPENS_CLOSES_HELP_WINDOW;

	/**
	 * ID: 2566<br>
	 * Message: Opens or closes the inventory window.
	 */
	public static final SystemMessageId OPENS_CLOSES_INVENTORY_WINDOW;

	/**
	 * ID: 2567<br>
	 * Message: Opens and closes the macro window for macro settings.
	 */
	public static final SystemMessageId OPENS_CLOSES_MACRO_WINDOW;
	 ...
	 * that you can use.
	 */
	public static final SystemMessageId OPENS_CLOSES_SKILL_WINDOW;

	/**
	 * ID: 2569<br>
	 * Message: Hides or shows the menu window, the window shows by default.
	 */
	public static final SystemMessageId HIDES_SHOWS_MENU_WINDOW;
	 ...
	 */
	public static final SystemMessageId OPENS_CLOSES_MINI_MAP;

	/**
	 * ID: 2571<br>
	 * Message: Opens and closes the option window.
	 */
	public static final SystemMessageId OPENS_CLOSES_OPTION_WINDOW;
	 ...
	 */
	public static final SystemMessageId OPEN_CLOSE_PARTY_WINDOW;
	 ...
	 * quests.
	 */
	public static final SystemMessageId OPEN_CLOSE_QUEST_WINDOW;

	/**
	 * ID: 2574<br>
	 * Message: Hide or show the radar map, the map will always show by default.
	 */
	public static final SystemMessageId HIDE_SHOW_RADAR_MAP;

	/**
	 * ID: 2575<br>
	 * Message: Hide or show the status window, the window will show by default.
	 */
	public static final SystemMessageId HIDE_SHOW_STATUS_WINDOW;
	 ...
	 * selection.
	 */
	public static final SystemMessageId OPENS_CLOSES_SYSTEM_WINDOW;
	 ...
	 */
	public static final SystemMessageId DONT_SHOW_DROPS_ITEMS;

	/**
	 * ID: 2578<br>
	 * Message: A key to automatically send whispers to a targeted character.
	 */
	public static final SystemMessageId KEY_TO_AUTO_SEND_WHISPERS;

	/**
	 * ID: 2579<br>
	 * Message: Turns off all game sounds.
	 */
	public static final SystemMessageId DISABLE_ALL_GAME_SOUNDS;

	/**
	 * ID: 2580<br>
	 * Message: Expands each shortcut window.
	 */
	public static final SystemMessageId EXPANDS_SHORTCUT_WINDOW;

	/**
	 * ID: 2581<br>
	 * Message: Initialize user interface location to a default location.
	 */
	public static final SystemMessageId INITIALIZE_USER_INTERFACE;

	/**
	 * ID: 2582<br>
	 * Message: Turns the character to the left.
	 */
	public static final SystemMessageId TURNS_CHARACTER_TO_LEFT;

	/**
	 * ID: 2583<br>
	 * Message: Turns the character to the right.
	 */
	public static final SystemMessageId TURNS_CHARACTER_TO_RIGHT;

	/**
	 * ID: 2584<br>
	 * Message: Moves the character forward.
	 */
	public static final SystemMessageId MOVES_CHARACTER_FORWARD;

	/**
	 * ID: 2585<br>
	 * Message: Moves the character backwards.
	 */
	public static final SystemMessageId MOVES_CHARACTER_BACKWARDS;

	/**
	 * ID: 2586<br>
	 * Message: Moves the character forward automatically.
	 */
	public static final SystemMessageId MOVES_CHARACTER_FORWARD_AUTO;

	/**
	 * ID: 2587<br>
	 * Message: Reduces the character's view.
	 */
	public static final SystemMessageId REDUCES_CHARACTER_VIEW;

	/**
	 * ID: 2588<br>
	 * Message: Expands the character's view.
	 */
	public static final SystemMessageId EXPANDS_CHARACTER_VIEW;

	/**
	 * ID: 2589<br>
	 * Message: Rapidly turns character's view to the front and back.
	 */
	public static final SystemMessageId RAPID_TURNS_CHARACTER_VIEW;

	/**
	 * ID: 2590<br>
	 * Message: Opens the GM manager window.
	 */
	public static final SystemMessageId OPENS_THE_GM_MANAGER_WINDOW;

	/**
	 * ID: 2591<br>
	 * Message: Opens the GM petition window.
	 */
	public static final SystemMessageId OPENS_THE_GM_PETITION_WINDOW;

	/**
	 * ID: 2592<br>
	 * Message: Quickly switch the content of the expanded shortcut window.
	 */
	public static final SystemMessageId RAPID_CONVERTS_CONTENTS_OF_EXPANDED_SHORTCUT_WINDOW;

	/**
	 * ID: 2593<br>
	 * Message: Advance by a set distance the viewing point of my character or mountable.
	 */
	public static final SystemMessageId MOVES_CHARACTER_VIEW_AHEAD;

	/**
	 * ID: 2594<br>
	 * Message: Retreat by a set distance the viewing point of my character or mountable.
	 */
	public static final SystemMessageId MOVES_CHARACTER_VIEW_BEHIND;

	/**
	 * ID: 2595<br>
	 * Message: Reset the viewing point of my character or mountable.
	 */
	public static final SystemMessageId RESTORES_CHARACTER_VIEW;

	/**
	 * ID: 2596<br>
	 * Message: No translation required.
	 */
	public static final SystemMessageId NO_TRANSLATION_REQUIRED;
	 ...
	 * Console Message: ------------------------------------------------------
	 */
	public static final SystemMessageId LINE_OF_DASHES;
	
	/**
	 * ID: 2714<BR>
	 * Console Message: ----------------------------------------------------------------------
	 */
	public static final SystemMessageId LONG_LINE_OF_DASHES;

	/**
	 * ID: 2715<br>
	 * Message: Airships cannot be boarded in the current area.
	 */
	public static final SystemMessageId AIRSHIP_CANT_BE_BOARDED_HERE;
	 ...
	 * $s1.
	 */
	public static final SystemMessageId CANT_SUMMON_AIRSHIP_NOT_ENOUGH_S1;

	/**
	 * ID: 2724<br>
	 * Message: The airship cannot be purchased because you don't have enough
	 * $s1.
	 */
	public static final SystemMessageId CANT_PURCHASE_AIRSHIP_NOT_ENOUGH_S1;

	/**
	 * ID: 2725<br>
	 * Message: You cannot summon the airship because you do not meet the
	 * requirements.
	 */
	public static final SystemMessageId CANT_SUMMON_AIRSHIP_DONT_MEET_REQUIREMENTS;

	/**
	 * ID: 2726<br>
	 * Message: You cannot purchase the airship because you do not meet the
	 * requirements.
	 */
	public static final SystemMessageId CANT_PURCHASE_AIRSHIP_DONT_MEET_REQUIREMENTS;
	 ...
	 */
	public static final SystemMessageId CANNOT_DO_WHILE_MOUNTED;
	...
	/**
	 * ID: 2739<BR>
	 * Console Message: You cannot control because you do not meet the
	 * requirements.
	 */
	public static final SystemMessageId CANNOT_CONTROL_AIRSHIP;

	/**
	 * ID: 2740<BR>
	 * Console Message: This action is prohibited while controlling.
	 */
	public static final SystemMessageId CANNOT_DO_WHILE_CONTROLLING;

	/**
	 * ID: 2741<BR>
	 * Console Message: You can control the airship by targeting the airship's
	 * control key and pressing the "control" action button while riding the
	 * airship.
	 */
	public static final SystemMessageId YOU_CAN_CONTROL_AIRSHIP;

	/**
	 * ID: 2742<BR>
	 * Console Message: Any character riding the airship can control it.
	 */
	public static final SystemMessageId ANY_CHARACTER_CAN_CONTROL_AIRSHIP;

	/**
	 * ID: 2743<BR>
	 * Console Message: If you restart while on an airship, you will return to
	 * the departure location.
	 */
	public static final SystemMessageId RESTART_WHILE_ON_AIRSHIP;

	/**
	 * ID: 2744<BR>
	 * Console Message: If you press the "Control Cancel" action button, you can
	 * exit the control state at any time.
	 */
	public static final SystemMessageId YOU_CAN_EXIT_CONTROL_STATE;

	/**
	 * ID: 2745<BR>
	 * Console Message: The "Mount Cancel" action button allows you to dismount
	 * before the airship departs.
	 */
	public static final SystemMessageId YOU_CAN_DISMOUNT_AIRSHIP;

	/**
	 * ID: 2746<BR>
	 * Console Message: Use the "Depart" action to make the airship depart.
	 */
	public static final SystemMessageId USE_DEPART;

	/**
	 * ID: 2747<BR>
	 * Console Message: Airship teleport is possible through the "Depart"
	 * action, and in that case, fuel (EP) is consumed.
	 */
	public static final SystemMessageId AIRSHIP_TELEPORT_IS_POSSIBLE;
	 ...
	 */
	public static final SystemMessageId CANNOT_CRYSTALLIZE_LIMIT_REACHED;
	 ...
	 */
	public static final SystemMessageId WAR_DECLARED_FOR_S1;

	/**
	 * ID: 2753<BR>
	 * Console Message: A powerful attack is prohibited when allied troops are
	 * the target.
	 */
	public static final SystemMessageId CANNOT_ATTACK_ALLIED_TROOPS;

	/**
	 * ID: 2754<BR>
	 * Console Message: PVP matches such as Olympiad, Underground Coliseum,
	 * Aerial Cleft, Kratei's Cube, and Handy's Block Checkers overlap and you
	 * cannot participate.
	 */
	public static final SystemMessageId PVP_MATCHES_OVERLAP;

	/**
	 * ID: 2755<BR>
	 * Console Message: $c1 has been designated as CAT.
	 */
	public static final SystemMessageId C1_IS_NOW_CAT;

	/**
	 * ID: 2756<BR>
	 * Console Message: Another player is probably controlling the target.
	 */
	public static final SystemMessageId TARGET_ALREADY_CONTROLLED;

	/**
	 * ID: 2757<BR>
	 * Console Message: The target is moving so you have failed to mount.
	 */
	public static final SystemMessageId TARGET_MOVING_FAILED_MOUNT;

	/**
	 * ID: 2758<BR>
	 * Console Message: You cannot control the target while a pet or servitor is
	 * summoned.
	 */
	public static final SystemMessageId CANT_CONTROL_TARGET_IF_HAVE_PET_SERVITOR;

	/**
	 * ID: 2759<BR>
	 * Console Message: When actions are prohibited, you cannot mount a
	 * mountable.
	 */
	public static final SystemMessageId WHEN_PROHIBITED_CANT_MOUNT;

	/**
	 * ID: 2760<BR>
	 * Console Message: When actions are prohibited, you cannot control the
	 * target.
	 */
	public static final SystemMessageId WHEN_PROHIBITED_CANT_CONTROL_TARGET;

	/**
	 * ID: 2761<BR>
	 * Console Message: You must target the one you wish to control.
	 */
	public static final SystemMessageId MUST_TARGET_TO_CONTROL;
	...
	/**
	 * ID: 2764<BR>
	 * Console Message: You cannot enter because the corresponding alliance
	 * channel's maximum number of entrants has been reached.
	 */
	 ...
	 */
	public static final SystemMessageId CANNOT_INCREASE_ALTITUDE;

	/**
	 * ID: 2780<BR>
	 * Console Message: Further decrease in altitude is not allowed.
	 */
	public static final SystemMessageId CANNOT_DECREASE_ALTITUDE;

	/**
	 * ID: 2781<BR>
	 * Console Message: Number of units: $s1
	 */
	public static final SystemMessageId NUMBER_OF_UNITS_S1;

	/**
	 * ID: 2782<BR>
	 * Console Message: Number of people: $s1
	 */
	public static final SystemMessageId NUMBER_OF_PEOPLE_S1;

	/**
	 * ID: 2783<BR>
	 * Console Message: No one is left from the opposing team, thus victory is
	 * yours.
	 */
	public static final SystemMessageId VICTORY_NOONE_LEFT;

	/**
	 * ID: 2784<BR>
	 * Console Message: The battlefield has been closed. The match has ended in
	 * a tie because the match lasted for $s1-minute(s) and $s2-second(s) and
	 * the requirements were not met.
	 */
	public static final SystemMessageId MATCH_LASTED_S1_MINUTES_S2_SECONDS_TIED;

	/**
	 * ID: 2785<BR>
	 * Console Message: It's a large scaled airship for transportations and
	 * battles and can be owned by the unit of clan.
	 */
	public static final SystemMessageId LARGE_SCALE_AIRSHIP;

	/**
	 * ID: 2786<BR>
	 * Console Message: Start action is available only when controlling the
	 * airship.
	 */
	public static final SystemMessageId START_ONLY_WHEN_CONTROLLING;

	/**
	 * ID: 2787<BR>
	 * Console Message: $c1 has drained you of $s2 HP.
	 */
	public static final SystemMessageId C1_DRAINED_YOU_S2_HP;
	 ...
	 */
	public static final SystemMessageId MERCENARY_REQUESTED_PARTICIPATION_IN_S1_TERRITORY;

	/**
	 * ID: 2789<BR>
	 * Console Message: Mercenary participation request is cancelled in $s1
	 * territory.<BR>
	 * Screen Message: $s1 Mercenary Participation Cancellation!
	 */
	public static final SystemMessageId MERCENARY_CANCELLED_PARTICIPATION_IN_S1_TERRITORY;
	 ...
	 */
	public static final SystemMessageId CLAN_REQUESTED_PARTICIPATION_IN_S1_TERRITORY;

	/**
	 * ID: 2791<BR>
	 * Console Message: Clan participation request is cancelled in $s1
	 * territory.<BR>
	...
	/**
	 * ID: 2792<BR>
	 * Console Message: 50 clan reputation points will be awarded. Do you wish
	 * to continue?
	 */
	...
	/**
	 * ID: 2793<BR>
	 * Console Message: The minimum number ($s1) of people to enter Instant Zone
	 * is not met and entry is not available.
	 */
	public static final SystemMessageId NOT_ENOUGH_PEOPLE_TO_ENTER_INSTANCE_ZONE_NEED_S1;

	/**
	 * ID: 2794<BR>
	 * Console Message: The territory war channel and functions will now be
	 * deactivated.
	 */
	 ...
	 */
	public static final SystemMessageId ALTITUDE_CANT_BE_DECREASED;

	/**
	 * ID: 2906<BR>
	 * Message: Altitude cannot be increased any further.
	 */
	public static final SystemMessageId ALTITUDE_CANT_BE_INCREASED;

	/**
	 * ID: 2907<BR>
	 * Message: You have entered a potentially hostile environment so the
	 * airship's speed has been greatly decreased.
	 */
	public static final SystemMessageId HOSTILE_ENVIROMENT_AIRSHIP_SPEED_DECREASED;

	/**
	 * ID: 2908<BR>
	 * Message: As you are leaving the hostile environment, the airship's speed
	 * has been returned to normal.
	 */
	public static final SystemMessageId LEAVING_HOSTILE_ENVIROMENT_AIRSHIP_SPEED_INCREASED;

	/**
	 * ID: 2909<BR>
	 * Message: A servitor or pet cannot be summoned while on an airship.
	 */
	public static final SystemMessageId CANT_SUMMON_ON_AIRSHIP;

	/**
	 * ID: 2910<BR>
	 * Message: You have entered an incorrect command.
	 */
	public static final SystemMessageId ENTERED_INCORRECT_COMMAND;
	 ...
	 */
	public static final SystemMessageId CLAN_MEMBER_CANT_BE_EXPELLED_DURING_TERRITORY_WAR;

	/**
	 * ID: 2916<br>
	 * Message: Participating in $s1 territory war
	 */
	public static final SystemMessageId PARTICIPATING_IN_S1_TERRITORY_WAR;

	/**
	 * ID: 2917<br>
	 * Message: Not participating in a territory war
	 */
	public static final SystemMessageId NOT_PARTICIPATING_IN_S1_TERRITORY_WAR;
	 ...
	 */
	public static final SystemMessageId CANT_REGISTER_TO_TERRITORY_WAR_BELOW_40;

	/**
	 * ID: 2919<br>
	 * Message: While disguised, you cannot operate a private or manufacture
	 * store.
	 */
	public static final SystemMessageId CANT_OPEN_STORE_WHILE_DISGUISED;

	/**
	 * ID: 2920<br>
	 * Message: No more airships can be summoned as the maximum airship limit
	 * has been met.
	 */
	public static final SystemMessageId CANT_SUMMON_AIRSHIP_LIMIT_REACHED;

	/**
	 * ID: 2921<br>
	 * Message: You cannot board the airship because the maximum number for
	 * occupants is met.
	 */
	public static final SystemMessageId CANT_BOARD_AIRSHIP_IS_FULL;
	...
	/**
	 * ID: 2929<br>
	 * Message: Your request cannot be processed because there's no enough
	 * available memory on your graphic card. Please try again after reducing
	 * the resolution.
	 */
	public static final SystemMessageId CANT_PROCESS_REQUEST_NO_MEMORY_IN_GRAPHIC_CARD;

	/**
	 * ID: 2930<br>
	 * Message: A graphic card internal error has occurred. Please install the
	 * latest version of the graphic card driver and try again.
	 */
	public static final SystemMessageId GRAPHIC_CARD_INTERNAL_ERROR;

	/**
	 * ID: 2931<br>
	 * Message: The system file may have been damaged. After ending the game,
	 * please check the file using the Lineage II auto update.
	 */
	public static final SystemMessageId SYSTEM_FILE_DAMAGED;

	/**
	 * ID: 2932<br>
	 * Message: $s1 adena
	 */
	public static final SystemMessageId S1_ADENA;

	/**
	 * ID: 2933<br>
	 * Message: Thomas D. Turkey has appeared. Please save Santa.
	 */
	public static final SystemMessageId TURKEY_APPEARED_SAVE_SANTA;

	/**
	 * ID: 2934<br>
	 * Message: You have defeated Thomas D. Turkey and rescued Santa.
	 */
	public static final SystemMessageId TURKEY_DEFEATED_SANTA_RESCUED;

	/**
	 * ID: 2935<br>
	 * Message: You failed to rescue Santa, and Thomas D. Turkey has
	 * disappeared.
	 */
	public static final SystemMessageId TURKEY_DISAPPEARED_FAILED_RESCUE;
	 ...
	 */
	public static final SystemMessageId CANT_USE_DISGUISE_SCROLL_WHILE_IN_SHOP;

	/**
	 * ID: 2939<br>
	 * Message: A disguise cannot be used when you are in a chaotic state.
	 */
	public static final SystemMessageId CANT_USE_DISGUISE_SCROLL_WHILE_CHAOTIC;

	/**
	 * ID: 2940<br>
	 * Message: You can increase the chance to enchant the item. Press Start to
	 * begin.
	 */
	public static final SystemMessageId CAN_INCREASE_CHANCE_TO_ENCHANT_PRESS_START;

	/**
	 * ID: 2941<br>
	 * Message: The request cannot be completed because the requirements are not
	 * met. In order to participate in a team match, all team members must have
	 * an Olympiad score of 1 or more.
	 */
	public static final SystemMessageId CANT_PARTICIPATE_IN_TEAM_MATCH_MEMBERS_MUST_HAVE_10_POINTS;

	/**
	 * ID: 2942<br>
	 * Message: The first gift's remaining resupply time is $s1 hour(s) $s2
	 * minute(s) $s3 second(s). (If you resummon the Agathion at the gift supply
	 * time, the supply time can take an additional 10 minutes.)
	 */
	public static final SystemMessageId FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_HOURS_S2_MINUTES_S3_SECONDS;

	/**
	 * ID: 2943<br>
	 * Message: The first gift's remaining resupply time is $s1 minute(s) $s2
	 * second(s). (If you resummon the Agathion at the gift supply time, the
	 * supply time can take an additional 10 minutes.)
	 */
	public static final SystemMessageId FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_MINUTES_S2_SECONDS;
	
	/**
	 * ID: 2944<br>
	 * Message: The first gift's remaining resupply time is $s1 second(s). (If
	 * you resummon the Agathion at the gift supply time, the supply time can
	 * take an additional 10 minutes.)
	 */
	public static final SystemMessageId FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_SECONDS;

	/**
	 * ID: 2945<br>
	 * Message: The second gift's remaining resupply time is $s1 hour(s) $s2
	 * minute(s) $s3 second(s). (If you resummon the Agathion at the gift supply
	 * time, the supply time can take an additional 1 hour 10 minutes.)
	 */
	public static final SystemMessageId SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_HOURS_S2_MINUTES_S3_SECONDS;

	/**
	 * ID: 2946<br>
	 * Message: The second gift's remaining resupply time is $s1 minute(s) $s2
	 * second(s). (If you resummon the Agathion at the gift supply time, the
	 * supply time can take an additional 1 hour 10 minutes.)
	 */
	public static final SystemMessageId SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_MINUTES_S2_SECONDS;

	/**
	 * ID: 2947<br>
	 * Message: The second gift's remaining resupply time is $s1 second(s). (If
	 * you resummon the Agathion at the gift supply time, the supply time can
	 * take an additional 1 hour 10 minutes.)
	 */
	public static final SystemMessageId SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_SECONDS;
	 ...
	 */
	public static final SystemMessageId OLY_PARTICIPANT_CANT_WITNESS_BATTLE;

	/**
	 * ID: 2957<br>
	 * Message: Characters with a February 29 creation date will receive a gift
	 * on February 28.
	 */
	public static final SystemMessageId CHARACTERS_CREATED_FEB_29_WILL_RECEIVE_GIFT_FEB_28;

	/**
	 * ID: 2958<br>
	 * Message: An Agathion has already been summoned.
	 */
	public static final SystemMessageId AGATHION_ALREADY_SUMMONED;

	/**
	 * ID: 2959<br>
	 * Message: Your account has been temporarily restricted because it is
	 * suspected of being used abnormally within the game. If you did not use it
	 * in an abnormal manner, you can go through self-identification on the
	 * homepage and use it afterward for normal service. You can check for more
	 * detailed information on the Lineage 2 official homepage
	 * (www.lineage2.plaync.co.kr) customer center's clause 1:1.
	 */
	public static final SystemMessageId ACCOUNT_TEMPORARILY_RESTRICTED;
	
	/**
	 * ID: 2960<br>
	 * Message: The item $s1 is require.
	 */
	public static final SystemMessageId ITEM_S1_REQUIRED;
	...
	/**
	 * ID: 2962<br>
	 * Message: This item cannot be used in the current transformation statte.
	 */
	public static final SystemMessageId ITEM_CANT_BE_USED_IN_THIS_TRANSFORMATION;
	 ...
	 * 
	 */
	public static final SystemMessageId OPPONENT_HASNT_EQUIPPED_S1_SO_S2_CANT_BE_USED;
	...
	/**
	 * ID: 2965<br>
	 * Message: You cannot purchase and re-purchase the same type of item at the
	 * same time.
	 */
	public static final SystemMessageId CANNOT_PURCHASE_AND_REPURCHASE_SAME_TYPE_AT_SAME_TYPE;
	 ...
	 */
	public static final SystemMessageId ATTEMPTING_SEND_MAIL_WISH_TO_PROCEED;
	 ...
	 */
	public static final SystemMessageId SET_AMOUNT_AENA_TO_SEND;

	/**
	 * ID: 2987<br>
	 * Message: Please set the amount of adena to receive.
	 */
	public static final SystemMessageId SET_AMOUNT_ADENA_TO_RECEIVE;
	 ...
	 */
	public static final SystemMessageId VITAMIN_ITEM_S1_USED;

	/**
	 * ID: 2990<br>
	 * Message: $S2 units of vitamin item $s1 was consumed.
	 */
	public static final SystemMessageId S2_UNITS_OF_VITAMIN_S1_CONSUMED;

	/**
	 * ID: 2991<br>
	 * Message: True input must be entered by someone over 15 years old.
	 */
	public static final SystemMessageId TRUE_INPUT_15_YEARS_OLD;

	/**
	 * ID: 2992<br>
	 * Message: Please choose the 2nd stage type.
	 */
	public static final SystemMessageId PLEASE_CHOOSE_SECOND_STAGE;
		/**
	 * ID: 2993<br>
	 * Message: When an Command Channel leader goes out of the Command Channel
	 * matching room, the currently open matchin room ends, do you really want
	 * to go out to the room?
	 */
	public static final SystemMessageId DO_YOU_REALLY_WANT_TO_END_CC_ROOM;

	/**
	 * ID: 2994<br>
	 * Message: The Command Channel matching room was cancelled.
	 */
	public static final SystemMessageId CC_ROOM_CANCELLED;

	/**
	 * ID: 2995<br>
	 * Message: This Command Channel matching room is already cancelled.
	 */
	public static final SystemMessageId CC_ROOM_ALREADY_CANCELLED;
	 ...
	 */
	public static final SystemMessageId CANNOT_ENTER_CC_ROOM_DONT_MEET_REQUIREMENTS;

	/**
	 * ID: 2997<br>
	 * Message: You exited from the Command Channel matching room.
	 */
	public static final SystemMessageId EXITED_FROM_CC_ROOM;

	/**
	 * ID: 2998<br>
	 * Message: You were expelled from the Command Channel matching room.
	 */
	public static final SystemMessageId EXPELLED_FROM_CC_ROOM;

	/**
	 * ID: 2999<br>
	 * Message: The Command Channel affiliated party's member can not use the
	 * matching screen.
	 */
	public static final SystemMessageId CC_MEMBER_CANT_USE_MATCHING;

	/**
	 * ID: 3000<br>
	 * Message: The Command Channel matching room was created.
	 */
	public static final SystemMessageId CC_MATCHING_ROOM_CREATED;

	/**
	 * ID: 3001<br>
	 * Message: The Command Channel matching room information was editted
	 */
	public static final SystemMessageId CC_MATCHING_ROOM_INFORMATION_EDITTED;
	 ...
	 */
	public static final SystemMessageId C1_ENTERED_CC_MATCHING_ROOM;

	/**
	 * ID: 3004<br>
	 * Message: I'm sorry to give you a satisfactory response. \n If you send
	 * your comments regarding unsatisfying parts, we will be able to provide
	 * even greater service. \n Please send us your comments.
	 */
	public static final SystemMessageId PLEASE_SEND_COMMENTS;

	/**
	 * ID: 3005<br>
	 * Message: This skill cannot be enhanced.
	 */
	public static final SystemMessageId SKILL_CANNOT_BE_ENHANCED;

	/**
	 * ID: 3006<br>
	 * Message: Newly used PC cafe $s1 points were withdrawn.
	 */
	public static final SystemMessageId S1_PC_CAFE_POINTS_WITHDRAWN;

	/**
	 * ID: 3007<br>
	 * Message: Shyeed's Roar filled with wrath rings throughout the Stakato
	 * Nest.
	 */
	public static final SystemMessageId SHYEED_APPEARANCE;
	...
	/**
	 * ID: 3017<br>
	 * Message: You cannot use any skill enhancing system under your status.
	 * Check out the current PC's status.
	 */
	public static final SystemMessageId SKILL_CANNOT_BE_ENHANCED_PC_STATUS;

	/**
	 * ID: 3018<br>
	 * Message: You cannot use skill enhancing system functions for the skills
	 * currently not acquired.
	 */
	public static final SystemMessageId SKILL_CANNOT_BE_ENHANCED_NOT_ACQUIRED;
	 ...
	 */
	public static final SystemMessageId STANDBY_FOR_GAME_TO_BEGIN;
	...
	/**
	 * ID: 3032<br>
	 * Message: In order to help Anakim, activate the sealing device of the
	 * Emperor who is possesed by the evil magical curse! Magical curse is very
	 * powerful, so we must be careful!
	 */
	public static final SystemMessageId TO_HELP_ANAKIM_ACTIVE_SEALING_DEVICE;
	...
	/**
	 * ID: 3035<br>
	 * Message: My power's weakening. Please activate the sealing device
	 * possessed by Lilith's magical curse!
	 */
	public static final SystemMessageId POWER_WEAKENING_ACTIVATE_SEALING_DEVICE;

	/**
	 * ID: 3036<br>
	 * Message: You, such a fool! The victory over this war belongs to Shilien!
	 */
	public static final SystemMessageId YOU_FOOL_VICTORY_BELONGS_TO_SHILIEN;
	 ...
	 * the curse of flames.
	 */
	public static final SystemMessageId USE_HOLY_WATER_TO_OPEN_DOOR;
	 ...
	 */
	public static final SystemMessageId USE_MAGIC_STAFF_TO_OPEN_DOOR;

	/**
	 * ID: 3041<br>
	 * Message: Around fifteen hundred years ago, the lands were riddled with
	 * heretics,
	 */
	public static final SystemMessageId FIFTEEN_HUNDRED_YEARS_AGO;

	/**
	 * ID: 3042<br>
	 * Message: worshippers of Shilen, the Goddess of Death...
	 */
	public static final SystemMessageId WORSHIPPERS_OF_SHILEN;

	/**
	 * ID: 3043<br>
	 * Message: But a miracle happened at the enthronement of Shunaiman, the
	 * first emperor.
	 */
	public static final SystemMessageId MIRACLE_HAPPENED_AT_ENTHRONEMENT;

	/**
	 * ID: 3044<br>
	 * Message: Anakim, an angel of Einhasad, came down from the skies,
	 */
	public static final SystemMessageId ANAKIM_CAME_DOWN_FROM_THE_SKIES;

	/**
	 * ID: 3045<br>
	 * Message: surrounded by sacred flames and three pairs of wings.
	 */
	public static final SystemMessageId ANAKIM_SURROUNDED_BY_SACRED_FLAMES;

	/**
	 * ID: 3046<br>
	 * Message: Thus empowered, the Emperor launched a war against 'Shilen's
	 * People.'
	 */
	public static final SystemMessageId EMPOWERED_EMPEROR_LAUNCHED_WAR_AGAINST_SHILENS_PEOPLE;

	/**
	 * ID: 3047<br>
	 * Message: The emperor's army led by Anakim attacked 'Shilen's People'
	 * relentlessly,
	 */
	public static final SystemMessageId EMPERORS_ARMY_ATTACKED_SHILENS_PEOPLE;

	/**
	 * ID: 3048<br>
	 * Message: but in the end some survivors managed to hide in underground
	 * Catacombs.
	 */
	public static final SystemMessageId SOME_SURVIVORS_MANAGED_TO_HIDE;

	/**
	 * ID: 3049<br>
	 * Message: A new leader emerged, Lilith, who seeked to summon Shilen from
	 * the afterlife,
	 */
	public static final SystemMessageId NEW_LEADER_EMERGED_WHO_SEEKED_TO_SUMMON_SHILEN;

	/**
	 * ID: 3050<br>
	 * Message: and to rebuild the Lilim army within the eight Necropolises.
	 */
	public static final SystemMessageId REBUILD_LILIM_ARMY_WITHIN_NECROS;

	/**
	 * ID: 3051<br>
	 * Message: Now, in the midst of impending war, the merchant of Mammon
	 * struck a deal.
	 */
	public static final SystemMessageId MERCHANT_OF_MAMMON_STRUCK_A_DEAL;

	/**
	 * ID: 3052<br>
	 * Message: He supplies Shunaiman with war funds in exchange for protection.
	 */
	public static final SystemMessageId SUPPLIES_SHINAIMAN_FOR_PROTECTION;

	/**
	 * ID: 3053<br>
	 * Message: And right now the document we're looking for is that contract.
	 */
	public static final SystemMessageId LOOKING_FOR_CONTRAT;

	/**
	 * ID: 3054<br>
	 * Message: Finally you're here! I'm Anakim, I need your help.
	 */
	public static final SystemMessageId FINALLY_HERE_ANAKIM_NEEDS_YOUR_HELP;

	/**
	 * ID: 3055<br>
	 * Message: It's the seal devices... I need you to destroy them while I
	 * distract Lilith!
	 */
	public static final SystemMessageId DESTROY_SEAL_DEVICES_WHILE_ANAKIM_DISTRACTS;

	/**
	 * ID: 3056<br>
	 * Message: Please hurry. I don't have much time left!
	 */
	public static final SystemMessageId HURRY_NO_TIME_LEFT;

	/**
	 * ID: 3057<br>
	 * Message: For Einhasad!
	 */
	public static final SystemMessageId FOR_EINHASAD;

	/**
	 * ID: 3058<br>
	 * Message: Em.bry.o..
	 */
	public static final SystemMessageId EMBRYO;
	 ...
	 * normally!
	 */
	public static final SystemMessageId SEALING_DEVICE_GLITTERS_ACTIVATION_COMPLETE;

	/**
	 * ID: 3061<br>
	 * Message: There comes a sound of opening the heavy door from somewhere.
	 */
	public static final SystemMessageId SOUND_OF_HEAVY_DOOR_OPENING;
	...
	/**
	 * ID: 3070<br>
	 * Message: Skill not available to be enhanced Check skill's Lv and current
	 * PC status.
	 */
	public static final SystemMessageId SKILL_NOT_AVAILABLE_TO_ENCHANT;

	/**
	 * ID: 3071<br>
	 * Message: Do you really want to reset? 10,000,000(10 million) Adena will
	 * be consumed.
	 */
	public static final SystemMessageId DO_YOU_REALLY_WANT_TO_RESET;
	...
	/**
	 * ID: 3083<br>
	 * Message: In the process of working on the previous clan
	 * declaration/retreat. Please try again later.
	 */
	public static final SystemMessageId WORKING_ON_PREVIOUS_CLAN_DECLARATION_TRY_AGAIN_LATER;

	/**
	 * ID: 3084<br>
	 * Message: Currently, we are in the process of choosing a hero. Please try
	 * again later.
	 */
	public static final SystemMessageId PROCESS_CHOOSING_HERO_TRY_AGAIN_LATER;

	/**
	 * ID: 3085<br>
	 * Message: You can summon the pet you are trying to summon now only when
	 * you own an agit.
	 */
	public static final SystemMessageId CANT_SUMMON_PET_MUST_OWN_AGIT;

	/**
	 * ID: 3086<br>
	 * Message: Would you like to give $s2 $s1?
	 */
	public static final SystemMessageId WOULD_YOU_LIKE_TO_GIVE_S2_S1;

	/**
	 * ID: 3087<br>
	 * Message: This mail is being sent with a Payment Request. Would you like
	 * to continue?
	 */
	public static final SystemMessageId MAIL_IS_PAYMENT_REQUEST_DO_YOU_WANT_CONTINUE;

	/**
	 * ID: 3088<br>
	 * Message: You have $s1 hours $s2 minutes and $s3 seconds left in the Proof
	 * of Space and Time. If Agathion is summoned within this time, 10 minutes
	 * or more can be added.
	 */
	public static final SystemMessageId S1_HOURS_S2_MINUTES_S3_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME;

	/**
	 * ID: 3089<br>
	 * Message: You have $s1 minutes and $s2 seconds left in the Proof of Space
	 * and Time. If Agathion is summoned within this time, 10 minutes or more
	 * can be added.
	 */
	public static final SystemMessageId S1_MINUTES_S2_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME;

	/**
	 * ID: 3090<br>
	 * Message: You have $s1 seconds left in the Proof of Space and Time. If
	 * Agathion is summoned within this time, 10 minutes or more can be added.
	 */
	public static final SystemMessageId S1_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME;

	/**
	 * ID: 3091<br>
	 * Message: You cannot delete characters on this server right now.
	 */
	public static final SystemMessageId CANNOT_DELETE_CHARACTER_NOW;

	/**
	 * ID: 3092<br>
	 * Message: Transaction Complete.
	 */
	public static final SystemMessageId TRANSACTION_COMPLETE;

	/**
	 * ID: 3093<br>
	 * Message: It is out of the proper calculation range. Please try again.
	 */
	public static final SystemMessageId IS_OUT_OF_PROPER_CALCULATION_RANGE;

	/**
	 * ID: 3094<br>
	 * Message: A user currently participating in the Olympiad cannot send party and friend invitations.
	 */
	public static final SystemMessageId CANNOT_INVITE_FRIENDS_PARTY_WHILE_IN_OLYMPIAD;

	/**
	 * ID: 3095<br>
	 * Message: The certification failed because you did not enter a valid certification number or
	 * you did not enter a certification number at all.
	 * If you fail 3 times in a row, you will be blocked from the game for 30 minutes.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_FAILED_INVALID_NUMBER;

	/**
	 * ID: 3096<br>
	 * Message: Due to problems with communications, our telephone certification service is currently unavailable.
	 * Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_UNAVAILABLE_PROBLEMS_WITH_COMMUNICATION;
	/**
	 * ID: 3097<br>
	 * Message: Due to problems with communications, telephone signals are being delayed. Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_SIGNALS_DELAYED_PROBLEMS_WITH_COMMUNICATION_TRY_LATER;

	/**
	 * ID: 3098<br>
	 * Message: The certification failed because the line was busy or the call was not received. Please try again.
	 */
	public static final SystemMessageId CERTIFICATION_FAILED_LINE_BUSY_OR_CALL_NOT_RECEIVED;
	/**
	 * ID: 3099<br>
	 * Message: The telephone certification service subscription number is expired or incorrect.
	 * Please check the telephone certification service subscription information.
	 * (plaync > Security Center > Telephone Certification Service)
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_SUBSCRIPTION_NUMBER_EXPIRED_OR_INCORRECT;

	/**
	 * ID: 3100<br>
	 * Message: The telephone certification service is currently being checked. Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_SERVICE_BEING_CHECKED_TRY_LATER;
	
	/**
	 * ID: 3101<br>
	 * Message: Due to heavy volume, the telephone certification service cannot be used at this time.
	 * Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_SERVICE_CANNOT_BE_USED_HEAVY_VOLUME;

	/**
	 * ID: 3102<br>
	 * Message: The telephone certification service use period has expired, so game play has been blocked.
	 * Please check the game play block setup. (plaync > Security Center > Telephone Certification Service)
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_SERVICE_USE_PERIOD_EXPIRED;

	/**
	 * ID: 3103<br>
	 * Message: The telephone certification failed 3 times in a row, so game play has been blocked for 30 minutes.
	 * Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_FAILED_3_TIMES_GAME_BLOCKED_FOR_30_MINUTES_TRY_LATER;

	/**
	 * ID: 3104<br>
	 * Message: The number of uses of the daily telephone certification service has been exceeded.
	 */
	public static final SystemMessageId NUMBER_OF_USES_OF_TELEPHONE_CERTIFICATION_SERVICE_EXCEEDED;

	/**
	 * ID: 3105<br>
	 * Message: Telephone certification is already underway. Please try again later.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_ALREADY_UNDERWAY_TRY_LATER;

	/**
	 * ID: 3106<br>
	 * Message: Telephone certification is underway.
	 */
	public static final SystemMessageId TELEPHONE_CERTIFICATION_UNDERWAY;

	/**
	 * ID: 3107<br>
	 * Message: One moment please.
	 */
	public static final SystemMessageId ONE_MOMENT_PLEASE;
	 ...
	 */
	public static final SystemMessageId S1_ACHIEVED_S2_WINS_IN_A_ROW_IN_JACKS_GAME;

	/**
	 * ID: 3110<br>
	 * Message: In reward for $s2 wins in a row, $s1 has received $s4 of $s3(s).
	 */
	public static final SystemMessageId S1_HAS_RECEIVED_S4_OF_S3_FOR_S2_WINS_IN_A_ROW;

	/**
	 * ID: 3111<br>
	 * Message: World: $s1 wins in a row ($s2 ppl)
	 */
	public static final SystemMessageId WORLD_RECORD_S1_WINS_IN_A_ROW_S2_PPL;

	/**
	 * ID: 3112<br>
	 * Message: My record: $s1 wins in a row
	 */
	public static final SystemMessageId MY_RECORD_S1_WINS_IN_A_ROW;

	/**
	 * ID: 3113<br>
	 * Message: World: Below 4 wins in a row
	 */
	public static final SystemMessageId WORLD_RECORD_BELOW_4_WINS_IN_A_ROW;

	/**
	 * ID: 3114<br>
	 * Message: My record: Below 4 wins in a row
	 */
	public static final SystemMessageId MY_RECORD_BELOW_4_WINS_IN_A_ROW;

	/**
	 * ID: 3115<br>
	 * Message: This is the Halloween event period.
	 */
	public static final SystemMessageId HALLOWEEN_EVENT_PERIOD;

	/**
	 * ID: 3116<br>
	 * Message: No record of 10 or more wins in a row.
	 */
	public static final SystemMessageId NO_RECORD_OF_10_WINS_IN_A_ROW;
	...
	/**
	 * ID: 3171<br>
	 * Message: The gift's remaining resupply time is $s1 minute(s) $s2 second(s).
	 * (If you resummon the Agathion at the gift supply time, the supply time can take an additional 30 minutes.)
	 */
	public static final SystemMessageId GIFT_REMAINING_SUPPLY_TIME_S1_MINUTES_S2_SECONDS;

	/**
	 * ID: 3172<br>
	 * Message: The gift's remaining resupply time is $s1 second(s).
	 * (If you resummon the Agathion at the gift supply time, the supply time can take an additional 30 minutes.)
	 */
	public static final SystemMessageId GIFT_REMAINING_SUPPLY_TIME_S1_SECONDS;
	 ...
	 */
	public static final SystemMessageId ITEM_SUCCESFULLY_PURCHASED;

	/**
	 * ID: 6002<br>
	 * Message: The item has failed to be purchased.
	 */
	public static final SystemMessageId FAILED_PURCHASE_ITEM;

	/**
	 * ID: 6003<br>
	 * Message: The item you selected cannot be purchased. Unfortunately, the
	 * sale period ended.
	 */
	public static final SystemMessageId CANNOT_PURCHASE_ITEM_SALE_PERIOD_ENDED;

	/**
	 * ID: 6004<br>
	 * Message: Enchant failed. The enchant skill for the corresponding item
	 * will be exactly retained.
	 */
	public static final SystemMessageId ENCHANT_FAILED_ITEM_WILL_RETAIN_SKILL;

	/**
	 * ID: 6005<br>
	 * Message: Game points are not enough.
	 */
	public static final SystemMessageId GAME_POINTS_NOT_ENOUGH;

	/**
	 * ID: 6006<br>
	 * Message: The item cannot be received because the inventory
	 * weight/quantity limit has been exceeded.
	 */
	public static final SystemMessageId ITEM_CANNOT_BE_RECEIVED_INVENTORY_QUANTITY_EXCEEDED;

	/**
	 * ID: 6007<br>
	 * Message: Product Purchase Error - The user state is not right.
	 */
	public static final SystemMessageId PRODUCT_PURCHASE_ERROR_USER_NOT_RIGHT;

	/**
	 * ID: 6008<br>
	 * Message: Product Purchase Error - The product is not right.
	 */
	public static final SystemMessageId PRODUCT_PURCHASE_ERROR_PRODUCT_NOT_RIGHT;

	/**
	 * ID: 6009<br>
	 * Message: Product Purchase Error - The item within the product is not
	 * right.
	 */
	public static final SystemMessageId PRODUCT_PURCHASE_ERROR_ITEM_NOT_RIGHT;

	/**
	 * ID: 6010<br>
	 * Message: The master account of your account has been restricted
	 */
	public static final SystemMessageId MASTER_ACCOUNT_RESTRICTED;

	/**
	 * ID: 6011<br>
	 * Message: You acquired $s1 Exp. and $s2 SP. (As a reward you receive $s3%
	 * more Exp.)
	 */
	public static final SystemMessageId ACQUIRED_S1_EXP_S2_SP_REWARD_MORE_S3_EXP;

	/**
	 * ID: 6012<br>
	 * Message: a blessing that increases Exp. by $1 $2
	 */
	public static final SystemMessageId A_BLESSING_INCREASES_EXP_BY_S1_S2;

	/**
	 * ID: 6013<br>
	 * Message: It is not a blessing period. When you reach today's target, you
	 * can receive $s1%.
	 */
	public static final SystemMessageId NOT_BLESSING_PERIOD_WHEN_REACH_TARGET_RECEIVE_S1;

	/**
	 * ID: 6014<br>
	 * Message: It is Eva's blessing period. $s1% will be effective until $s2.
	 */
	public static final SystemMessageId IT_IS_EVAS_BLESSING_S1_WILL_BE_EFFECTIVE_UNTIL_S2;

	/**
	 * ID: 6015<br>
	 * Message: It is Eva's blessing period. Until $s1, Jack Sage can gift you
	 * with $s2%.
	 */
	public static final SystemMessageId IT_IS_EVAS_BLESSING_UNTIL_S1_JACK_CAN_GIFT_S2;

	/**
	 * ID: 6016<br>
	 * Message: Progress: Event stage $s1.
	 */
	public static final SystemMessageId PROGESS_EVENT_STAGE_S1;

	/**
	 * ID: 6017<br>
	 * Message: Eva's Blessing Stage $s1 has begun.
	 */
	public static final SystemMessageId EVAS_BLESSING_STAGE_S1_BEGUN;

	/**
	 * ID: 6018<br>
	 * Message: Eva's Blessing Stage $s1 has ended.
	 */
	public static final SystemMessageId EVAS_BLESSING_STAGE_S1_ENDED;

	/**
	 * ID: 6019<br>
	 * Message: You cannot buy the item on this day of the week.
	 */
	public static final SystemMessageId CANT_BUY_ITEM_TODAY;
		/**
	 * ID: 6020<br>
	 * Message: You cannot buy the item at this hour.
	 */
	public static final SystemMessageId CANT_BUY_ITEM_NOW;

	/**
	 * ID: 6021<br>
	 * Message: ,%s1 reached %s2 consecutive wins in Jack Game.
	 */
	public static final SystemMessageId S1_REACHED_S2_WINS_IN_JACK_GAME;

	/**
	 * ID: 6022<br>
	 * Message: ,$s1 received $s4 $s3 as reward for $s2 consecutive wins.
	 */
	public static final SystemMessageId S1_RECEIVED_S4_S3_REWARD_FOR_S2_WINS;

	/**
	 * ID: 6023<br>
	 * Message: World: $s1 consecutive wins ($s2 ppl.)
	 */
	public static final SystemMessageId WORLD_RECORD_S1_WINS_S2_PPL;

	/**
	 * ID: 6024<br>
	 * Message: My Record: $s1 consecutive wins
	 */
	public static final SystemMessageId MY_RECORD_S1_WINS;

	/**
	 * ID: 6025<br>
	 * Message: World: Under 4 consecutive wins
	 */
	public static final SystemMessageId WORLD_UNDER_4_WINS;

	/**
	 * ID: 6026<br>
	 * Message: My Record: Under 4 consecutive wins
	 */
	public static final SystemMessageId MY_RECORD_UNDER_4;

	/**
	 * ID: 6027<br>
	 * Message: It's Halloween Event period.
	 */
	public static final SystemMessageId ITS_HALLOWEEN;

	/**
	 * ID: 6028<br>
	 * Message: No record over 10 consecutive wins.
	 */
	public static final SystemMessageId NO_RECORD_OVER_10_WINS;
	
	/**
	 * ID: 6029<br>
	 * Message: Please help raise reindeer for Santa's Christmas delivery!
	 */
	public static final SystemMessageId PLEASE_HELP_RAISE_REINDEER_FOR_SANTAS_CHRISTMAS_DELIVERY;
	
	/**
	 * ID: 6030<br>
	 * Message: Santa has started delivering the Christmas gifts to Aden!
	 */
	public static final SystemMessageId SANTA_STARTED_DELIVERING_CHRISTMAS_GIFTS;
	
	/**
	 * ID: 6031<br>
	 * Message: Santa has completed the deliveries! See you in 1 hour!
	 */
	public static final SystemMessageId SANTA_COMPLETED_DELIVERIES;

	/**
	 * ID: 6032<br>
	 * Message: Santa is out delivering the gifts. Merry Christmas!
	 */
	public static final SystemMessageId SANTA_OUT_DELIVERING_MERRY_CHRISTMAS;

	/**
	 * ID: 6033<br>
	 * Message: Only the top $s1 appear in the ranking, and only the top $s2 are recorded in My Best Ranking.
	 */
	public static final SystemMessageId ONLY_TOP_S1_APPEAR_IN_RANKING_ONLY_TOP_S2_RECORDED_IN_BEST_RANKING;

	/**
	 * ID: 6034<br>
	 * Message: $s1 have/has been initialized.
	 */
	public static final SystemMessageId S1_HAS_BEEN_INITIALIZED;

	/**
	 * ID: 6035<br>
	 * Message: When there are many players with the same score, they appear in the order in which they were achieved.
	 */
	public static final SystemMessageId WHEN_MANY_PLAYERS_HAVE_SAME_SCORE_THEY_APPEAR_IN_ORDER_OF_ACHIEVING;
	/**
	 * ID: 6036<br>
	 * Message: Below $s1 points
	 */
	public static final SystemMessageId BELOW_S1_POINTS;

	/**
	 * ID: 6037<br>
	 * Message: The Lovers' Jubilee has begun!
	 */
	public static final SystemMessageId LOVERS_JUBILEE_HAS_BEGUN;

	/**
	 * ID: 6038<br>
	 * Message: You can use Evangelist Mark. (/Evangelist on/off is used to toggle)
	 */
	public static final SystemMessageId YOU_CAN_USE_EVANGELIST_MARK;

	/**
	 * ID: 6039<br>
	 * Message: You have completed the initial level. Congratulations~!
	 */
	public static final SystemMessageId YOU_COMPLETED_INITIAL_LEVEL_CONGRATS;

	/**
	 * ID: 6040<br>
	 * Message: Please type "on/off" after the command.
	 */
	public static final SystemMessageId PLEASE_TYPE_ON_OFF_AFTER_COMMAND;

	/**
	 * ID: 6041<br>
	 * Message: This is the April Fools' Day event period.
	 */
	public static final SystemMessageId APRIL_FOOLS_EVENT_PERIOD;

	/**
	 * ID: 6042<br>
	 * Message: The skill has been canceled because you have insufficient Soul Avatar Energy.
	 */
	public static final SystemMessageId SKILL_CANCELED_INSUFFICIENT_SOUL_AVATAR;

	/**
	 * ID: 6043<br>
	 * Message: Your energy cannot be replenished because there is no Soul Avatar.
	 */
	public static final SystemMessageId ENERGY_CANNOT_BE_REPLENISHED_NO_SOUL_AVATAR;

	/**
	 * ID: 6044<br>
	 * Message: Energy $s replenished at the Soul Avatar.
	 */
	public static final SystemMessageId ENERGY_S1_REPLENISHED_AT_SOUL_AVATAR;

	/**
	 * ID: 6045<br>
	 * Message: ,$c1 acquired April Fools' Day Special Gift.
	 */
	public static final SystemMessageId C1_ACQUIRED_APRIL_FOOLS_GIFT;
	...
	/**
	 * ID: 6506<br>
	 * Message: Although you can't be certain, the air seems laden with the
	 * scent of freshly baked bread.
	 * 
	 */
	public static final SystemMessageId SCENT_BAKED_BREAD;

	/**
	 * ID: 6507<br>
	 * Message: You feel refreshed. Everything appears clear.
	 */
	public static final SystemMessageId YOU_FEEL_REFRESHED;
	...
	static
	{
		...
		MOVED_TO_THE_PREVIOUS_CHATTING_CHANNEL_TAB = new SystemMessageId(2501);
		MOVED_TO_THE_NEXT_CHATTING_CHANNEL_TAB = new SystemMessageId(2502);
		CURRENT_TARGET_WILL_BE_CANCELLED = new SystemMessageId(2503);
		FOCUS_WILL_MOVED_TO_CHAT_WINDOW = new SystemMessageId(2504);
		OPENS_OR_CLOSES_INVENTORY_WINDOW = new SystemMessageId(2505);
		TEMPORARILY_HIDES_ALL_OPEN_WINDOWS = new SystemMessageId(2506);
		CLOSES_ALL_OPEN_WINDOWS = new SystemMessageId(2507);
		OPENS_GM_MANAGER_WINDOW = new SystemMessageId(2508);
		OPENS_GM_PETITION_WINDOW = new SystemMessageId(2509);
		BUFF_IN_PARTY_WINDOW_IS_TOGGLED = new SystemMessageId(2510);
		ACTIVATES_DESACTIVATES_MINIMUM_FRAME = new SystemMessageId(2511);
		RUNS_OR_CLOSES_MSN_WINDOW = new SystemMessageId(2512);
		ASSIGN_1_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2513);
		ASSIGN_2_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2514);
		ASSIGN_3_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2515);
		ASSIGN_4_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2516);
		ASSIGN_5_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2517);
		ASSIGN_6_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2518);
		ASSIGN_7_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2519);
		ASSIGN_8_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2520);
		ASSIGN_9_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2521);
		ASSIGN_10_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2522);
		ASSIGN_11_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2523);
		ASSIGN_12_SLOT_SHORTCUT_BASE_WINDOW = new SystemMessageId(2524);
		ASSIGN_1_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2525);
		ASSIGN_2_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2526);
		ASSIGN_3_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2527);
		ASSIGN_4_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2528);
		ASSIGN_5_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2529);
		ASSIGN_6_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2530);
		ASSIGN_7_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2531);
		ASSIGN_8_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2532);
		ASSIGN_9_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2533);
		ASSIGN_10_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2534);
		ASSIGN_11_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2535);
		ASSIGN_12_SLOT_SHORTCUT_EXPANDED_WINDOW = new SystemMessageId(2536);
		ASSIGN_1_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2537);
		ASSIGN_2_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2538);
		ASSIGN_3_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2539);
		ASSIGN_4_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2540);
		ASSIGN_5_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2541);
		ASSIGN_6_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2542);
		ASSIGN_7_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2543);
		ASSIGN_8_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2544);
		ASSIGN_9_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2545);
		ASSIGN_10_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2546);
		ASSIGN_11_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2547);
		ASSIGN_12_SLOT_SHORTCUT_EXPANDED_WINDOW2 = new SystemMessageId(2548);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE1 = new SystemMessageId(2549);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE2 = new SystemMessageId(2550);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE3 = new SystemMessageId(2551);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE4 = new SystemMessageId(2552);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE5 = new SystemMessageId(2553);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE6 = new SystemMessageId(2554);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE7 = new SystemMessageId(2555);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE8 = new SystemMessageId(2556);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE9 = new SystemMessageId(2557);
		MOVE_SHORTCUT_PAGE_TO_BASE_WINDOW_PAGE10 = new SystemMessageId(2558);
		OPENS_CLOSES_ACTION_WINDOW = new SystemMessageId(2559);
		OPENS_CLOSES_GAME_BOARD = new SystemMessageId(2560);
		OPENS_CLOSES_CALCULATOR = new SystemMessageId(2561);
		HIDES_SHOWS_CHAT_WINDOW = new SystemMessageId(2562);
		OPENS_CLOSES_CLAN_WINDOW = new SystemMessageId(2563);
		OPENS_CLOSES_STATUS_WINDOW = new SystemMessageId(2564);
		OPENS_CLOSES_HELP_WINDOW = new SystemMessageId(2565);
		OPENS_CLOSES_INVENTORY_WINDOW = new SystemMessageId(2566);
		OPENS_CLOSES_MACRO_WINDOW = new SystemMessageId(2567);
		OPENS_CLOSES_SKILL_WINDOW = new SystemMessageId(2568);
		HIDES_SHOWS_MENU_WINDOW = new SystemMessageId(2569);
		OPENS_CLOSES_MINI_MAP = new SystemMessageId(2570);
		OPENS_CLOSES_OPTION_WINDOW = new SystemMessageId(2571);
		OPEN_CLOSE_PARTY_WINDOW = new SystemMessageId(2572);
		OPEN_CLOSE_QUEST_WINDOW = new SystemMessageId(2573);
		HIDE_SHOW_RADAR_MAP = new SystemMessageId(2574);
		HIDE_SHOW_STATUS_WINDOW = new SystemMessageId(2575);
		OPENS_CLOSES_SYSTEM_WINDOW = new SystemMessageId(2576);
		DONT_SHOW_DROPS_ITEMS = new SystemMessageId(2577);
		KEY_TO_AUTO_SEND_WHISPERS = new SystemMessageId(2578);
		DISABLE_ALL_GAME_SOUNDS = new SystemMessageId(2579);
		EXPANDS_SHORTCUT_WINDOW = new SystemMessageId(2580);
		INITIALIZE_USER_INTERFACE = new SystemMessageId(2581);
		TURNS_CHARACTER_TO_LEFT = new SystemMessageId(2582);
		TURNS_CHARACTER_TO_RIGHT = new SystemMessageId(2583);
		MOVES_CHARACTER_FORWARD = new SystemMessageId(2584);
		MOVES_CHARACTER_BACKWARDS = new SystemMessageId(2585);
		MOVES_CHARACTER_FORWARD_AUTO = new SystemMessageId(2586);
		REDUCES_CHARACTER_VIEW = new SystemMessageId(2587);
		EXPANDS_CHARACTER_VIEW = new SystemMessageId(2588);
		RAPID_TURNS_CHARACTER_VIEW = new SystemMessageId(2589);
		OPENS_THE_GM_MANAGER_WINDOW = new SystemMessageId(2590);
		OPENS_THE_GM_PETITION_WINDOW = new SystemMessageId(2591);
		RAPID_CONVERTS_CONTENTS_OF_EXPANDED_SHORTCUT_WINDOW = new SystemMessageId(2592);
		MOVES_CHARACTER_VIEW_AHEAD = new SystemMessageId(2593);
		MOVES_CHARACTER_VIEW_BEHIND = new SystemMessageId(2594);
		RESTORES_CHARACTER_VIEW = new SystemMessageId(2595);
		NO_TRANSLATION_REQUIRED = new SystemMessageId(2596);
		//NO_TRANSLATION_REQUIRED = new SystemMessageId(2597);
		//NO_TRANSLATION_REQUIRED = new SystemMessageId(2598);
		//NO_TRANSLATION_REQUIRED = new SystemMessageId(2599);
		...
		LINE_OF_DASHES = new SystemMessageId(2713);
		LONG_LINE_OF_DASHES = new SystemMessageId(2714);
		AIRSHIP_CANT_BE_BOARDED_HERE = new SystemMessageId(2715);
		...
		CANT_SUMMON_AIRSHIP_NOT_ENOUGH_S1 = new SystemMessageId(2723);
		CANT_PURCHASE_AIRSHIP_NOT_ENOUGH_S1 = new SystemMessageId(2724);
		CANT_SUMMON_AIRSHIP_DONT_MEET_REQUIREMENTS = new SystemMessageId(2725);
		CANT_PURCHASE_AIRSHIP_DONT_MEET_REQUIREMENTS = new SystemMessageId(2726);
		YOU_CANNOT_BOARD_NOT_MEET_REQUEIREMENTS = new SystemMessageId(2727);
		CANNOT_DO_WHILE_MOUNTED = new SystemMessageId(2728);
		...
		CANNOT_CONTROL_AIRSHIP = new SystemMessageId(2739);
		CANNOT_DO_WHILE_CONTROLLING = new SystemMessageId(2740);
		YOU_CAN_CONTROL_AIRSHIP = new SystemMessageId(2741);
		ANY_CHARACTER_CAN_CONTROL_AIRSHIP = new SystemMessageId(2742);
		RESTART_WHILE_ON_AIRSHIP = new SystemMessageId(2743);
		YOU_CAN_EXIT_CONTROL_STATE = new SystemMessageId(2744);
		YOU_CAN_DISMOUNT_AIRSHIP = new SystemMessageId(2745);
		USE_DEPART = new SystemMessageId(2746);
		AIRSHIP_TELEPORT_IS_POSSIBLE = new SystemMessageId(2747);
		YOU_HAVE_BEEN_REPORTED_AND_CANNOT_REPORT = new SystemMessageId(2748);
		CANNOT_CRYSTALLIZE_LIMIT_REACHED = new SystemMessageId(2749);
		...
		WAR_DECLARED_FOR_S1 = new SystemMessageId(2752);
		CANNOT_ATTACK_ALLIED_TROOPS = new SystemMessageId(2753);
		PVP_MATCHES_OVERLAP = new SystemMessageId(2754);
		C1_IS_NOW_CAT = new SystemMessageId(2755);
		TARGET_ALREADY_CONTROLLED = new SystemMessageId(2756);
		TARGET_MOVING_FAILED_MOUNT = new SystemMessageId(2757);
		CANT_CONTROL_TARGET_IF_HAVE_PET_SERVITOR = new SystemMessageId(2758);
		WHEN_PROHIBITED_CANT_MOUNT = new SystemMessageId(2759);
		WHEN_PROHIBITED_CANT_CONTROL_TARGET = new SystemMessageId(2760);
		MUST_TARGET_TO_CONTROL = new SystemMessageId(2761);
		...
		CANNOT_INCREASE_ALTITUDE = new SystemMessageId(2779);
		CANNOT_DECREASE_ALTITUDE = new SystemMessageId(2780);
		NUMBER_OF_UNITS_S1 = new SystemMessageId(2781);
		NUMBER_OF_PEOPLE_S1 = new SystemMessageId(2782);
		VICTORY_NOONE_LEFT = new SystemMessageId(2783);
		MATCH_LASTED_S1_MINUTES_S2_SECONDS_TIED = new SystemMessageId(2784);
		LARGE_SCALE_AIRSHIP = new SystemMessageId(2785);
		START_ONLY_WHEN_CONTROLLING = new SystemMessageId(2786);
		C1_DRAINED_YOU_S2_HP = new SystemMessageId(2787);
		MERCENARY_REQUESTED_PARTICIPATION_IN_S1_TERRITORY = new SystemMessageId(2788);
		MERCENARY_CANCELLED_PARTICIPATION_IN_S1_TERRITORY = new SystemMessageId(2789);
		CLAN_REQUESTED_PARTICIPATION_IN_S1_TERRITORY = new SystemMessageId(2790);
		...
		ALTITUDE_CANT_BE_DECREASED = new SystemMessageId(2905);
		ALTITUDE_CANT_BE_INCREASED = new SystemMessageId(2906);
		HOSTILE_ENVIROMENT_AIRSHIP_SPEED_DECREASED = new SystemMessageId(2907);
		LEAVING_HOSTILE_ENVIROMENT_AIRSHIP_SPEED_INCREASED = new SystemMessageId(2908);
		CANT_SUMMON_ON_AIRSHIP = new SystemMessageId(2909);
		ENTERED_INCORRECT_COMMAND = new SystemMessageId(2910);
		...
		CLAN_MEMBER_CANT_BE_EXPELLED_DURING_TERRITORY_WAR = new SystemMessageId(2915);
		PARTICIPATING_IN_S1_TERRITORY_WAR = new SystemMessageId(2916);
		NOT_PARTICIPATING_IN_S1_TERRITORY_WAR = new SystemMessageId(2917);
		CANT_REGISTER_TO_TERRITORY_WAR_BELOW_40 = new SystemMessageId(2918);
		CANT_OPEN_STORE_WHILE_DISGUISED = new SystemMessageId(2919);
		CANT_SUMMON_AIRSHIP_LIMIT_REACHED = new SystemMessageId(2920);
		CANT_BOARD_AIRSHIP_IS_FULL = new SystemMessageId(2921);
		...
		CANT_PROCESS_REQUEST_NO_MEMORY_IN_GRAPHIC_CARD = new SystemMessageId(2929);
		GRAPHIC_CARD_INTERNAL_ERROR = new SystemMessageId(2930);
		SYSTEM_FILE_DAMAGED = new SystemMessageId(2931);
		S1_ADENA = new SystemMessageId(2932);
		TURKEY_APPEARED_SAVE_SANTA = new SystemMessageId(2933);
		TURKEY_DEFEATED_SANTA_RESCUED = new SystemMessageId(2934);
		TURKEY_DISAPPEARED_FAILED_RESCUE = new SystemMessageId(2935);
		...
		CANT_USE_DISGUISE_SCROLL_WHILE_IN_SHOP = new SystemMessageId(2938);
		CANT_USE_DISGUISE_SCROLL_WHILE_CHAOTIC = new SystemMessageId(2939);
		CAN_INCREASE_CHANCE_TO_ENCHANT_PRESS_START = new SystemMessageId(2940);
		CANT_PARTICIPATE_IN_TEAM_MATCH_MEMBERS_MUST_HAVE_10_POINTS = new SystemMessageId(2941);
		FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_HOURS_S2_MINUTES_S3_SECONDS = new SystemMessageId(2942);
		FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_MINUTES_S2_SECONDS = new SystemMessageId(2943);
		FIRST_GIFT_REMAINING_RESUPPLY_TIME_S1_SECONDS = new SystemMessageId(2944);
		SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_HOURS_S2_MINUTES_S3_SECONDS = new SystemMessageId(2945);
		SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_MINUTES_S2_SECONDS = new SystemMessageId(2946);
		SECOND_GIFT_REMAINING_RESUPPLY_TIME_S1_SECONDS = new SystemMessageId(2947);
		TERRITORY_WAR_SCROLL_CAN_NOT_USED_NOW = new SystemMessageId(2955);
		OLY_PARTICIPANT_CANT_WITNESS_BATTLE = new SystemMessageId(2956);
		CHARACTERS_CREATED_FEB_29_WILL_RECEIVE_GIFT_FEB_28 = new SystemMessageId(2957);
		AGATHION_ALREADY_SUMMONED = new SystemMessageId(2958);
		ACCOUNT_TEMPORARILY_RESTRICTED = new SystemMessageId(2959);
		ITEM_S1_REQUIRED = new SystemMessageId(2960);
		S2_UNIT_OF_THE_ITEM_S1_REQUIRED = new SystemMessageId(2961);
		ITEM_CANT_BE_USED_IN_THIS_TRANSFORMATION = new SystemMessageId(2962);
		OPPONENT_HASNT_EQUIPPED_S1_SO_S2_CANT_BE_USED = new SystemMessageId(2963);
		CANCEL_NOBLESSE_QUESTS = new SystemMessageId(2964);
		CANNOT_PURCHASE_AND_REPURCHASE_SAME_TYPE_AT_SAME_TYPE = new SystemMessageId(2965);
		PAYMENT_REQUEST_NO_ITEM = new SystemMessageId(2966);
		ATTEMPTING_SEND_MAIL_WISH_TO_PROCEED = new SystemMessageId(2967);
		...
		SET_AMOUNT_AENA_TO_SEND = new SystemMessageId(2986);
		SET_AMOUNT_ADENA_TO_RECEIVE = new SystemMessageId(2987);
		CANT_CANCEL_INVENTORY_FULL = new SystemMessageId(2988);
		VITAMIN_ITEM_S1_USED = new SystemMessageId(2989);
		S2_UNITS_OF_VITAMIN_S1_CONSUMED = new SystemMessageId(2990);
		TRUE_INPUT_15_YEARS_OLD = new SystemMessageId(2991);
		PLEASE_CHOOSE_SECOND_STAGE = new SystemMessageId(2992);
		DO_YOU_REALLY_WANT_TO_END_CC_ROOM = new SystemMessageId(2993);
		CC_ROOM_CANCELLED = new SystemMessageId(2994);
		CC_ROOM_ALREADY_CANCELLED = new SystemMessageId(2995);
		CANNOT_ENTER_CC_ROOM_DONT_MEET_REQUIREMENTS = new SystemMessageId(2996);
		EXITED_FROM_CC_ROOM = new SystemMessageId(2997);
		EXPELLED_FROM_CC_ROOM = new SystemMessageId(2998);
		CC_MEMBER_CANT_USE_MATCHING = new SystemMessageId(2999);
		CC_MATCHING_ROOM_CREATED = new SystemMessageId(3000);
		CC_MATCHING_ROOM_INFORMATION_EDITTED = new SystemMessageId(3001);
		RECIPIENT_NOT_EXIST = new SystemMessageId(3002);
		C1_ENTERED_CC_MATCHING_ROOM = new SystemMessageId(3003);
		PLEASE_SEND_COMMENTS = new SystemMessageId(3004);
		SKILL_CANNOT_BE_ENHANCED = new SystemMessageId(3005);
		S1_PC_CAFE_POINTS_WITHDRAWN = new SystemMessageId(3006);
		SHYEED_APPEARANCE = new SystemMessageId(3007);
		...
		SKILL_CANNOT_BE_ENHANCED_PC_STATUS = new SystemMessageId(3017);
		SKILL_CANNOT_BE_ENHANCED_NOT_ACQUIRED = new SystemMessageId(3018);
		YOU_CANT_SEND_MAIL_TO_YOURSELF = new SystemMessageId(3019);
		PAYMENT_AMOUNT_NOT_ENTERED = new SystemMessageId(3020);
		STANDBY_FOR_GAME_TO_BEGIN = new SystemMessageId(3021);
		...
		TO_HELP_ANAKIM_ACTIVE_SEALING_DEVICE = new SystemMessageId(3032);
		...
		USE_HOLY_WATER_TO_OPEN_DOOR = new SystemMessageId(3039);
		USE_MAGIC_STAFF_TO_OPEN_DOOR = new SystemMessageId(3040);
		FIFTEEN_HUNDRED_YEARS_AGO = new SystemMessageId(3041);
		WORSHIPPERS_OF_SHILEN = new SystemMessageId(3042);
		MIRACLE_HAPPENED_AT_ENTHRONEMENT = new SystemMessageId(3043);
		ANAKIM_CAME_DOWN_FROM_THE_SKIES = new SystemMessageId(3044);
		ANAKIM_SURROUNDED_BY_SACRED_FLAMES = new SystemMessageId(3045);
		EMPOWERED_EMPEROR_LAUNCHED_WAR_AGAINST_SHILENS_PEOPLE = new SystemMessageId(3046);
		EMPERORS_ARMY_ATTACKED_SHILENS_PEOPLE = new SystemMessageId(3047);
		SOME_SURVIVORS_MANAGED_TO_HIDE = new SystemMessageId(3048);
		NEW_LEADER_EMERGED_WHO_SEEKED_TO_SUMMON_SHILEN = new SystemMessageId(3049);
		REBUILD_LILIM_ARMY_WITHIN_NECROS = new SystemMessageId(3050);
		MERCHANT_OF_MAMMON_STRUCK_A_DEAL = new SystemMessageId(3051);
		SUPPLIES_SHINAIMAN_FOR_PROTECTION = new SystemMessageId(3052);
		LOOKING_FOR_CONTRAT = new SystemMessageId(3053);
		FINALLY_HERE_ANAKIM_NEEDS_YOUR_HELP = new SystemMessageId(3054);
		DESTROY_SEAL_DEVICES_WHILE_ANAKIM_DISTRACTS = new SystemMessageId(3055);
		HURRY_NO_TIME_LEFT = new SystemMessageId(3056);
		FOR_EINHASAD = new SystemMessageId(3057);
		EMBRYO = new SystemMessageId(3058);
		S1_NOT_RECEIVE_DURING_WAITING_TIME_MAIL_RETURNED = new SystemMessageId(3059);
		SEALING_DEVICE_GLITTERS_ACTIVATION_COMPLETE = new SystemMessageId(3060);
		SOUND_OF_HEAVY_DOOR_OPENING = new SystemMessageId(3061);
		...
		SKILL_NOT_AVAILABLE_TO_ENCHANT = new SystemMessageId(3070);
		DO_YOU_REALLY_WANT_TO_RESET = new SystemMessageId(3071);
		...
		WORKING_ON_PREVIOUS_CLAN_DECLARATION_TRY_AGAIN_LATER = new SystemMessageId(3083);
		PROCESS_CHOOSING_HERO_TRY_AGAIN_LATER = new SystemMessageId(3084);
		CANT_SUMMON_PET_MUST_OWN_AGIT = new SystemMessageId(3085);
		WOULD_YOU_LIKE_TO_GIVE_S2_S1 = new SystemMessageId(3086);
		MAIL_IS_PAYMENT_REQUEST_DO_YOU_WANT_CONTINUE = new SystemMessageId(3087);
		S1_HOURS_S2_MINUTES_S3_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME = new SystemMessageId(3088);
		S1_MINUTES_S2_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME = new SystemMessageId(3089);
		S1_SECONDS_LEFT_IN_PROOF_OF_SPACE_AND_TIME = new SystemMessageId(3090);
		CANNOT_DELETE_CHARACTER_NOW = new SystemMessageId(3091);
		TRANSACTION_COMPLETE = new SystemMessageId(3092);
		IS_OUT_OF_PROPER_CALCULATION_RANGE = new SystemMessageId(3093);
		CANNOT_INVITE_FRIENDS_PARTY_WHILE_IN_OLYMPIAD = new SystemMessageId(3094);
		TELEPHONE_CERTIFICATION_FAILED_INVALID_NUMBER = new SystemMessageId(3095);
		TELEPHONE_CERTIFICATION_UNAVAILABLE_PROBLEMS_WITH_COMMUNICATION = new SystemMessageId(3096);
		TELEPHONE_SIGNALS_DELAYED_PROBLEMS_WITH_COMMUNICATION_TRY_LATER = new SystemMessageId(3097);
		CERTIFICATION_FAILED_LINE_BUSY_OR_CALL_NOT_RECEIVED = new SystemMessageId(3098);
		TELEPHONE_CERTIFICATION_SUBSCRIPTION_NUMBER_EXPIRED_OR_INCORRECT = new SystemMessageId(3099);
		TELEPHONE_CERTIFICATION_SERVICE_BEING_CHECKED_TRY_LATER = new SystemMessageId(3100);
		TELEPHONE_CERTIFICATION_SERVICE_CANNOT_BE_USED_HEAVY_VOLUME = new SystemMessageId(3101);
		TELEPHONE_CERTIFICATION_SERVICE_USE_PERIOD_EXPIRED = new SystemMessageId(3102);
		TELEPHONE_CERTIFICATION_FAILED_3_TIMES_GAME_BLOCKED_FOR_30_MINUTES_TRY_LATER = new SystemMessageId(3103);
		NUMBER_OF_USES_OF_TELEPHONE_CERTIFICATION_SERVICE_EXCEEDED = new SystemMessageId(3104);
		TELEPHONE_CERTIFICATION_ALREADY_UNDERWAY_TRY_LATER = new SystemMessageId(3105);
		TELEPHONE_CERTIFICATION_UNDERWAY = new SystemMessageId(3106);
		ONE_MOMENT_PLEASE = new SystemMessageId(3107);
		YOU_ARE_NO_LONGER_PROTECTED_FROM_AGGRESSIVE_MONSTERS = new SystemMessageId(3108);
		S1_ACHIEVED_S2_WINS_IN_A_ROW_IN_JACKS_GAME = new SystemMessageId(3109);
		S1_HAS_RECEIVED_S4_OF_S3_FOR_S2_WINS_IN_A_ROW = new SystemMessageId(3110);
		WORLD_RECORD_S1_WINS_IN_A_ROW_S2_PPL = new SystemMessageId(3111);
		MY_RECORD_S1_WINS_IN_A_ROW = new SystemMessageId(3112);
		WORLD_RECORD_BELOW_4_WINS_IN_A_ROW = new SystemMessageId(3113);
		MY_RECORD_BELOW_4_WINS_IN_A_ROW = new SystemMessageId(3114);
		HALLOWEEN_EVENT_PERIOD = new SystemMessageId(3115);
		NO_RECORD_OF_10_WINS_IN_A_ROW = new SystemMessageId(3116);
		...
		GIFT_REMAINING_SUPPLY_TIME_S1_MINUTES_S2_SECONDS = new SystemMessageId(3171);
		GIFT_REMAINING_SUPPLY_TIME_S1_SECONDS = new SystemMessageId(3172);
		...
		ITEM_SUCCESFULLY_PURCHASED = new SystemMessageId(6001);
		FAILED_PURCHASE_ITEM = new SystemMessageId(6002);
		CANNOT_PURCHASE_ITEM_SALE_PERIOD_ENDED = new SystemMessageId(6003);
		ENCHANT_FAILED_ITEM_WILL_RETAIN_SKILL = new SystemMessageId(6004);
		GAME_POINTS_NOT_ENOUGH = new SystemMessageId(6005);
		ITEM_CANNOT_BE_RECEIVED_INVENTORY_QUANTITY_EXCEEDED = new SystemMessageId(6006);
		PRODUCT_PURCHASE_ERROR_USER_NOT_RIGHT = new SystemMessageId(6007);
		PRODUCT_PURCHASE_ERROR_PRODUCT_NOT_RIGHT = new SystemMessageId(6008);
		PRODUCT_PURCHASE_ERROR_ITEM_NOT_RIGHT = new SystemMessageId(6009);
		MASTER_ACCOUNT_RESTRICTED = new SystemMessageId(6010);
		ACQUIRED_S1_EXP_S2_SP_REWARD_MORE_S3_EXP = new SystemMessageId(6011);
		A_BLESSING_INCREASES_EXP_BY_S1_S2 = new SystemMessageId(6012);
		NOT_BLESSING_PERIOD_WHEN_REACH_TARGET_RECEIVE_S1 = new SystemMessageId(6013);
		IT_IS_EVAS_BLESSING_S1_WILL_BE_EFFECTIVE_UNTIL_S2 = new SystemMessageId(6014);
		IT_IS_EVAS_BLESSING_UNTIL_S1_JACK_CAN_GIFT_S2 = new SystemMessageId(6015);
		PROGESS_EVENT_STAGE_S1 = new SystemMessageId(6016);
		EVAS_BLESSING_STAGE_S1_BEGUN = new SystemMessageId(6017);
		EVAS_BLESSING_STAGE_S1_ENDED = new SystemMessageId(6018);
		CANT_BUY_ITEM_TODAY = new SystemMessageId(6019);
		CANT_BUY_ITEM_NOW = new SystemMessageId(6020);
		S1_REACHED_S2_WINS_IN_JACK_GAME = new SystemMessageId(6021);
		S1_RECEIVED_S4_S3_REWARD_FOR_S2_WINS = new SystemMessageId(6022);
		WORLD_RECORD_S1_WINS_S2_PPL = new SystemMessageId(6023);
		MY_RECORD_S1_WINS = new SystemMessageId(6024);
		WORLD_UNDER_4_WINS = new SystemMessageId(6025);
		MY_RECORD_UNDER_4 = new SystemMessageId(6026);
		ITS_HALLOWEEN = new SystemMessageId(6027);
		NO_RECORD_OVER_10_WINS = new SystemMessageId(6028);
		PLEASE_HELP_RAISE_REINDEER_FOR_SANTAS_CHRISTMAS_DELIVERY = new SystemMessageId(6029);
		SANTA_STARTED_DELIVERING_CHRISTMAS_GIFTS = new SystemMessageId(6030);
		SANTA_COMPLETED_DELIVERIES = new SystemMessageId(6031);
		SANTA_OUT_DELIVERING_MERRY_CHRISTMAS = new SystemMessageId(6032);
		ONLY_TOP_S1_APPEAR_IN_RANKING_ONLY_TOP_S2_RECORDED_IN_BEST_RANKING = new SystemMessageId(6033);
		S1_HAS_BEEN_INITIALIZED = new SystemMessageId(6034);
		WHEN_MANY_PLAYERS_HAVE_SAME_SCORE_THEY_APPEAR_IN_ORDER_OF_ACHIEVING = new SystemMessageId(6035);
		BELOW_S1_POINTS = new SystemMessageId(6036);
		LOVERS_JUBILEE_HAS_BEGUN = new SystemMessageId(6037);
		YOU_CAN_USE_EVANGELIST_MARK = new SystemMessageId(6038);
		YOU_COMPLETED_INITIAL_LEVEL_CONGRATS = new SystemMessageId(6039);
		PLEASE_TYPE_ON_OFF_AFTER_COMMAND = new SystemMessageId(6040);
		APRIL_FOOLS_EVENT_PERIOD = new SystemMessageId(6041);
		SKILL_CANCELED_INSUFFICIENT_SOUL_AVATAR = new SystemMessageId(6042);
		ENERGY_CANNOT_BE_REPLENISHED_NO_SOUL_AVATAR = new SystemMessageId(6043);
		ENERGY_S1_REPLENISHED_AT_SOUL_AVATAR = new SystemMessageId(6044);
		C1_ACQUIRED_APRIL_FOOLS_GIFT = new SystemMessageId(6045);
		...
		SCENT_BAKED_BREAD = new SystemMessageId(6506);
		YOU_FEEL_REFRESHED = new SystemMessageId(6507);
