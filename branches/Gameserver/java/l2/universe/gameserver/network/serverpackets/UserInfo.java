...
public final class UserInfo extends L2GameServerPacket
{
	...
	public UserInfo(L2PcInstance character)
	{
		...
		else if (_activeChar.getSiegeState() == 2)
			_relation |= 0x80;
	...
	protected final void writeImpl()
	{
		...
		writeD(_activeChar.getPvpFlag()); // 0-non-pvp  1-pvp = purple name
		...
		writeD(_activeChar.getAppearance().getVisibleNameColor());
		...
		writeD(_activeChar.getAppearance().getVisibleTitleColor());
