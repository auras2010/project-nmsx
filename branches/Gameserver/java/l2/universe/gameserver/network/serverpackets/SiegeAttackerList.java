...
public final class SiegeAttackerList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		else
		{
			...
			writeD(0x01); //1
			writeD(0x00); //0
			List<L2Clan> attackers = CHSiegeManager.getInstance().getSiegableHall(_hall.getId()).getAttackers();
	...
	/* (non-Javadoc)
	 * @see l2.universe.gameserver.serverpackets.ServerBasePacket#getType()
	 */
	@Override
