...
import l2.universe.gameserver.network.serverpackets.FriendAddRequest;
...
public final class RequestFriendInvite extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (friend.isInOlympiadMode())
       	{
           	SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.CANNOT_INVITE_FRIENDS_PARTY_WHILE_IN_OLYMPIAD);
           	sm.addString(_name);
           	activeChar.sendPacket(sm);
           	return;
       	}
