...
public class RequestGiveNickName extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar.isNoble() && _target.matches(activeChar.getName()))
		{
			...
			activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.TITLE_CHANGED));
		...
		else if ((activeChar.getClanPrivileges() & L2Clan.CP_CL_GIVE_TITLE) == L2Clan.CP_CL_GIVE_TITLE)
		{
			...
			{
                activeChar.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.CLAN_LVL_3_NEEDED_TO_ENDOWE_TITLE));
				return;
			}
            ...
            if (member1 != null)
            {
                ...
                if (member != null)
                {
    				...
    				member.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.TITLE_CHANGED));
