	...
	protected void runImpl()
	{
		...
		if (_response == 1)
        {
			...
			if(!requestor.getParty().isInCommandChannel())
			{
				...
				requestor.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.COMMAND_CHANNEL_FORMED));
				newCc = true;
			}
			...
			if (!newCc)
			{
				player.sendPacket(SystemMessage.getSystemMessage(SystemMessageId.JOINED_COMMAND_CHANNEL));
			}
		}
		else
        {
