...
import l2.universe.gameserver.network.serverpackets.ExAttributeEnchantResult;
...
public class RequestExEnchantItemAttribute extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		//can't enchant rods, shadow items, adventurers', Common Items, PvP items, hero items, cloaks, bracelets, underwear (e.g. shirt), belt, necklace,
