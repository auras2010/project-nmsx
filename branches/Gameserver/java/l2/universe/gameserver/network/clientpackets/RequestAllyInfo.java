...
public final class RequestAllyInfo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			sendPacket(SystemMessage.getSystemMessage(SystemMessageId.NO_CURRENT_ALLIANCES));
			return;
		}
		
		sendPacket(SystemMessage.getSystemMessage(SystemMessageId.ALLIANCE_INFO_HEAD));
		SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.ALLIANCE_NAME_S1);
		...
		sendPacket(SystemMessage.getSystemMessage(SystemMessageId.CLAN_INFO_FOOT));
		sm = null;
	}
