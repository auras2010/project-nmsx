...
import l2.universe.gameserver.model.actor.instance.L2BabyPetInstance;
...
import l2.universe.gameserver.model.actor.instance.L2StaticObjectInstance;
...
import l2.universe.gameserver.network.serverpackets.ChairSit;
import l2.universe.gameserver.network.serverpackets.ExAskCoupleAction;
import l2.universe.gameserver.network.serverpackets.ExBasicActionList;
import l2.universe.gameserver.network.serverpackets.RecipeShopManageList;
	...
	protected void runImpl()
	{
		...
		switch (_actionId)
		{
			...
			case 22: // Attack (pet attack)
				if (target instanceof L2Character && pet != null && pet != target && activeChar != target && !pet.isBetrayed())
				{
					...
					if (!activeChar.allowPeaceAttack() && activeChar.isInsidePeaceZone(pet, target) && (!activeChar.isInFunEvent() || !target.isInFunEvent())) //add by CTF
					{
