...
{
	private long _lastGuardsCall = 0;
	...
	{
		// Synerge - For not flooding with clan calls, do it once per second
		final long actualTime = System.currentTimeMillis();
		if (actualTime > _lastGuardsCall)
		{
			_lastGuardsCall = actualTime + 1000;
