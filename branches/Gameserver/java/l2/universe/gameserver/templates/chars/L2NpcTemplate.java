 ...
 */
package l2.universe.gameserver.templates.chars;
...
import l2.universe.gameserver.model.L2NpcChatData;
...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	public void addQuestEvent(Quest.QuestEventType EventType, Quest q)
	{
		...
		else
		{
			...
			{
				// if it is the same quest (i.e. reload) or the existing is a superclass of the new
				// one, replace the existing.
