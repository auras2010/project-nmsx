...
public class Kamaloka23 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka23(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka23";
		param.Template = "Kamaloka_23.xml";
		param.Level = 23;
		param.Npc = 30332;
		param.Mob = 18554;
		param.Minion = 0;
		param.enterCoord = newCoord(-88994,-220816,-7898);
		param.ClientId = 57;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka23(-1, "Kamaloka23", "Kamaloka23");
	}
