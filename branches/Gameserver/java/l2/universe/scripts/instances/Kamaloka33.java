...
public class Kamaloka33 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka33(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka33";
		param.Template = "Kamaloka_33.xml";
		param.Level = 33;
		param.Npc = 30071;
		param.Mob = 18558;
		param.Minion = 0;
		param.enterCoord = newCoord(-89189,-214187,-8103);
		param.ClientId = 57;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka33(-1, "Kamaloka33", "Kamaloka33");
	}
