...
public class Kamaloka69 extends Kamaloka
{
	private KamaParam param = new KamaParam();

	public Kamaloka69(int questId, String name, String descr)
	{
		super(questId, name, descr);
		param.qn = "Kamaloka69";
		param.Template = "Kamaloka_69.xml";
		param.Level = 69;
		param.PartySize = 9;
		param.Npc = 31981;
		param.Mob = 29141;
		param.Minion = 0;
		param.enterCoord = newCoord(-10973,-174906,-10944);
		param.ClientId = 73;
	...
	public static void main(String[] args)
	{
		...
		new Kamaloka69(-1, "Kamaloka69", "Kamaloka69");
	}
