...
package l2.universe.scripts.events;
...
public class BloodShedParty extends Quest
{
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		if (party.getMemberCount() < ExternalConfig.PARTY_MEMBER_COUNT)
		{
			player.sendPacket(new ExShowScreenMessage("Your party must have at least" + ExternalConfig.PARTY_MEMBER_COUNT + " players", 3000));
			return false;
		}
	...
	public String onKill( L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		final BSPWorld world = (BSPWorld) tmpworld;
			...
			if (npc.getNpcId() == MOBS && GetKilledMobs(MOBS) == 6)
			{
