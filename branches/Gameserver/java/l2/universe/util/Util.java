...
import l2.universe.util.lib.Validator;
...
public class Util
{
	...
	/**
	 * Parsing TimeInMilis (long) into user short 
	 * time format.
	 * EXAMPLE:
	 *   getShortTime(System.currentTimeMillis(), "dd-MM-yyyy HH:mm:ss")
	 * 
	 * @param timeInMillis - time in miliseconds
	 * @param dateFormat - date format that Should be Showed
	 * @return Date/Time in user wanted format
	 */
	public static String getShortTime(long timeInMillis, String dateFormat)
	{
		SimpleDateFormat sdf = new SimpleDateFormat(dateFormat);
		return sdf.format(new Date(timeInMillis));
	}

	public static void Validate(String subject, String body)
	{
		Validator Validator = new Validator();
		Validator.Validate(subject, body);
	}
}
