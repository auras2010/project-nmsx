...
import l2.universe.gameserver.util.FloodProtectorConfig;
...
public final class Config
{
	...
	//--------------------------------------------------
	// L2 Universe Property File Definitions
	//--------------------------------------------------
	...
	public static final String HEXID_FILE = "./config/settings/hexid.txt";
	public static final String ID_CONFIG_FILE = "./config/settings/idfactory.properties";
	public static final String SERVER_VERSION_FILE = "./config/L2universe-version.properties";
	public static final String MOD_CONFIG_FILE = "./config/mods.properties";
	public static final String LOGIN_CONFIGURATION_FILE = "./config/loginserver.properties";
	public static final String NPC_CONFIG_FILE = "./config/NPC.properties";
	public static final String PVP_CONFIG_FILE = "./config/pvp.properties";
	public static final String RATES_CONFIG_FILE = "./config/settings/rates.properties";
	public static final String CONFIGURATION_FILE = "./config/settings/server.properties";
	public static final String IP_CONFIG_FILE = "./config/settings/ipconfig.xml";
	public static final String SIEGE_CONFIGURATION_FILE = "./config/siege.properties";
	public static final String TW_CONFIGURATION_FILE = "./config/territorywar.properties";
	public static final String TELNET_FILE = "./config/telnet.properties";
	public static final String FLOOD_PROTECTOR_FILE = "./config/settings/floodprotector.properties";
	...
	public static final String COMMUNITY_CONFIGURATION_FILE = "./config/settings/CommunityServer.properties";
	...
	//--------------------------------------------------
	// l2.universe Variable Definitions
	//--------------------------------------------------
	...
	public static boolean SHOW_TO_PARTY_MEMBERS_SPOIL_SUCCESS;
	...
	public static int LOS_CAST_CHECK_INTERVAL;
	public static boolean DISABLE_TUTORIAL;
	public static boolean EXPERTISE_PENALTY;
	public static boolean STORE_RECIPE_SHOPLIST;
	public static boolean STORE_UI_SETTINGS;
	public static String[] FORBIDDEN_NAMES;
	public static boolean NO_STATS_LIMITS_FOR_GMS;	
	...
	public static boolean ALT_OLY_NO_DUALBOX;
	public static TIntArrayList LIST_OLY_RESTRICTED_ITEMS;
	public static int ALT_OLY_ENCHANT_LIMIT;
	public static int ALT_OLY_WAIT_TIME;
	public static String[] ALT_OLY_FEED_PROTECTION;
	...
	public static TIntArrayList DISCARD_ITEM_EXCEPTIONS;
	public static int SERVER_START_INGAME_HOUR;
	...
	// MODs Settings
	//--------------------------------------------------
	public static boolean MOD_CHAMPION_ENABLE;
	public static boolean MOD_CHAMPION_PASSIVE;
	public static boolean MOD_CHAMPION_MINIONS;
	public static int MOD_CHAMPION_FREQUENCY;
	public static String MOD_CHAMP_TITLE;
	public static int MOD_CHAMP_MIN_LVL;
	public static int MOD_CHAMP_MAX_LVL;
	public static int MOD_CHAMPION_HP;
	public static int MOD_CHAMPION_MP;
	public static int MOD_CHAMPION_REWARDS_XP;
	public static int MOD_CHAMPION_REWARDS_SP;
	public static int MOD_CHAMPION_REWARDS;
	public static float MOD_CHAMPION_ADENAS_REWARDS;
	public static float MOD_CHAMPION_HP_REGEN;
	public static float MOD_CHAMPION_ATK;
	public static float MOD_CHAMPION_SPD_ATK;
	public static int MOD_CHAMPION_REWARD_LOWER_LVL_ITEM_CHANCE;
	public static int MOD_CHAMPION_REWARD_HIGHER_LVL_ITEM_CHANCE;
	public static int MOD_CHAMPION_REWARD_ID;
	public static int MOD_CHAMPION_REWARD_QTY;
	//Champion drop
	public static float MOD_CHAMPION_SEAL_STONES_REWARDS;
	public static int MOD_CHAMPION_SPOIL_RATE;
	public static int MOD_CHAMPION_SPOIL_AMOUNT;
	public static int MOD_CHAMPION_REWARDS_RATE;
	public static int MOD_CHAMPION_REWARDS_AMOUNT;
	
	public static boolean MOD_CHAMPION_ENABLE_VITALITY;
	public static boolean MOD_CHAMPION_ENABLE_IN_INSTANCES;
	public static boolean MOD_CHAMP_AURA;
	...
	public static boolean MOD_ENABLE_WAREHOUSESORTING_CLAN;
	public static boolean MOD_ENABLE_WAREHOUSESORTING_PRIVATE;
	...
	public static boolean MOD_ENABLE_MANA_POTIONS_SUPPORT;
	public static boolean MOD_DISPLAY_SERVER_TIME;
	public static boolean WELCOME_MESSAGE_ENABLED;
	public static String WELCOME_MESSAGE_TEXT;
	public static int WELCOME_MESSAGE_TIME;
	public static boolean MOD_ANTIFEED_ENABLE;
	public static boolean MOD_ANTIFEED_DUALBOX;
	public static boolean MOD_ANTIFEED_DISCONNECTED_AS_DUALBOX;
	public static int MOD_ANTIFEED_INTERVAL;
	public static boolean ANNOUNCE_PK_PVP;
	public static boolean ANNOUNCE_PK_PVP_NORMAL_MESSAGE;
	public static String ANNOUNCE_PK_MSG;
	public static String ANNOUNCE_PVP_MSG;
	public static boolean MOD_CHAT_ADMIN;
	public static boolean MOD_MULTILANG_ENABLE;
	public static List<String> MOD_MULTILANG_ALLOWED = new ArrayList<String>();
	public static String MOD_MULTILANG_DEFAULT;
	public static boolean MOD_MULTILANG_VOICED_ALLOW;
	...
	public static boolean MOD_DEBUG_VOICE_COMMAND;
	public static int MOD_DUALBOX_CHECK_MAX_PLAYERS_PER_IP;
	public static int MOD_DUALBOX_CHECK_MAX_OLYMPIAD_PARTICIPANTS_PER_IP;
	public static TIntIntHashMap MOD_DUALBOX_CHECK_WHITELIST;
	public static boolean MOD_FISHERMAN_ENABLED;
	public static int MOD_FISHERMAN_INTERVAL;
	public static int MOD_FISHERMAN_REWARD_ID;
	public static int MOD_FISHERMAN_REWARD_COUNT;
	...
	public static double MOB_PATTACK_MULTIPLIER;
	public static double MOB_MATTACK_MULTIPLIER;
	
	public static int INTELLIGENT_FARMING_MOBS;		
	...
	public static float RATE_SHOP_ITEMS_COST;
	public static float RATE_SHOP_EQUIPABLE_COST;
	public static float RATE_SHOP_CONSUMABLE_COST;
	public static float RATE_CRAFT_CONSUMABLE_COST;
	public static float RATE_MULTISELL_ITEMS_COST;
	public static float RATE_EXTR_FISH;
	public static float RATE_DROP_ITEMS;
	public static float RATE_DROP_ITEMS_BY_RAID;
	public static float RATE_DROP_SPOIL;
	public static int RATE_DROP_MANOR;
	public static int RATE_LIMIT_MANOR;
	...
	public static float RATE_QUEST_REWARD_ARMOR;
	public static float RATE_QUEST_REWARD_WEAPON;
	public static float RATE_QUEST_REWARD_QI_BASED;
	public static float RATE_QUEST_REWARD_XP_QI_BASED;
	public static float RATE_QUEST_REWARD_SP_QI_BASED;
	public static float RATE_QUEST_REWARD_ADENA_QI_BASED;
	public static float RATE_QUEST_REWARD_POTION_QI_BASED;
	public static float RATE_QUEST_REWARD_SCROLL_QI_BASED;
	public static float RATE_QUEST_REWARD_RECIPE_QI_BASED;
	public static float RATE_QUEST_REWARD_MATERIAL_QI_BASED;
	public static float RATE_QUEST_REWARD_ACCESSORY_QI_BASED;
	public static float RATE_QUEST_REWARD_ARMOR_QI_BASED;
	public static float RATE_QUEST_REWARD_WEAPON_QI_BASED;
	...
	public static float PET_MOUNTABLE_XP_RATE;
	...
	public static int SOUL_CRY_LEVEL_CHANCE;
	public static boolean L2JMOD_HELLBOUND_STATUS;
	public static float RATE_TRUST;	
	...
	public static int ENCHANT_CHANCE_WEAPON_WARRIOR;
	public static int ENCHANT_CHANCE_WEAPON_MAGE;
	...
	public static int BLESSED_ENCHANT_CHANCE_WEAPON_WARRIOR;
	public static int BLESSED_ENCHANT_CHANCE_WEAPON_MAGE;
	...
	public static int QUEEN_ZONE_INTERVAL;
	...
	public static int Max_Level_Attack_AQ;
	public static boolean QUEEN_ZONE_CHECKER;
	...
	public static boolean CHAMBION_BODY_EFFECT;
		...
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				try
				{
					...
					DATABASE_URL = serverSettings.getProperty("URL", "jdbc:mysql://localhost/L2Universedb");
					...
					DATABASE_CLEAN_UP = Boolean.parseBoolean(serverSettings.getProperty("DatabaseCleanUp", "True"));
				...
				try
				{
					...
					ENTER_HELLBOUND_WITHOUT_QUEST = Boolean.parseBoolean(Character.getProperty("EnterHellBoundWithoutQuest", "false"));
					...
					SHOW_TO_PARTY_MEMBERS_SPOIL_SUCCESS = Boolean.parseBoolean(Character.getProperty("ShowToPartyMembersSpoilSuccess", "false"));
					...
					ENCHANT_CHANCE_WEAPON_WARRIOR = Integer.parseInt(Character.getProperty("EnchantChanceWeaponWarrior", "70"));
					ENCHANT_CHANCE_WEAPON_MAGE = Integer.parseInt(Character.getProperty("EnchantChanceWeaponMage", "40"));
					...
					BLESSED_ENCHANT_CHANCE_WEAPON_WARRIOR = Integer.parseInt(Character.getProperty("BlessedEnchantChanceWeaponWarrior", "70"));
					BLESSED_ENCHANT_CHANCE_WEAPON_MAGE = Integer.parseInt(Character.getProperty("BlessedEnchantChanceWeaponMage", "40"));
					...
					NO_STATS_LIMITS_FOR_GMS = Boolean.parseBoolean(Character.getProperty("NoStatsLimitsForGMs", "True"));
				}
				catch (Exception e)
				{
					e.printStackTrace();
				...
				// Load L2 Universe Server Version L2Properties file (if exists)
				try
				{
				...
				try
				{
					...
					COMMUNITY_COLOR_LEGEND = Boolean.parseBoolean(General.getProperty("ShowCommunityColorLegend", "false"));
					...
					CUSTOM_MINIONS_TABLE = Boolean.valueOf(General.getProperty("CustomMinionsTable", "false"));
					...
					LOS_CAST_CHECK_INTERVAL = Integer.parseInt(General.getProperty("LoSCastCheckInterval", "333"));
					String[] itemSplit = General.getProperty("DiscardItemExceptions", "57").split(",");
					DISCARD_ITEM_EXCEPTIONS = new TIntArrayList(split.length);
					for (String id : itemSplit)
					{
						DISCARD_ITEM_EXCEPTIONS.add(Integer.parseInt(id));
					}
					SERVER_START_INGAME_HOUR = Integer.parseInt(General.getProperty("ServerStartInGameHour", "6"));
				}
				catch (Exception e)
				{
					e.printStackTrace();
				...
				try
				{
					...
					MOB_PATTACK_MULTIPLIER = Double.parseDouble(NPC.getProperty("MobPAttackMultiplier", "100")) / 100;
					MOB_MATTACK_MULTIPLIER = Double.parseDouble(NPC.getProperty("MobMAttackMultiplier", "100")) / 100;
					
					INTELLIGENT_FARMING_MOBS = Integer.parseInt(NPC.getProperty("IntelligentFarmingMobs", "0"));
				}
				catch (Exception e)
				{
					e.printStackTrace();
				...
				try
				{
					...
					RATE_SHOP_CONSUMABLE_COST = Float.parseFloat(ratesSettings.getProperty("RateShopConsumableCost", "1."));
					RATE_SHOP_EQUIPABLE_COST = Float.parseFloat(ratesSettings.getProperty("RateShopEquipableCost", "1."));
					RATE_SHOP_ITEMS_COST = Float.parseFloat(ratesSettings.getProperty("RateShopItemsCost", "1."));		
					RATE_CRAFT_CONSUMABLE_COST = Float.parseFloat(ratesSettings.getProperty("RateCraftConsumableCost", "1."));
					RATE_MULTISELL_ITEMS_COST = Float.parseFloat(ratesSettings.getProperty("RateMultisellItemsCost", "1."));							
					...
					RATE_LIMIT_MANOR = Integer.parseInt(ratesSettings.getProperty("RateLimitManor", "1"));					
					...
					RATE_QUEST_REWARD_ARMOR = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardArmor", "1."));
					RATE_QUEST_REWARD_WEAPON = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardWeapon", "1."));
					RATE_QUEST_REWARD_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardQiBased", "1."));
					RATE_QUEST_REWARD_XP_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardXPQiBased", "1."));
					RATE_QUEST_REWARD_SP_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardSPQiBased", "1."));
					RATE_QUEST_REWARD_ADENA_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardAdenaQiBased", "1."));
					RATE_QUEST_REWARD_POTION_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardPotionQiBased", "1."));
					RATE_QUEST_REWARD_SCROLL_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardScrollQiBased", "1."));
					RATE_QUEST_REWARD_RECIPE_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardRecipeQiBased", "1."));
					RATE_QUEST_REWARD_MATERIAL_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardMaterialQiBased", "1."));
					RATE_QUEST_REWARD_ACCESSORY_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardAccessoryQiBased", "1."));
					RATE_QUEST_REWARD_ARMOR_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardArmorQiBased", "1."));
					RATE_QUEST_REWARD_WEAPON_QI_BASED = Float.parseFloat(ratesSettings.getProperty("RateQuestRewardWeaponQiBased", "1."));
					RATE_TRUST = Float.parseFloat(ratesSettings.getProperty("RateTrust", "1."));
					...
					PET_MOUNTABLE_XP_RATE = Float.parseFloat(ratesSettings.getProperty("PetMountableXpRate", "1."));
				...
				// Load MOD L2Properties file (if exists)
				try
				{
					L2Properties MODSettings = new L2Properties();
					is = new FileInputStream(new File(MOD_CONFIG_FILE));
					MODSettings.load(is);
					
					MOD_CHAMPION_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("ChampionEnable", "false"));
					MOD_CHAMPION_PASSIVE = Boolean.parseBoolean(MODSettings.getProperty("ChampionPassive", "false"));
					MOD_CHAMPION_MINIONS = Boolean.parseBoolean(MODSettings.getProperty("ChampionMinions", "false"));
					MOD_CHAMPION_FREQUENCY = Integer.parseInt(MODSettings.getProperty("ChampionFrequency", "0"));
					MOD_CHAMP_TITLE = MODSettings.getProperty("ChampionTitle", "Champion");
					MOD_CHAMP_MIN_LVL = Integer.parseInt(MODSettings.getProperty("ChampionMinLevel", "20"));
					MOD_CHAMP_MAX_LVL = Integer.parseInt(MODSettings.getProperty("ChampionMaxLevel", "60"));
					MOD_CHAMPION_HP = Integer.parseInt(MODSettings.getProperty("ChampionHp", "7"));
					MOD_CHAMPION_HP_REGEN = Float.parseFloat(MODSettings.getProperty("ChampionHpRegen", "1."));
					MOD_CHAMPION_MP = Integer.parseInt(MODSettings.getProperty("ChampionMp", "7"));
					MOD_CHAMPION_REWARDS = Integer.parseInt(MODSettings.getProperty("ChampionRewards", "8"));
					MOD_CHAMPION_ADENAS_REWARDS = Float.parseFloat(MODSettings.getProperty("ChampionAdenasRewards", "1"));
					MOD_CHAMPION_ATK = Float.parseFloat(MODSettings.getProperty("ChampionAtk", "1."));
					MOD_CHAMPION_SPD_ATK = Float.parseFloat(MODSettings.getProperty("ChampionSpdAtk", "1."));
					MOD_CHAMPION_REWARDS_XP = Integer.parseInt(MODSettings.getProperty("ChampionRewardsXP", "1"));
					MOD_CHAMPION_REWARDS_SP = Integer.parseInt(MODSettings.getProperty("ChampionRewardsSP", "1"));
					MOD_CHAMPION_REWARD_LOWER_LVL_ITEM_CHANCE = Integer.parseInt(MODSettings.getProperty("ChampionRewardLowerLvlItemChance", "0"));
					MOD_CHAMPION_REWARD_HIGHER_LVL_ITEM_CHANCE = Integer.parseInt(MODSettings.getProperty("ChampionRewardHigherLvlItemChance", "0"));
					MOD_CHAMPION_REWARD_ID = Integer.parseInt(MODSettings.getProperty("ChampionRewardItemID", "6393"));
					MOD_CHAMPION_REWARD_QTY = Integer.parseInt(MODSettings.getProperty("ChampionRewardItemQty", "1"));
					MOD_CHAMPION_ENABLE_VITALITY = Boolean.parseBoolean(MODSettings.getProperty("ChampionEnableVitality", "False"));
					MOD_CHAMPION_ENABLE_IN_INSTANCES = Boolean.parseBoolean(MODSettings.getProperty("ChampionEnableInInstances", "False"));
					MOD_CHAMP_AURA = Boolean.parseBoolean(MODSettings.getProperty("ChampAura", "False"));
					CHAMBION_BODY_EFFECT  = Boolean.parseBoolean(MODSettings.getProperty("ChampionBodyEffect", "False"));
					//Champion drop
					MOD_CHAMPION_SEAL_STONES_REWARDS = Float.parseFloat(MODSettings.getProperty("ChampionSealStonesRewards", "1"));
					MOD_CHAMPION_SPOIL_RATE = Integer.parseInt(MODSettings.getProperty("ChampionSpoilRate", "8"));
					MOD_CHAMPION_SPOIL_AMOUNT = Integer.parseInt(MODSettings.getProperty("ChampionSpoilAmount", "8"));
					MOD_CHAMPION_REWARDS_RATE = Integer.parseInt(MODSettings.getProperty("ChampionRewardsRate", "8"));
					MOD_CHAMPION_REWARDS_AMOUNT = Integer.parseInt(MODSettings.getProperty("ChampionRewardsAmount", "8"));

					MOD_FISHERMAN_ENABLED = Boolean.parseBoolean(MODSettings.getProperty("FishermanEnabled", "false"));
					MOD_FISHERMAN_INTERVAL = Integer.parseInt(MODSettings.getProperty("FishermanInterval", "120"));
					MOD_FISHERMAN_REWARD_ID = Integer.parseInt(MODSettings.getProperty("FishermanRewardId", "57"));
					MOD_FISHERMAN_REWARD_COUNT = Integer.parseInt(MODSettings.getProperty("FishermanRewardCount", "100"));

					MOD_ALLOW_WEDDING = Boolean.parseBoolean(MODSettings.getProperty("AllowWedding", "False"));
					MOD_WEDDING_PRICE = Integer.parseInt(MODSettings.getProperty("WeddingPrice", "250000000"));
					MOD_WEDDING_PUNISH_INFIDELITY = Boolean.parseBoolean(MODSettings.getProperty("WeddingPunishInfidelity", "True"));
					MOD_WEDDING_TELEPORT = Boolean.parseBoolean(MODSettings.getProperty("WeddingTeleport", "True"));
					MOD_WEDDING_TELEPORT_PRICE = Integer.parseInt(MODSettings.getProperty("WeddingTeleportPrice", "50000"));
					MOD_WEDDING_TELEPORT_DURATION = Integer.parseInt(MODSettings.getProperty("WeddingTeleportDuration", "60"));
					MOD_WEDDING_SAMESEX = Boolean.parseBoolean(MODSettings.getProperty("WeddingAllowSameSex", "False"));
					MOD_WEDDING_FORMALWEAR = Boolean.parseBoolean(MODSettings.getProperty("WeddingFormalWear", "True"));
					MOD_WEDDING_DIVORCE_COSTS = Integer.parseInt(MODSettings.getProperty("WeddingDivorceCosts", "20"));
					
					MOD_ENABLE_WAREHOUSESORTING_CLAN = Boolean.valueOf(MODSettings.getProperty("EnableWarehouseSortingClan", "False"));
					MOD_ENABLE_WAREHOUSESORTING_PRIVATE = Boolean.valueOf(MODSettings.getProperty("EnableWarehouseSortingPrivate", "False"));
					
					BANKING_SYSTEM_ENABLED = Boolean.parseBoolean(MODSettings.getProperty("BankingEnabled", "false"));
					BANKING_SYSTEM_GOLDBARS = Integer.parseInt(MODSettings.getProperty("BankingGoldbarCount", "1"));
					BANKING_SYSTEM_ADENA = Integer.parseInt(MODSettings.getProperty("BankingAdenaCount", "500000000"));
					
					OFFLINE_TRADE_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("OfflineTradeEnable", "false"));
					OFFLINE_CRAFT_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("OfflineCraftEnable", "false"));
					OFFLINE_SET_NAME_COLOR = Boolean.parseBoolean(MODSettings.getProperty("OfflineSetNameColor", "false"));
					OFFLINE_NAME_COLOR = Integer.decode("0x" + MODSettings.getProperty("OfflineNameColor", "808080"));
					OFFLINE_FAME = Boolean.parseBoolean(MODSettings.getProperty("OfflineFame", "true"));
					RESTORE_OFFLINERS = Boolean.parseBoolean(MODSettings.getProperty("RestoreOffliners", "false"));
					OFFLINE_MAX_DAYS = Integer.parseInt(MODSettings.getProperty("OfflineMaxDays", "10"));
					OFFLINE_DISCONNECT_FINISHED = Boolean.parseBoolean(MODSettings.getProperty("OfflineDisconnectFinished", "true"));
					
					MOD_ENABLE_MANA_POTIONS_SUPPORT = Boolean.parseBoolean(MODSettings.getProperty("EnableManaPotionSupport", "false"));
					
					MOD_DISPLAY_SERVER_TIME = Boolean.parseBoolean(MODSettings.getProperty("DisplayServerTime", "false"));
					
					WELCOME_MESSAGE_ENABLED = Boolean.parseBoolean(MODSettings.getProperty("ScreenWelcomeMessageEnable", "false"));
					WELCOME_MESSAGE_TEXT = MODSettings.getProperty("ScreenWelcomeMessageText", "Welcome to L2 Universe server!");
					WELCOME_MESSAGE_TIME = Integer.parseInt(MODSettings.getProperty("ScreenWelcomeMessageTime", "10")) * 1000;
					
					MOD_ANTIFEED_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("AntiFeedEnable", "false"));
					MOD_ANTIFEED_DUALBOX = Boolean.parseBoolean(MODSettings.getProperty("AntiFeedDualbox", "true"));
					MOD_ANTIFEED_DISCONNECTED_AS_DUALBOX = Boolean.parseBoolean(MODSettings.getProperty("AntiFeedDisconnectedAsDualbox", "true"));
					MOD_ANTIFEED_INTERVAL = 1000 * Integer.parseInt(MODSettings.getProperty("AntiFeedInterval", "120"));
					ANNOUNCE_PK_PVP = Boolean.parseBoolean(MODSettings.getProperty("AnnouncePkPvP", "False"));
					ANNOUNCE_PK_PVP_NORMAL_MESSAGE = Boolean.parseBoolean(MODSettings.getProperty("AnnouncePkPvPNormalMessage", "True"));
					ANNOUNCE_PK_MSG = MODSettings.getProperty("AnnouncePkMsg", "$killer has slaughtered $target");
					ANNOUNCE_PVP_MSG = MODSettings.getProperty("AnnouncePvpMsg", "$killer has defeated $target");
					
					MOD_CHAT_ADMIN = Boolean.parseBoolean(MODSettings.getProperty("ChatAdmin", "false"));
					
					MOD_MULTILANG_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("MultiLangEnable", "false"));
					String[] allowed = MODSettings.getProperty("MultiLangAllowed", "en").split(";");
					MOD_MULTILANG_ALLOWED = new ArrayList<String>(allowed.length);
					for (String lang : allowed)
						MOD_MULTILANG_ALLOWED.add(lang);
					MOD_MULTILANG_DEFAULT = MODSettings.getProperty("MultiLangDefault", "en");
					if (!MOD_MULTILANG_ALLOWED.contains(MOD_MULTILANG_DEFAULT))
						_log.warning("MultiLang[Config.load()]: default language: " + MOD_MULTILANG_DEFAULT + " is not in allowed list !");
					MOD_MULTILANG_VOICED_ALLOW = Boolean.parseBoolean(MODSettings.getProperty("MultiLangVoiceCommand", "True"));
					
					L2JMOD_MULTILANG_SM_ENABLE = Boolean.parseBoolean(MODSettings.getProperty("MultiLangSystemMessageEnable", "false"));
					allowed = MODSettings.getProperty("MultiLangSystemMessageAllowed", "").split(";");
					...
					L2WALKER_PROTECTION = Boolean.parseBoolean(MODSettings.getProperty("L2WalkerProtection", "False"));
				}
				catch (Exception e)
				{
					e.printStackTrace();
					throw new Error("Failed to Load " + MOD_CONFIG_FILE + " File.");
				}
				...
				try
				{
					...
					ALT_OLY_NO_DUALBOX = Boolean.parseBoolean(olympiad.getProperty("AltOlyNoDualbox", "false"));
					...
					ALT_OLY_FEED_PROTECTION = olympiad.getProperty("AltOlyFeedProtection", "").split(",");
				}
				catch (Exception e)
				{
					e.printStackTrace();
				...
				try
				{
		            ...
		            Interval_Of_Beleth_Spawn = Integer.parseInt(grandbossSettings.getProperty("IntervalOfBelethSpawn", "121"));
					if (Interval_Of_Beleth_Spawn < 1 || Interval_Of_Beleth_Spawn > 480)
						Interval_Of_Beleth_Spawn = 121;
					Interval_Of_Beleth_Spawn = Interval_Of_Beleth_Spawn * 3600000;
					Random_Of_Beleth_Spawn = Integer.parseInt(grandbossSettings.getProperty("RandomOfBelethSpawn", "8"));
					if (Random_Of_Beleth_Spawn < 1 || Random_Of_Beleth_Spawn > 192)
						Random_Of_Beleth_Spawn = 8;
					Random_Of_Beleth_Spawn = Random_Of_Beleth_Spawn * 3600000;
					...
					Max_Level_Attack_AQ = Integer.parseInt(grandbossSettings.getProperty("MaxLevelAttackAntQueen", "50"));
					QUEEN_ZONE_CHECKER = Boolean.parseBoolean(grandbossSettings.getProperty("QueenZoneChecker", "false"));
					QUEEN_ZONE_INTERVAL = Integer.parseInt(grandbossSettings.getProperty("QueenZoneCheckerInterval", "2"));
					if (QUEEN_ZONE_INTERVAL < 1 || QUEEN_ZONE_INTERVAL > 480)
						QUEEN_ZONE_INTERVAL = 2;
					QUEEN_ZONE_INTERVAL = QUEEN_ZONE_INTERVAL * 1000;
	...
	public static boolean setParameterValue(String pName, String pValue)
	{
		...
		else if (pName.equalsIgnoreCase("RateShopConsumableCost")) RATE_SHOP_CONSUMABLE_COST = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("RateShopItemsCost")) RATE_SHOP_ITEMS_COST = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("RateShopEquipableCost")) RATE_SHOP_EQUIPABLE_COST = Float.parseFloat(pValue);	
		else if (pName.equalsIgnoreCase("RateCraftConsumableCost")) RATE_CRAFT_CONSUMABLE_COST = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("RateMultisellItemsCost")) RATE_MULTISELL_ITEMS_COST = Float.parseFloat(pValue);
		...
		else if (pName.equalsIgnoreCase("RateTrust")) RATE_TRUST = Float.parseFloat(pValue);
		...
		//champions drop 
		else if (pName.equalsIgnoreCase("ChampionSealStonesRewards")) MOD_CHAMPION_SEAL_STONES_REWARDS = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionAdenasRewards")) MOD_CHAMPION_ADENAS_REWARDS = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionSpoilAmount")) MOD_CHAMPION_SPOIL_AMOUNT = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardsAmount")) MOD_CHAMPION_REWARDS_AMOUNT = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardsRate")) MOD_CHAMPION_REWARDS_RATE = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionSpoilRate")) MOD_CHAMPION_SPOIL_RATE = Integer.parseInt(pValue);
		...
		else if (pName.equalsIgnoreCase("NoStatsLimitsForGMs"))
			NO_STATS_LIMITS_FOR_GMS = Boolean.parseBoolean(pValue);		
		...
		else if (pName.equalsIgnoreCase("EnchantChanceWeaponWarrior")) ENCHANT_CHANCE_WEAPON_WARRIOR = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("EnchantChanceWeaponMage")) ENCHANT_CHANCE_WEAPON_MAGE = Integer.parseInt(pValue);
		...
		else if (pName.equalsIgnoreCase("MobPAttackMultiplier")) MOB_PATTACK_MULTIPLIER = Double.parseDouble(pValue) / 100;
		else if (pName.equalsIgnoreCase("MobMAttackMultiplier")) MOB_MATTACK_MULTIPLIER = Double.parseDouble(pValue) / 100;	
		else if (pName.equalsIgnoreCase("IntelligentFarmingMobs")) INTELLIGENT_FARMING_MOBS =Integer.parseInt(pValue);
		...
		else if (pName.equalsIgnoreCase("ChampionEnable")) MOD_CHAMPION_ENABLE =	Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("ChampionFrequency")) MOD_CHAMPION_FREQUENCY = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionMinLevel")) MOD_CHAMP_MIN_LVL = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionMaxLevel")) MOD_CHAMP_MAX_LVL = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionHp")) MOD_CHAMPION_HP = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionHpRegen")) MOD_CHAMPION_HP_REGEN = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewards")) MOD_CHAMPION_REWARDS = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionAdenasRewards")) MOD_CHAMPION_ADENAS_REWARDS = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionAtk")) MOD_CHAMPION_ATK = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionSpdAtk")) MOD_CHAMPION_SPD_ATK = Float.parseFloat(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardLowerLvlItemChance")) MOD_CHAMPION_REWARD_LOWER_LVL_ITEM_CHANCE = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardHigherLvlItemChance")) MOD_CHAMPION_REWARD_HIGHER_LVL_ITEM_CHANCE = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardItemID")) MOD_CHAMPION_REWARD_ID = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionRewardItemQty")) MOD_CHAMPION_REWARD_QTY = Integer.parseInt(pValue);
		else if (pName.equalsIgnoreCase("ChampionEnableInInstances")) MOD_CHAMPION_ENABLE_IN_INSTANCES = Boolean.parseBoolean(pValue);
		
		else if (pName.equalsIgnoreCase("AllowWedding")) MOD_ALLOW_WEDDING = Boolean.parseBoolean(pValue);
		...
		else if (pName.equalsIgnoreCase("EnableWarehouseSortingClan")) MOD_ENABLE_WAREHOUSESORTING_CLAN = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("EnableWarehouseSortingPrivate")) MOD_ENABLE_WAREHOUSESORTING_PRIVATE = Boolean.parseBoolean(pValue);

		else if (pName.equalsIgnoreCase("EnableManaPotionSupport")) MOD_ENABLE_MANA_POTIONS_SUPPORT = Boolean.parseBoolean(pValue);

		else if (pName.equalsIgnoreCase("DisplayServerTime")) MOD_DISPLAY_SERVER_TIME = Boolean.parseBoolean(pValue);

		else if (pName.equalsIgnoreCase("AntiFeedEnable")) MOD_ANTIFEED_ENABLE = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("AntiFeedDualbox")) MOD_ANTIFEED_DUALBOX = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("AntiFeedDisconnectedAsDualbox")) MOD_ANTIFEED_DISCONNECTED_AS_DUALBOX = Boolean.parseBoolean(pValue);
		else if (pName.equalsIgnoreCase("AntiFeedInterval")) MOD_ANTIFEED_INTERVAL = 1000*Integer.parseInt(pValue);
	...
	private static void loadFloodProtectorConfigs(final L2Properties properties)
	{
		...
		loadFloodProtectorConfig(properties, FLOOD_PROTECTOR_GLOBAL_CHAT, "GlobalChat", "10");
