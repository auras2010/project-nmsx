...
//import l2.universe.gameserver.model.entity.InstanceWorld;
...
//{
//	private static Logger _log = Logger.getLogger(RimKamaloka.class.getName());
//
...
//			
//			InstanceManager.getInstance().setInstanceTime(player.getObjectId(), world.templateId, reenter.getTimeInMillis());
//			player.sendPacket(sm);
//
...
//	{
//		private Logger _log = Logger.getLogger(LockTask.class.getName());
//
...
//						player.sendPacket(sm);
//						_log.info("[Solo kamaloka] Engine: Set time to enter into Solo Kamaloka for object: "+ objectId);
//					}
//				}
//				if (!found)
//				{
