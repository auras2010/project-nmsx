...
public class Valakas extends L2AttackableAIScript
{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		...
		final long respawnTime = (long) Config.Interval_Of_Valakas_Spawn + Rnd.get(Config.Random_Of_Valakas_Spawn);
	...
	public void broadcastSpawn(L2Npc npc)
	{
		...
		for (final L2Object obj : objs)
		{
			if (obj instanceof L2PcInstance)
			{
				...
				{
					obj.sendPacket(new PlaySound(1, "B03_A", 1, npc.getObjectId(), 212852, -114842, -1632));
					obj.sendPacket(new SocialAction(npc.getObjectId(), 3));
				}
			}
		}
		return;
