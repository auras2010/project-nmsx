...
import l2.universe.gameserver.network.serverpackets.ExCubeGameChangeTimeToStart;
import l2.universe.gameserver.network.serverpackets.ExCubeGameRequestReady;
import l2.universe.gameserver.network.serverpackets.ExCubeGameTeamList;
...
public class HandysBlockCheckerEvent extends Quest
{
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (arena != -1)
		{
			...
			if (HandysBlockCheckerManager.getInstance().addPlayerToArena(player, arena))
			{
				...
				final int minMembers = ExternalConfig.MIN_BLOCK_CHECKER_TEAM_MEMBERS;
	...
	{
		if (!ExternalConfig.ENABLE_BLOCK_CHECKER_EVENT)
		{
