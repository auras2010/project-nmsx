 ...
 */
package quests._105_SkirmishWithTheOrcs;
 ...
 */
public class _105_SkirmishWithTheOrcs extends Quest
{
	// NPC
	...
	{ 
		KABOO_CHIEF_UOPH, KABOO_CHIEF_KRACHA, KABOO_CHIEF_BATOH, KABOO_CHIEF_TANUKIA,
		KABOO_CHIEF_TUREL, KABOO_CHIEF_ROKO, KABOO_CHIEF_KAMUT, KABOO_CHIEF_MURTIKA 
	};

	public _105_SkirmishWithTheOrcs(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] {KENDNELLS_ORDER1, KENDNELLS_ORDER2, KENDNELLS_ORDER3, KENDNELLS_ORDER4, KENDNELLS_ORDER5,
				KENDNELLS_ORDER6, KENDNELLS_ORDER7, KENDNELLS_ORDER8, KABOO_CHIEF_TORC1, KABOO_CHIEF_TORC2};
	}
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		switch(st.getState())
		{
			...
			case State.STARTED :
				...
				{
					case 1:
						if (st.getQuestItemsCount(KENDNELLS_ORDER1) + st.getQuestItemsCount(KENDNELLS_ORDER2) + st.getQuestItemsCount(KENDNELLS_ORDER3) 
								+ st.getQuestItemsCount(KENDNELLS_ORDER4) != 0)
					...
					case 2:
						...
						break;
					case 3:
						if (st.getQuestItemsCount(KENDNELLS_ORDER5) + st.getQuestItemsCount(KENDNELLS_ORDER6) + st.getQuestItemsCount(KENDNELLS_ORDER7) 
								+ st.getQuestItemsCount(KENDNELLS_ORDER8) == 1)
					...
					case 4:
						if (st.getQuestItemsCount(KABOO_CHIEF_TORC2) > 0)
						{
							...
							st.giveReward(57, 17599);
							st.addRewardExpAndSp(41478,3555);
							st.unset("cond");
							st.exitQuest(false);
	...
	{
		new _105_SkirmishWithTheOrcs(105, "_105_SkirmishWithTheOrcs", "Skirmish With Orcs");
	}
}
