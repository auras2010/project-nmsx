...
20974: [5,10,25,[Spiteful_Soul_Vengeance,Spiteful_Soul_Energy]],            # Spiteful Soul Leader
  ...
  def onKill(self,npc,player,isPet):
    ...
    if leader_st :
      ...
      if cond == condition and random < chance:
        if len(itemList) > 1:
          stoneRandom = leader_st.getRandom(2)
          if stoneRandom == 0 :
          ...
          if npcId == 27181:                # Imperial Gravekeeper
            spawnedNpc=leader_st.addSpawn(30765,3600000)
