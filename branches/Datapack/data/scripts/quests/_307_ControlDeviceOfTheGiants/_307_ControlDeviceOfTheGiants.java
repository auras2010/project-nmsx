...
public class _307_ControlDeviceOfTheGiants extends Quest
{
    ...
    public _307_ControlDeviceOfTheGiants(int id, String name, String descr)
    {
        super(id, name, descr);
    ...
    {
        new _307_ControlDeviceOfTheGiants(307, "_307_ControlDeviceOfTheGiants", "Control Device Of The Giants");
    }
}
