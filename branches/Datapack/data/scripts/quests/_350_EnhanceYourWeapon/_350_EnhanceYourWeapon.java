...
import l2.universe.gameserver.model.actor.L2Attackable.AbsorberInfo;
...
public class _350_EnhanceYourWeapon extends Quest
{
	...
	private void load()
	{
		try
		{
			...
			File file = new File(Config.DATAPACK_ROOT + "/data/scripts/quests/_350_EnhanceYourWeapon/data.xml");
			if (!file.exists())
			{
	...
	{
		new _350_EnhanceYourWeapon(350, qn, "Enhance Your Weapon");
	}
