...
import l2.universe.gameserver.instancemanager.Manager;
...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(final String command, final L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_diet"))
		{
			try
			{
				final String mode = command.substring(11);
	...
	public void showConfigPage(final L2PcInstance activeChar)
	{
		...
		replyMSG.append("<tr><td><font color=\"LEVEL\">Enchant Weapon</font> = " + Config.ENCHANT_CHANCE_WEAPON_WARRIOR + "</td><td><edit var=\"param5\" width=40 height=15></td><td><button value=\"Set\" action=\"bypass -h admin_setconfig EnchantChanceWeapon $param5\" width=40 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
