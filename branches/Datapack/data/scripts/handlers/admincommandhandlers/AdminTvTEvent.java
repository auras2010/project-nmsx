...
import l2.universe.gameserver.model.entity.events.TvTEventTeleporter;
...
public class AdminTvTEvent implements IAdminCommandHandler
{
	...
	private void remove(final L2PcInstance activeChar, final L2PcInstance playerInstance)
	{
		...
		new TvTEventTeleporter(playerInstance, ExternalConfig.TVT_EVENT_PARTICIPATION_NPC_COORDINATES, true, true);
	}
