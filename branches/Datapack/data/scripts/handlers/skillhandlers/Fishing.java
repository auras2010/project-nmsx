...
import l2.universe.gameserver.model.zone.type.L2FishingZone;
import l2.universe.gameserver.model.zone.type.L2WaterZone;
...
public class Fishing implements ISkillHandler
{
	...
	public void useSkill(final L2Character activeChar, final L2Skill skill, final L2Object[] targets)
	{
		...
		if (player.isInsideZone(L2Character.ZONE_WATER) || player.isInsideZone(L2Character.ZONE_PEACE) || player.isInsideZone(L2Character.ZONE_TOWN) || player.isInsideZone(L2Character.ZONE_CASTLE) || player.isInsideZone(L2Character.ZONE_JAIL) || player.isInsideZone(L2Character.ZONE_HELLBOUND) || player.isInsideZone(L2Character.ZONE_FORT))
		{
